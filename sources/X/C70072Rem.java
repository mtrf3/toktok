...
public final class C70072Rem extends R30<IPdpStarter.PdpEnterParam, RYH, IPdpStarter.PdpEnterParam, RYH> {
    ...
    public final AbstractC73672Svk<RYH> LJII(IPdpStarter.PdpEnterParam pdpEnterParam) {
        ...
        return pdpApi.getProductInfoBatch(requestParams, C70091Rf5.LJI(str)).LJJL(T16.LIZ());
    }

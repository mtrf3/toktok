...
public final class C46312IFo implements JGK {
    public final /* synthetic */ ViewOnAttachStateChangeListenerC48975JJz LJLIL;
    ...
    public final void LLLJIL() {
        JGI core = this.LJLIL.LJLLL.getCore();
        if (core == null) {
            return;
        }
        core.setMute(J1C.LIZ(C46314IFq.LIZIZ() ? 1 : 0, 0, this.LJLIL.LJLL));
    }
    ...
    public final void LLLLLJLJLL() {
        ...
        LIZ.append("Precise pauseMedia(); is playing = ");
        JGI core = this.LJLIL.LJLLL.getCore();
        Boolean bool2 = null;
        if (core != null) {
            bool = Boolean.valueOf(core.isPlaying());
        } else {
            bool = null;
        }
        LIZ.append(bool);
        X1D.LIZIZ(LIZ);
        JGI core2 = this.LJLIL.LJLLL.getCore();
        if (core2 != null && Boolean.valueOf(core2.isPlaying()) != null) {
            JGI core3 = this.LJLIL.LJLLL.getCore();
            if (core3 != null) {
                bool2 = Boolean.valueOf(core3.isPlaying());
            }
            o.LJI(bool2);
            if (bool2.booleanValue() && (jk3 = this.LJLIL.LJLLI) != null) {
                jk3.LJJII();
            }
        }
    }
    ...
    public C46312IFo(ViewOnAttachStateChangeListenerC48975JJz viewOnAttachStateChangeListenerC48975JJz) {
        this.LJLIL = viewOnAttachStateChangeListenerC48975JJz;
    }

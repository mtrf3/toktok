...
public final class FDC implements FDH {
    public static final FDC LIZ = new FDC();
    ...
    public final EcomGeckoFrontUpdateModel[] config() {
        ...
        LJIIIZ.getClass();
        EcomGeckoFrontUpdateModel[] ecomGeckoFrontUpdateModelArr2 = (EcomGeckoFrontUpdateModel[]) FFL.LJIJ(true, "ecom_common_gecko_front_update_ext1", 31744, EcomGeckoFrontUpdateModel[].class, ecomGeckoFrontUpdateModelArr);

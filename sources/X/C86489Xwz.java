...
public final class C86489Xwz extends C86492Xx2 {
    ...
    public final void LIZIZ(Bitmap bitmap) {
        ...
        if (bitmap != null && (innerPushUITemplate = this.LJLJI) != null) {
            innerPushUITemplate.setPreloadLabelImage(bitmap);
        }
        this.LJLIL.getTracker().LJIIIIZZ = System.currentTimeMillis() - this.LJLILLLLZI.element;
    }
    ...
    public final void onProgress(float f) {
        ...
        LIZ.append("avatarRightLabelUrl onProgress progress:");
        LIZ.append(f);
        C86478Xwo.LIZ("InnerPushViewPreload", X1D.LIZIZ(LIZ));
    }

    public C86489Xwz(InnerPushMessage innerPushMessage, C72242sW c72242sW, InnerPushUITemplate innerPushUITemplate) {

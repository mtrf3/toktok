...
public final class R9K extends R4O {
    public final /* synthetic */ C45R<R40<R9Z>> LIZ;
    ...
    public final void onSuccess(R40<R9Z> response) {
    ...
    public final void onError(R40<R9Z> response, int i) {
        o.LJIIIZ(response, "response");
        ((C73516StE) this.LIZ).onError(new C69084R9k(response.LIZLLL, response.LJFF, this.LIZIZ, this.LIZJ, null, null, 32, null));
    }
    ...
    public R9K(C73516StE c73516StE, EnumC69116RAq enumC69116RAq, EnumC69113RAn enumC69113RAn) {
        this.LIZ = c73516StE;

...
public final class K96 extends C0CJ {
    public final WeakReference<C74053T4n> LJLIL;
    public int LJLILLLLZI;
    public int LJLJI;

    public K96(C74053T4n tabLayout) {
    ...
    */
    public final void LIZIZ(int r7, float r8, int r9) {
        ...
        L21:
            ...
            goto L18
        */
        throw new UnsupportedOperationException("Method not decompiled: X.K96.LIZIZ(int, float, int):void");
    }
}

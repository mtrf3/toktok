...
public final class C78531Urv implements InterfaceC78280Uns {
    ...
    public final UFL LIZ() {
        ...
        return new C77327UWl(keys);
    }

    @Override // X.InterfaceC78280Uns
    public final java.util.Map<String, Object> LIZIZ() {
        return C38382F4o.LIZIZ(this.LIZ);
    }

    public C78531Urv(JSONObject origin) {
    ...
    public final InterfaceC78505UrV get(String name) {
        o.LJIIJ(name, "name");
        return new C78536Us0(this.LIZ.opt(name));
    }

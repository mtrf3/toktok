...
public final class C59056NFs {
    public static String LIZ(Aweme aweme) {
        ...
        if (awemeRawAd != null && (adDescriptiveCTA = awemeRawAd.getAdDescriptiveCTA()) != null && (bottomContainer = adDescriptiveCTA.getBottomContainer()) != null) {
            str = bottomContainer.getContainerUrl();
        } else {
            str = null;
        }
        LIZ.append(str);
    ...
    public static C59421NTt LIZIZ(Context context, Aweme aweme) {
        ...
        o.LJIIIZ(aweme, "aweme");
        AwemeRawAd awemeRawAd = aweme.getAwemeRawAd();
        if (awemeRawAd != null && (adDescriptiveCTA = awemeRawAd.getAdDescriptiveCTA()) != null && (bottomContainer = adDescriptiveCTA.getBottomContainer()) != null && (containerUrl = bottomContainer.getContainerUrl()) != null) {
            str = UriProtector.parse(containerUrl).buildUpon().appendQueryParameter("initialData", NG3.LIZ(context, aweme).toString()).toString();
        } else {
            str = null;
        }
        return new C59421NTt(EnumC59053NFp.CACHE_WITH_RETRY, LIZ(aweme), 4, false, new NIA("feed_fyp_descriptive_bottom_container", str, NG3.LIZIZ(context, aweme), C59055NFr.LIZ("feed_fyp_descriptive_bottom_container"), new C1PH(), false, null, false, 992), null, false, 200);
    }
    ...
    public static C59066NGc LIZJ(Context context, Aweme aweme) {
        ...
        return new C59066NGc("feed_fyp_descriptive_bottom_container", enumC59241NMv, context, new NGY(str, str2, groupId, num, num2, 32));
    }
}

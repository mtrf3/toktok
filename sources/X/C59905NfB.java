...
public final class C59905NfB implements InterfaceC60850NuQ, InterfaceC60061Nhh {
    ...
    public final void finish() {
        ...
        if (str != null && str.length() > 0 && (weakReference = this.LJLIL) != null && weakReference.get() != null) {
    ...
    public final void LJJI(SparkActivity activity) {
        ...
        if (C19N.LJ("tiktokec_payment_blank_detect", false)) {
            ...
            if (view != null) {
                ...
                c60601NqP.LJII = new C59906NfC(this);

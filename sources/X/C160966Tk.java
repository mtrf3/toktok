...
public final class C160966Tk extends C6OX {
    public final Context LJIIJ;
    public final EmbedHashTagStickerModel LJIIJJI;
    ...
    public final C1NS<EmbedHashTagStickerModel> LJJIZ() {
    ...
    public final void LJI(StickerModel stickerModel) {
        ...
        if ((stickerModel instanceof EmbedHashTagStickerModel) && (embedHashTagStickerModel = (EmbedHashTagStickerModel) stickerModel) != null) {
            LJJIZ().LJ(new AqS168S0100000_2(embedHashTagStickerModel, 4));
            LJJIL(((EmbedHashTagStickerModel) stickerModel).getBaseStickerModel());
        }
    }
    ...
    public final void LJJIJIIJIL(BaseStickerModel baseState) {
        ...
        LJJIZ().LJ(new AqS168S0100000_2(baseState, 3));
    }

    @Override // X.C6OX, X.C6QO
    public final void setVisible(boolean z) {
        LJJIZ().LJ(new AqS7S0010000_2(z, 1));
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C160966Tk(Context context, EmbedHashTagStickerModel hashTagStickerModel, FrameLayout stickerContainer, C159636Oh c159636Oh, LifecycleOwner lifecycleOwner, C160056Px stickerObjectContainer) {
        ...
        this.LJIILL = C221108m2.LIZIZ(new AqS152S0100000_2(this, 9));
        this.LJIILLIIL = C221108m2.LIZIZ(new AqS152S0100000_2(this, 10));

...
public final class C57111MbD {
    ...
    public final void LIZIZ() {
        ...
        if (notificationSubscribeSettingsList != null) {
            ...
            if (tuxSheet == null) {
                View inflate = View.inflate(this.LIZ, R.layout.sq, null);
                ...
                if (!arrayList.isEmpty()) {
                    ...
                    LIZJ.LIZIZ(new AqS156S0200000_9(this, inflate, 69));
                    ...
                    tuxSheet2.LJLILLLLZI = new IDDListenerS103S0200000_9(this, notificationSubscribeSettingsList, 4);
                    this.LJ = tuxSheet2;
                }
                tuxSheet = this.LJ;
                if (tuxSheet == null) {
            ...
            this.LIZJ = false;
            C1DG.LJII(this.LIZ, "context).supportFragmentManager", tuxSheet, "notification_subscribe_settings");
    ...
    public C57111MbD(int i, ActivityC45651qj context) {
        o.LJIIIZ(context, "context");
        this.LIZ = context;
        this.LIZIZ = i;
        C5H3 LJZI = V1B.LJZI(new AqS159S0100000_9(this, 804));
        this.LJFF = LJZI;
        ((SubscribeSettingVM) LJZI.getValue()).LJLILLLLZI.observe(context, new AObserverS77S0100000_9(this, 65));
    }

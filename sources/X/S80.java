...
public final class S80 implements Parcelable.Creator<SizeChartTemplateItem> {
    @Override // android.os.Parcelable.Creator
    public final SizeChartTemplateItem createFromParcel(Parcel parcel) {
        boolean z;
        boolean z2;
        ...
        return new SizeChartTemplateItem(readString, readInt, arrayList, readString2, readString3, z, readString4, readString5, z2, arrayList2);
    }

    @Override // android.os.Parcelable.Creator
    public final SizeChartTemplateItem[] newArray(int i) {
        return new SizeChartTemplateItem[i];
    }
}

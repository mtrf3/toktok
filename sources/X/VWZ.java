...
public final class VWZ extends C45621qg implements InterfaceC33971Uz {
    public C16610kz LLFII;
    public InterfaceC88473Ynt<? super View, ? super Float, ? super Float, Boolean> LLFZ;
    public boolean LLI;

    @Override // android.view.View
    public final boolean isNestedScrollingEnabled() {
        C16610kz c16610kz = this.LLFII;
        if (c16610kz != null) {
    ...
    public final boolean dispatchTouchEvent(MotionEvent motionEvent) {
        ...
        if (motionEvent != null && motionEvent.getActionMasked() == 0 && dispatchTouchEvent && this.LLI) {
    ...
    public VWZ(Context context, AttributeSet attributeSet) {
        super(context, attributeSet, R.attr.a7h);
    ...
    public final boolean onNestedPreFling(View target, float f, float f2) {
        ...
        InterfaceC88473Ynt<? super View, ? super Float, ? super Float, Boolean> interfaceC88473Ynt = this.LLFZ;

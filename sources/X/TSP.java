...
public final class TSP implements U62 {
    public final /* synthetic */ TSQ LJLIL;
    ...
    public final void LJLILLLLZI(InterfaceC75441TjB session, int i) {
        ...
        LIZ.append("MultiGuestV3LinkMicStateChangedChannel state=");
        LIZ.append(i);
        C0NB.LJIIIZ("MultiGuestsToolbar", X1D.LIZIZ(LIZ));
        if (i == 5) {
            TSQ.LJII = true;
            TSQ tsq = this.LJLIL;
            tsq.getClass();
            EnumC30204BtI enumC30204BtI = EnumC30204BtI.QUESTION;
            if (enumC30204BtI.isShowing(tsq.LIZ) || enumC30204BtI.isShowingInInteractionDialog(tsq.LIZ)) {
                tsq.LJFF = true;
                tsq.LIZIZ(enumC30204BtI, new ARunnableS49S0100000_13(tsq, 157));
            } else {
                tsq.LJFF = false;
            }
            TSQ tsq2 = this.LJLIL;
            ...
            if (enumC30204BtI2.isShowing(tsq2.LIZ) || enumC30204BtI2.isShowingInInteractionDialog(tsq2.LIZ)) {
                tsq2.LIZIZ(enumC30204BtI2, new ARunnableS49S0100000_13(tsq2, 156));
            }
            Object kv0 = this.LJLIL.LIZ.kv0(LeftSlotToolbarVisibilityChannel.class);
            Boolean bool = Boolean.TRUE;
            if (!o.LJ(kv0, bool)) {
                if (C29232Bdc.LJIILJJIL() && C29232Bdc.LJII(this.LJLIL.LIZ)) {
                    this.LJLIL.getClass();
                    if (!C259710f.LIZ.LJIIIZ() || C15380j0.LIZ(297.0f) <= C81185Vtd.LIZLLL()) {
                        this.LJLIL.LIZJ(EnumC30204BtI.MULTI_GUEST_MIC, new TUE(this.LJLIL.LIZJ));
                    }
                } else {
                    this.LJLIL.LIZJ(EnumC30204BtI.MULTI_GUEST_MIC, new TUE(this.LJLIL.LIZJ));
                    TSQ tsq3 = this.LJLIL;
                    MultiGuestDataHolder multiGuestDataHolder = tsq3.LIZIZ;
                    if (multiGuestDataHolder != null && ((multiGuestDataHolder.LJJIJLIJ == 3 || multiGuestDataHolder.LJJIJLIJ == 1) && C29137Bc5.LJ((LiveMode) tsq3.LIZ.kv0(BCX.class)))) {
                        this.LJLIL.getClass();
                        if (!C259710f.LIZ.LJIIIZ() || C15380j0.LIZ(297.0f) <= C81185Vtd.LIZLLL()) {
                            TSQ tsq4 = this.LJLIL;
                            tsq4.LIZJ(EnumC30204BtI.MULTI_GUEST_VIDEO, new TSW(tsq4.LIZJ));
                        }
                    }
                }
            }
            this.LJLIL.LIZJ(EnumC30204BtI.MULTI_GUEST_MANAGE, new TWH());
            TSQ tsq5 = this.LJLIL;
            tsq5.LIZIZ(EnumC30204BtI.MULTIGUEST, new ARunnableS49S0100000_13(tsq5, 158));
            this.LJLIL.LIZ.qv0(CommentWidgetStyleChangeEvent.class, bool);
            return;
        }
        if (!TSQ.LJII) {
            return;

...
public final class C82333WSz extends AbstractC29891Fh<WTX> implements WTX, InterfaceC143795kd, InterfaceC135635Tz {
    ...
    public final WLT LJLJJL;
    public final InterfaceC45999I3n LJLJJLL;
    public final I3X LJLJL;
    public final C5H3 LJLJLJ;

    static {
        TBT tbt = new TBT(C82333WSz.class, "svcBottomAndPanelApiComponent", "getSvcBottomAndPanelApiComponent()Lcom/ss/android/ugc/gamora/recorder/voicechange/slideslip/SVCBottomAndPanelApiComponent;", 0);
        C65351Pkp c65351Pkp = C65352Pkq.LIZ;
        c65351Pkp.getClass();
        LJLJLLL = new InterfaceC74236TBo[]{tbt, C61845OOz.LIZJ(C82333WSz.class, "shortVideoContext", "getShortVideoContext()Lcom/ss/android/ugc/aweme/shortvideo/ShortVideoContext;", 0, c65351Pkp)};
    }

    public final void LJJLI() {
    }

    public WTX LJJLIIIIJ() {
        return this;
    }
    ...
    private final InterfaceC82199WNv LJJLIIIJILLIZJL() {
        return (InterfaceC82199WNv) this.LJLJI.LIZ(this, LJLJLLL[0]);
    }

    private final C81583W0d LJJLIIIJJI() {
        return (C81583W0d) this.LJLJLJ.getValue();
    }

    private final void LJJLIIIJJIZ() {
        this.LJLJJL.pM().LIZLLL(this, new AObjectS89S0100000_14(this, 159));
        this.LJLJJLL.Ai0().LIZLLL(this, new AObjectS89S0100000_14(this, 160));
        this.LJLJL.ck0().LIZLLL(this, new AObjectS89S0100000_14(this, 161));
    }

    private final ShortVideoContext getShortVideoContext() {
        return (ShortVideoContext) this.LJLJJI.LIZ(this, LJLJLLL[1]);
    }

    public final void LJJLIIJ() {
        C145995oB c145995oB = new C145995oB();
        c145995oB.LJI("shoot_way", "vc_page");
        c145995oB.LJI("creation_id", getShortVideoContext().LJI());
        c145995oB.LJI("enter_from", "vc_page");
        c145995oB.LJI("content_source", "shoot");
        c145995oB.LJI("content_type", "video");
        String str = getShortVideoContext().creativeModel.streamVoiceConversionModel.vcVoiceId;
        if (str == null) {
            str = "";
        }
        c145995oB.LJI("voice_modify_id", str);
        c145995oB.LIZ(1, "is_voice_effect");
        c145995oB.LJI("voice_effect_selected_from", "vc_page");
    ...
    public void W9() {
        String str;
        InterfaceC82199WNv LJJLIIIJILLIZJL = LJJLIIIJILLIZJL();
        if (LJJLIIIJILLIZJL != null && !LJJLIIIJILLIZJL.Po0() && (str = getShortVideoContext().creativeModel.streamVoiceConversionModel.vcVoiceId) != null) {
            C82200WNw.LIZIZ(LJJLIIIJILLIZJL, str, 2);
            C82468WYe.LIZIZ(getShortVideoContext());
            StringBuilder LIZ = X1D.LIZ();
            LIZ.append("shoot page vc id: ");
            LIZ.append(str);
            X1D.LIZIZ(LIZ);
        }
    }
    ...
    @Override // X.WTX
    public void ij0() {
        String string = C86V.LJ().getString(R.string.a2l);
        o.LJIIIIZZ(string, "getResources().getString…stPage_voiceFilter_toast)");
        View requireViewById = this.LJLIL.requireViewById(R.id.j83);
        o.LJIIIIZZ(requireViewById, "parentScene.requireViewById(R.id.root_view)");
        UrlModel urlModel = new UrlModel(null, 1, null);
        ArrayList arrayList = new ArrayList();
        arrayList.add("https://p16-sg.tiktokcdn.com/obj/tiktok-obj/vc_filter_anchor_icon.png");
        urlModel.setUrlList(arrayList);
        LJJLIIIJLLLLLLLZ((FrameLayout) requireViewById, new C81582W0c(string, urlModel));
    }

    @Override // X.AbstractC29891Fh
    public void onCreate() {
        super.onCreate();
        if (C78685UuP.LJJJZ(getShortVideoContext().creativeModel.streamVoiceConversionModel.vcVoiceId)) {
            this.LJLJJL.ip0().LIZIZ(this, new AObjectS89S0100000_14(this, 162));
        }
    }

    @Override // X.AbstractC29891Fh
    public /* bridge */ /* synthetic */ WTX getApiComponent() {
        LJJLIIIIJ();
        return this;
    }
    ...
    public C82333WSz(WMH parentScene, C82622Wbi diContainer) {
        o.LJIIIZ(parentScene, "parentScene");
        o.LJIIIZ(diContainer, "diContainer");
        this.LJLIL = parentScene;
        this.LJLILLLLZI = diContainer;
        this.LJLJI = UCI.LJII(getDiContainer(), InterfaceC82199WNv.class, null);
        this.LJLJJI = UCI.LJI(getDiContainer(), ShortVideoContext.class, null);
        this.LJLJJL = (WLT) getDiContainer().LJ(WLT.class, null);
        this.LJLJJLL = (InterfaceC45999I3n) getDiContainer().LJ(InterfaceC45999I3n.class, null);
        this.LJLJL = (I3X) getDiContainer().LJ(I3X.class, null);
        this.LJLJLJ = C221108m2.LIZIZ(WTF.LJLIL);
    }

    private final void LJJLIIIJLLLLLLLZ(FrameLayout frameLayout, C81582W0c c81582W0c) {
        if (LJJLIIIJJI().LJLJJL) {
            LJJLIIIJJI().LJJLIIIJL(false);
        }
        C81583W0d LJJLIIIJJI = LJJLIIIJJI();
        LJJLIIIJJI.LJLJJLL = c81582W0c;
        LJJLIIIJJI.LIZ(frameLayout);
    }

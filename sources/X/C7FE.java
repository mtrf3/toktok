...
public final class C7FE implements KPL {
    public final C200847uS LJLIL;
    public final C7FF LJLILLLLZI;
    ...
    public C7FE(C200847uS postModeModel) {
        PhotoModeImageInfo photoModeImageInfo;
        List<PhotoModeImageUrlModel> imageList;
        ViewGroup viewGroup;
        o.LJIIIZ(postModeModel, "postModeModel");
        this.LJLIL = postModeModel;
        View LLLZIIL = C16880lQ.LLLZIIL(R.layout.c2d, C16880lQ.LLZIL(postModeModel.LIZIZ), null);
        ViewGroup viewGroup2 = postModeModel.LJ;
        if (viewGroup2 != null && (viewGroup = (ViewGroup) viewGroup2.findViewById(R.id.hzj)) != null) {
            viewGroup.addView(LLLZIIL);
        }
        C7FF c7ff = (C7FF) LLLZIIL.findViewById(R.id.hos);
        this.LJLILLLLZI = c7ff;
        View view = c7ff instanceof View ? (View) c7ff : null;
        int i = 0;
        if (view != null) {
        ...
        if (c7ff != 0) {
            c7ff.LIZ();
            c7ff.setLifecycleOwner(postModeModel.LIZIZ);
            Aweme aweme = postModeModel.LIZJ;
        ...
        if (postModeFullPageViewModel != null) {
            C8YN.LJII(this, postModeFullPageViewModel, new TBT() { // from class: X.7Of
                @Override // X.TBT, X.TBZ, X.TBW
                public final Object get(Object obj) {
                    return Integer.valueOf(((C203127y8) obj).LJLIL);
                }
            }, null, new AqS185S0100000_3(this, 160), 6);
        }
    }

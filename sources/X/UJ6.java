...
public final class UJ6 extends DataChannelSceneObserver<Boolean, FrameL2SlotVisibilityChannel> {
    public final /* synthetic */ UJ4 LIZ;

    @Override // com.bytedance.ies.sdk.widgets.DataChannelSceneObserver
    public final Class<FrameL2SlotVisibilityChannel> getType() {
        return FrameL2SlotVisibilityChannel.class;
    }
    ...
    public final void onEvent(LayeredElementContext layeredElementContext, ConstraintProperty constraintProperty, Boolean bool) {
        this.LIZ.LIZIZ(2, !C76965UIn.LIZLLL(bool, layeredElementContext, "layeredElementContext", constraintProperty, "constraintProperty"));
    }
}

...
public final class C27149Al7 implements Parcelable.Creator<PDPReturnPolicyModule> {
    @Override // android.os.Parcelable.Creator
    public final PDPReturnPolicyModule createFromParcel(Parcel parcel) {
        ...
        return new PDPReturnPolicyModule(readString, icon2, linkRichText, arrayList, icon3, icon);
    }

    @Override // android.os.Parcelable.Creator
    public final PDPReturnPolicyModule[] newArray(int i) {
        return new PDPReturnPolicyModule[i];
    }
}

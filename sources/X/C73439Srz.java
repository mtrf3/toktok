...
public final class C73439Srz<T> extends AbstractC73430Srq<T, T> {
    public C73439Srz(InterfaceC115714gR<T> interfaceC115714gR) {
    ...
    public final void LJJJZ(InterfaceC116954iR<? super T> interfaceC116954iR) {
        this.LJLIL.LIZ(new C73438Sry(interfaceC116954iR));
    }
}

...
public final class C43093Gvh extends AbstractC43051Gv1 {
    ...
    public final File LIZLLL() {
        return C60903NvH.LJIIJJI().LJJIJL().getFileProvider().LIZJ(C60903NvH.LJIIJJI().LJJIJL().getFileProvider().LIZLLL("read_text_audio"));
    }

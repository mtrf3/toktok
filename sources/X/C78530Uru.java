...
public final class C78530Uru implements InterfaceC78280Uns {
    ...
    public final UFL LIZ() {
        ...
        return new C77330UWo(keys);
    }

    @Override // X.InterfaceC78280Uns
    public final java.util.Map<String, Object> LIZIZ() {
        return C38385F4r.LIZIZ(this.LIZ);
    }

    public C78530Uru(JSONObject origin) {
    ...
    public final InterfaceC78505UrV get(String name) {
        o.LJIIJ(name, "name");
        return new C78538Us2(this.LIZ.opt(name));
    }
    ...
    public final InterfaceC78502UrS getArray(String name) {
        ...
        return new C78535Urz(optJSONArray);
    }
    ...
    public final InterfaceC78280Uns getMap(String name) {
        ...
        return new C78530Uru(optJSONObject);
    }

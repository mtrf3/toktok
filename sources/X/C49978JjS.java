...
public final class C49978JjS implements InterfaceC49992Jjg {
    public final InterfaceC49985JjZ LIZ;

    public C49978JjS(JVP jvp) {
        this.LIZ = jvp;
    }
    ...
    public final boolean LIZIZ(C50420Jqa videoEvent, Aweme aweme) {
        o.LJIIIZ(videoEvent, "videoEvent");
        if (videoEvent.LJLJLJ == 35 || o.LJ(aweme.getSearchFeedType(), "SearchBotFeed")) {
            return true;
        }
        return false;
    }
    ...
    public final int LIZJ(C50420Jqa videoEvent, Aweme aweme) {
        ...
        return interfaceC49985JjZ.LJJIJL(aid);
    }

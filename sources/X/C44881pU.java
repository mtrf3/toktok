...
public final class C44881pU implements InterfaceC39071g7 {
    public final InterfaceC274115t LJLIL;
    public final EnumC273815q LJLILLLLZI;
    public final EnumC273915r LJLJI;
    ...
    public final AbstractC39201gK LJJJIL(long j) {
        ...
        final int LJJJI;
        if (this.LJLJI == EnumC273915r.Width) {
            if (this.LJLILLLLZI == EnumC273815q.Max) {
                LJJJI = this.LJLIL.LJJLJLI(C23360vs.LJI(j));
            } else {
                LJJJI = this.LJLIL.LJJJI(C23360vs.LJI(j));
            }
            final int LJI = C23360vs.LJI(j);
            return new AbstractC39201gK(LJJJI, LJI) { // from class: X.1pV
        ...
        return new AbstractC39201gK(LJII, LJJLIIIJLLLLLLLZ) { // from class: X.1pV
            @Override // X.InterfaceC273715p
            public final int LJJJJ(AbstractC272415c alignmentLine) {
                o.LJIIIZ(alignmentLine, "alignmentLine");
                return LiveLayoutPreloadThreadPriority.DEFAULT;
    ...
    public C44881pU(InterfaceC274115t measurable, EnumC273815q enumC273815q, EnumC273915r enumC273915r) {
        o.LJIIIZ(measurable, "measurable");
        this.LJLIL = measurable;
        this.LJLILLLLZI = enumC273815q;
        this.LJLJI = enumC273915r;
    }
}

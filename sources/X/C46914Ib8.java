...
public final class C46914Ib8 implements InterfaceC46867IaN {
        ...
        if (c47164IfA != null && (c47163If9 = c47164IfA.LIZJ) != null && (LJIIIIZZ = c47163If9.LJIIIIZZ()) != null && LJIIIIZZ.size() > 0) {
            for (C47160If6 c47160If6 : LJIIIIZZ) {
                if (c47160If6.LIZ() == 0 || !IZ8.LJIILLIIL()) {
                    ...
                    arrayList.add(new Pair(C47165IfB.LIZIZ(c47160If6.getResolution()), simBitRate));
                }
            }
        }
        if (IZ8.LJIIZILJ()) {
            Collections.sort(arrayList, new C46919IbD(0));
        }
        return arrayList;
    }
                ...
                if (LJIIIIZZ2 != null && !LJIIIIZZ2.isEmpty()) {
                    ...
                    for (C47160If6 c47160If62 : LJIIIIZZ2) {
                        if (c47160If62 != null && c47160If62.LIZ() == 0) {
                            ...
                            arrayList.add(new Pair(C47165IfB.LIZIZ(c47160If62.getResolution()), Integer.valueOf(LIZLLL)));
                        }
                    }
                }
            }
        ...
        if (c47164IfA2 != null && (c47163If9 = c47164IfA2.LIZJ) != null && (LJIIIIZZ = c47163If9.LJIIIIZZ()) != null && LJIIIIZZ.size() > 0) {
            for (C47160If6 c47160If63 : LJIIIIZZ) {
                if (c47160If63.LIZ() == 0 || !IZ8.LJIILLIIL()) {
                    arrayList2.add(new Pair(C47165IfB.LIZIZ(c47160If63.getResolution()), Integer.valueOf(c47160If63.LIZLLL(3))));
                }
            }
        }
        if (IZ8.LJIIZILJ()) {
            Collections.sort(arrayList2, new C46918IbC(0));
        }
        return arrayList2;
    }
    ...
    public C46914Ib8(C47164IfA c47164IfA) {
        C47163If9 c47163If9;
        this.LIZ = c47164IfA;
    ...
    public final EnumC47177IfN LIZ(EnumC47177IfN enumC47177IfN) {
        return C47165IfB.LIZIZ(TTVideoEngine.LJIIJJI(this.LIZ, C47165IfB.LIZ(enumC47177IfN), 1));
    }
        ...
        if (c47164IfA != null && (c47163If9 = c47164IfA.LIZJ) != null && (LJIIIIZZ = c47163If9.LJIIIIZZ()) != null && LJIIIIZZ.size() > 0) {
            for (C47160If6 c47160If6 : LJIIIIZZ) {
                if (c47160If6.LIZLLL(3) == i) {
                    return new Pair<>(C47165IfB.LIZIZ(c47160If6.getResolution()), c47160If6.LIZIZ(18));
                }
            }
        }
        return pair;

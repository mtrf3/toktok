...
public final class C62189Oav extends C62846OlW {
    public final IDdS476S0100000_10 LJLIL;

    @Override // X.C62846OlW
    public final void LIZ() {
        setOutlineProvider(new C62190Oaw(this));
    ...
    public final void LIZIZ(InterfaceC81599W0t interfaceC81599W0t) {
        if (interfaceC81599W0t != null) {
            setAspectRatio(interfaceC81599W0t.getWidth() / interfaceC81599W0t.getHeight());
            invalidateOutline();
        }
    }

    public C62189Oav(Context context, AttributeSet attributeSet) {
    ...
    public C62189Oav(Context context, AttributeSet attributeSet, int i) {
        super(context, attributeSet, i);
        new LinkedHashMap();
        this.LJLIL = new IDdS476S0100000_10(this, 4);
    }
}

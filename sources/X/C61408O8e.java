...
public final class C61408O8e {
    public static String LIZ;

    public static C39281gS LIZIZ() {
        JSONObject jSONObject;
        C2YJ c2yj = C2YJ.LIZIZ;
        LIZ = c2yj.LIZ.getAdTrackerConfig();
        try {
            jSONObject = new JSONObject(c2yj.LIZ.getAdTrackerConfig());
    ...
    public static void LIZJ(Context context) {
        ...
        c22760uu.LIZJ = NK4.LIZ;
        c22760uu.LJ = new O0O();
        C06360Mu c06360Mu = new C06360Mu();
        c06360Mu.LIZ = true;
        c06360Mu.LIZIZ = new IDfS3S0000000_10(0);
        c06360Mu.LIZ(O0N.LIZ);
        ...
        c22760uu.LIZ();
        SettingsManagerProxy.inst().registerSettingsWatcher(new C61409O8f(C35191Zr.LIZIZ()), false);
    }
}

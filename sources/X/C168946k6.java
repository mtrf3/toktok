...
@InterfaceC65848Psq(c = "com.ss.android.ugc.aweme.tools.draft.operate.restore.DraftAlgorithmModelRestoreHandler$restoreWithNet$2$2", f = "DraftAlgorithmModelRestoreHandler.kt", l = {94}, m = "invokeSuspend")
/* renamed from: X.6k6, reason: invalid class name and case insensitive filesystem */
/* loaded from: classes3.dex */
public final class C168946k6 extends AbstractC65782Prm implements InterfaceC88471Ynr<InterfaceC70422pa, InterfaceC67352kd<? super DraftFileRestoreResult>, Object> {
    public int LJLIL;
    public final /* synthetic */ C168956k7 LJLILLLLZI;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C168946k6(C168956k7 c168956k7, InterfaceC67352kd<? super C168946k6> interfaceC67352kd) {
    ...
    public final InterfaceC67352kd<C76800UCe> create(Object obj, InterfaceC67352kd<?> interfaceC67352kd) {
        return new C168946k6(this.LJLILLLLZI, interfaceC67352kd);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i != 0) {
            ...
            LIZ.append(" ; restore requirement start ...");
            C5Z2.LIZ(X1D.LIZIZ(LIZ));
            DownloadableModelSupport.getInstance().fetchResourcesNeededByRequirements(c168956k7.LJFF, new IFetchModelListener() { // from class: X.6k1
                ...
                public final void onFailed(Exception e) {
                    ...
                    C168956k7 c168956k72 = c168956k7;
                    InfoStickerModel LJI = ((AwemeDraft) c168956k72.LIZ.LIZLLL).LJI();
                    if (LJI != null) {
                        list = LJI.stickers;
                    } else {
                        list = null;
                    ...
                    if (list != null && !list.isEmpty()) {
                        ...
                        for (StickerItemModel stickerItemModel : list) {
                            String str = stickerItemModel.pinAlgorithmFile;
                        ...
                        while (it.hasNext()) {
                            ((StickerItemModel) it.next()).pinAlgorithmFile = null;
                        }
                    }
                    ((AwemeDraft) c168956k72.LIZ.LIZLLL).LJJJJI.editMusicSyncMode = false;
                    C45771Hxn.LIZ = false;
                    StringBuilder LIZ2 = X1D.LIZ();
                    LIZ2.append(c168956k7.LIZIZ);
                    LIZ2.append(" ; restore requirement failed ..., exception : ");
                    LIZ2.append(android.util.Log.getStackTraceString(e));
                    C5Z2.LIZ(X1D.LIZIZ(LIZ2));
                    XJL<DraftFileRestoreResult> xjl = xks;
                    DraftFileRestoreResult LIZIZ = C168716jj.LIZIZ(c168956k7, Integer.valueOf(R.string.eyo), new DraftFileRestoreException(-3001, e), 2);
                ...
                public final void onSuccess(String[] requirements) {
                    ...
                    StringBuilder LIZ2 = X1D.LIZ();
                    LIZ2.append(c168956k7.LIZIZ);
                    LIZ2.append(" ; restore requirement success ...");
                    C5Z2.LIZ(X1D.LIZIZ(LIZ2));
                    XJL<DraftFileRestoreResult> xjl = xks;

...
public final class WT1 extends AbstractC29891Fh<W1Y> implements W1Y, InterfaceC143795kd, InterfaceC135635Tz {
    ...
    public final WLT LJLJJI;
    public final InterfaceC45999I3n LJLJJL;
    public final I3X LJLJJLL;
    ...
    static {
        TBT tbt = new TBT(WT1.class, "shortVideoContext", "getShortVideoContext()Lcom/ss/android/ugc/aweme/shortvideo/ShortVideoContext;", 0);
        C65351Pkp c65351Pkp = C65352Pkq.LIZ;
        c65351Pkp.getClass();
        LJLLI = new InterfaceC74236TBo[]{tbt, C61845OOz.LIZJ(WT1.class, "stickerApiComponent", "getStickerApiComponent()Lcom/ss/android/ugc/gamora/recorder/sticker/sticker_core/StickerApiComponent;", 0, c65351Pkp), C61845OOz.LIZJ(WT1.class, "stickerComponent", "getStickerComponent()Lcom/ss/android/ugc/gamora/recorder/sticker/sticker_core/StickerApiComponent;", 0, c65351Pkp), C61845OOz.LIZJ(WT1.class, "slideComponent", "getSlideComponent()Lcom/ss/android/ugc/gamora/recorder/sticker/slideslip/SlideSlipBottomStickerApiComponent;", 0, c65351Pkp)};
    }

    public W1Y LJJLIIIIJ() {
        return this;
    }
    ...
    private final C81583W0d LJJLIIIJILLIZJL() {
        return (C81583W0d) this.LJLL.getValue();
    }

    private final void LJJLIIIJLLLLLLLZ() {
        this.LJLJJI.pM().LIZLLL(this, new AObjectS89S0100000_14(this, 150));
        this.LJLJJL.Ai0().LIZLLL(this, new AObjectS89S0100000_14(this, 151));
        this.LJLJJLL.ck0().LIZLLL(this, new AObjectS89S0100000_14(this, 152));
    }

    private final I0N getStickerApiComponent() {
        return (I0N) this.LJLJL.LIZ(this, LJLLI[1]);
    }

    public final InterfaceC82129WLd LJJLIIIJJI() {
        return (InterfaceC82129WLd) this.LJLJLLL.LIZ(this, LJLLI[3]);
    }

    public final I0N LJJLIIIJJIZ() {
        return (I0N) this.LJLJLJ.LIZ(this, LJLLI[2]);
    }

    public final ShortVideoContext getShortVideoContext() {
        return (ShortVideoContext) this.LJLJI.LIZ(this, LJLLI[0]);
    }
    ...
    private final void LJJLIIJ() {
        ...
        if (stickerApiComponent != null && (CY = stickerApiComponent.CY()) != null) {
            CY.LIZLLL(this, new AObjectS89S0100000_14(this, 153));
        }
    }

    public final void LJJLI() {
        if (LJJLIIIJILLIZJL().LJLJJL) {
            LJJLIIIJILLIZJL().LJJLIIIJL(false);
        }
    }
    ...
    public void onCreate() {
        super.onCreate();
        if (getShortVideoContext().ttsVoiceModel != null && !TextUtils.isEmpty(getShortVideoContext().ttsVoiceModel.getSpeakerName())) {
            this.LJLJJI.ip0().LIZIZ(this, new AObjectS89S0100000_14(this, 154));
        }
        LJJLIIJ();
        LJJLIIIJLLLLLLLZ();
    }
    ...
    @Override // X.AbstractC29891Fh
    public /* bridge */ /* synthetic */ W1Y getApiComponent() {
        LJJLIIIIJ();
        return this;
    }
    ...
    @Override // X.W1Y
    public void oq(String hintText) {
        ...
        TA((FrameLayout) requireViewById, hintText);
    }

    public WT1(WMH parentScene, C82622Wbi diContainer) {
        o.LJIIIZ(parentScene, "parentScene");
        o.LJIIIZ(diContainer, "diContainer");
        this.LJLIL = parentScene;
        this.LJLILLLLZI = diContainer;
        this.LJLJI = UCI.LJI(getDiContainer(), ShortVideoContext.class, null);
        this.LJLJJI = (WLT) getDiContainer().LJ(WLT.class, null);
        this.LJLJJL = (InterfaceC45999I3n) getDiContainer().LJ(InterfaceC45999I3n.class, null);
        this.LJLJJLL = (I3X) getDiContainer().LJ(I3X.class, null);
        ...
        this.LJLL = C221108m2.LIZIZ(WTE.LJLIL);
    }

    @Override // X.W1Y
    public void TA(FrameLayout parentLayout, String hintText) {
        o.LJIIIZ(parentLayout, "parentLayout");
        o.LJIIIZ(hintText, "hintText");
        m40(parentLayout, new C81582W0c(hintText, null));
    }

    @Override // X.W1Y
    public void m40(FrameLayout parentLayout, C81582W0c textViewGuideModel) {
        o.LJIIIZ(parentLayout, "parentLayout");
        o.LJIIIZ(textViewGuideModel, "textViewGuideModel");
        if (LJJLIIIJILLIZJL().LJLJJL) {
            LJJLIIIJILLIZJL().LJJLIIIJL(false);
        }
        C81583W0d LJJLIIIJILLIZJL = LJJLIIIJILLIZJL();
        LJJLIIIJILLIZJL.LJLJJLL = textViewGuideModel;
        LJJLIIIJILLIZJL.LIZ(parentLayout);
    }

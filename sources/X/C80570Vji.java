...
public class C80570Vji extends AbstractC270614k {
    public final /* synthetic */ ViewPagerBottomSheetBehavior LIZ;

    public C80570Vji(ViewPagerBottomSheetBehavior viewPagerBottomSheetBehavior) {
    ...
    public final boolean tryCaptureView(View view, int i) {
        ...
        if ((i2 == 3 && viewPagerBottomSheetBehavior.LJIJI == i && (view2 = viewPagerBottomSheetBehavior.LJIILL.get()) != null && view2.canScrollVertically(-1)) || (reference = this.LIZ.LJIILJJIL) == null || reference.get() != view) {
            return false;
        }
        return true;
    }
    ...
    public final void onViewReleased(View view, float f, float f2) {
        ...
        if (this.LIZ.LJIIIZ.LJIJI(view.getLeft(), i)) {
            ...
            C16300kU.LJIIL(view, new RunnableC80571Vjj(this.LIZ, view, i2));
        } else {

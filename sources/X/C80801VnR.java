...
public class C80801VnR extends C16120kC {
    public final /* synthetic */ C80795VnL LIZ;

    public C80801VnR(C80795VnL c80795VnL) {
        this.LIZ = c80795VnL;
    }
    ...
    */
    public final void onInitializeAccessibilityEvent(android.view.View r4, android.view.accessibility.AccessibilityEvent r5) {
        ...
        L51:
            ...
            goto L22
        */
        throw new UnsupportedOperationException("Method not decompiled: X.C80801VnR.onInitializeAccessibilityEvent(android.view.View, android.view.accessibility.AccessibilityEvent):void");
    }
    ...
    public final boolean performAccessibilityAction(View view, int i, Bundle bundle) {
        ...
        if (i != 4096) {
            ...
            C80795VnL c80795VnL = this.LIZ;
            c80795VnL.setCurrentItem(c80795VnL.LJLJL - 1);
            return true;
        }
        if (!this.LIZ.canScrollVertically(1)) {
            return false;
        }
        C80795VnL c80795VnL2 = this.LIZ;
        c80795VnL2.setCurrentItem(c80795VnL2.LJLJL + 1);
        return true;
    }
}

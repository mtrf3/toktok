...
public final class MKM extends RecyclerView {
    ...
    private final RecyclerView getNestedRc() {
        ...
        if (recyclerView2 == null || !recyclerView2.isAttachedToWindow() || ((recyclerView = this.LLLIIII) != null && !recyclerView.getGlobalVisibleRect(this.LLLFFI))) {
            ...
            while (!this.LLLFZ.isEmpty()) {
                ...
                if (viewGroup != null) {
                    Iterator it = new IDObjectS326S0100000_1(viewGroup, 7).iterator();
                    while (it.hasNext()) {
    ...
    public final void LJLJJL(InterfaceC65784Pro<C76800UCe> interfaceC65784Pro) {
        RecyclerView nestedRc = getNestedRc();
        this.LLLIIII = nestedRc;
        if (nestedRc != null) {
            nestedRc.LJLI(0);
        }
        LJIIJJI(new IDrS13S0200000_9((C56042Lz4) interfaceC65784Pro, this, 3));
        LJLIL(0);
    }

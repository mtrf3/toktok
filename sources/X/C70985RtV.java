...
public final class C70985RtV extends AbstractC70875Rrj {
    public C70985RtV() {
        super("tiktokec_product_detail_page_video_stay_time", "lib_track_builtin_lane_business");
    }

    @Override // X.AbstractC71002Rtm
    public final C71007Rtr LIZ() {
        QSQ qsq = new QSQ(3);
        qsq.LIZ(new C71006Rtq("video_id", new C71008Rts[0]));

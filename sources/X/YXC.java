...
public final class YXC extends C1CG<YXF> {
    @Override // X.C0BI
    public final String LIZIZ() {
        return "INSERT OR REPLACE INTO `RECENT_SHARE` (`ID`,`SHARE_TIME`,`SEND_TIME`,`CURR_UID`,`SHARE_TYPE`) VALUES (?,?,?,?,?)";
    }

    public YXC(AbstractC03300Ba abstractC03300Ba) {

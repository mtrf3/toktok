...
public final class C78534Ury implements InterfaceC78502UrS {
    public final JSONArray LIZ;

    @Override // X.InterfaceC78502UrS
    public final List<Object> LIZ() {
        return C38385F4r.LIZ(this.LIZ);
    }
    ...
    public C78534Ury(JSONArray origin) {
    ...
    public final InterfaceC78505UrV get(int i) {
        return new C78539Us3(this.LIZ.opt(i));
    }

...
public final class C85138XbC implements R47 {
    ...
    public C85138XbC(int i, TwoStepVerificationManageActivity twoStepVerificationManageActivity, String str, String str2, List list, boolean z) {
    ...
    public final void onResult(int i, int i2, Object obj) {
        if (i2 == 1) {
            ...
            o.LJI(twoSvUserData);
            twoSvUserData.setHas_pwd(Boolean.TRUE);

...
public final class C35995EAt {
    public static final /* synthetic */ int LIZ = 0;

    public static C35996EAu LIZ(android.net.Uri uri) {
        if (uri == null) {
            return null;
        }
        try {
            ...
            if (ujb.o.LJJJLIIL(builder, "/data/", false) || ujb.o.LJJJLIIL(builder, "local_file://", false)) {
                ...
                return new C35996EAu(builder, null, queryParameterNames);
            }
            String str = "";
            if (uri.getScheme() == null && uri.getHost() == null) {
                ...
                return new C35996EAu(builder, "", queryParameterNames2);
            }
            ...
            return new C35996EAu(LIZIZ, path, queryParameterNames3);
        } catch (Throwable th) {
    ...
    public static C35996EAu LIZIZ(String str) {
        if (str == null) {
            return null;
        }
        try {

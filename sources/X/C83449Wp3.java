...
public final class C83449Wp3 extends AbstractC83417WoX {
    ...
    public final C83427Woh<ActionAIMusicInfoList> LIZLLL() {
        ...
        return new C83427Woh<>(interfaceC83402WoI, new C83451Wp5(this));
    }
    ...
    public C83449Wp3(LifecycleOwner lifecycleOwner, Context context, C82622Wbi diContainer) {
        super(lifecycleOwner, context, diContainer);
        o.LJIIIZ(lifecycleOwner, "lifecycleOwner");
        o.LJIIIZ(diContainer, "diContainer");
        this.LJI = context;
        this.LJII = C221108m2.LIZIZ(new AqS161S0200000_14(diContainer, this, 52));
        this.LJIIIIZZ = C221108m2.LIZIZ(new AqS161S0200000_14(diContainer, this, 53));
    }
}

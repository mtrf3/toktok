...
public final class XF8 implements XCP {
    ...
    public final void onSuccess(Effect effect) {
        ...
        if (effect2 != null) {
            C6QQ.LIZ(new AqS0S1500000_15(this.LIZIZ, this.LIZJ, effect2, this.LIZ, this.LIZLLL, effect2, 1));
        }
    }
    ...
    public XF8(NLELokiResourceProtocol nLELokiResourceProtocol, NLEResourceCallback nLEResourceCallback, XF5 xf5, String str) {

...
public final /* synthetic */ class SOL extends TBS implements InterfaceC88475Ynv<FollowingVisibilityViewModel, Context, LifecycleOwner, PrivacySettingsAdapterConfigs, SKL, SMD> {
    public static final SOL LJLIL = new SOL();

    public SOL() {
        super(5, SMD.class, "<init>", "<init>(Lcom/ss/android/ugc/tiktok/tpsc/settings/account/adapters/following/FollowingVisibilityViewModel;Landroid/content/Context;Landroidx/lifecycle/LifecycleOwner;Lcom/ss/android/ugc/tiktok/tpsc/settings/account/PrivacySettingsAdapterConfigs;Lcom/ss/android/ugc/tiktok/tpsc/utils/ToastHolder;)V", 0);
    }

    @Override // X.InterfaceC88475Ynv
    public final SMD invoke(FollowingVisibilityViewModel followingVisibilityViewModel, Context context, LifecycleOwner lifecycleOwner, PrivacySettingsAdapterConfigs privacySettingsAdapterConfigs, SKL skl) {

...
public class C74063T4x extends View {
    public Paint LJLIL;
    ...
    public final void LIZ() {
        ...
        if (!this.LJLJJI) {
            ...
            this.LJZ.addUpdateListener(new AUListenerS99S0100000_12(this, 17));
            this.LJZ.start();
            return;
        }
        this.LJLL = 15.0f;
        ...
        while (true) {
            ...
            if (i < i2) {
                ...
                ofFloat2.addUpdateListener(new AUListenerS99S0100000_12(this, 18));
                ...
                ofFloat3.addUpdateListener(new AUListenerS99S0100000_12(this, 19));
                ...
                ofFloat4.addUpdateListener(new AUListenerS0S0100002_12(this, f4, LIZIZ, 1));
                ...
                ofFloat5.addUpdateListener(new AUListenerS99S0100000_12(this, 20));
                ...
                this.LJZI.addListener(new ALAdapterS3S0110000_12(this, 3));
                this.LJZI.start();
                return;
            }
        }
    ...
    public C74063T4x(Context context, AttributeSet attributeSet) {
        ...
        this.LJLJLJ = obtainStyledAttributes.getFloat(10, resources.getInteger(R.integer.b6));
        this.LJLJLLL = obtainStyledAttributes.getFloat(9, resources.getInteger(R.integer.b5));
        this.LJLLILLLL = obtainStyledAttributes.getDimensionPixelSize(12, resources.getDimensionPixelSize(R.dimen.l9));
        this.LJLJJI = obtainStyledAttributes.getBoolean(8, resources.getBoolean(R.bool.f));
        this.LJLJJL = obtainStyledAttributes.getBoolean(2, resources.getBoolean(R.bool.e));
        float f = obtainStyledAttributes.getFloat(11, resources.getInteger(R.integer.b7));
        this.LJZL = f;
        this.LJLZ = f;
        int identifier = getContext().getResources().getIdentifier("colorAccent", "attr", getContext().getPackageName());
        if (obtainStyledAttributes.hasValue(7)) {
            this.LJLLJ = obtainStyledAttributes.getColor(7, resources.getColor(R.color.ht));
            ...
            this.LJLLJ = obtainStyledAttributes2.getColor(0, resources.getColor(R.color.ht));
            obtainStyledAttributes2.recycle();
        }
        this.LJLLL = obtainStyledAttributes.getInteger(3, resources.getInteger(R.integer.b1));
        this.LJLLLL = obtainStyledAttributes.getInteger(5, resources.getInteger(R.integer.b3));
        obtainStyledAttributes.getInteger(6, resources.getInteger(R.integer.b4));
        this.LJLLLLLL = obtainStyledAttributes.getInteger(4, resources.getInteger(R.integer.b2));

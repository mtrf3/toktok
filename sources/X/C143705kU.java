...
public final class C143705kU extends AbstractC29891Fh<InterfaceC143715kV> implements InterfaceC143795kd, InterfaceC143715kV, InterfaceC135635Tz {
    ...
    public final InterfaceC143715kV LJLJJI;
    public final InterfaceC115514g7 LJLJJL;

    static {
        TBT tbt = new TBT(C143705kU.class, "planCUIApiComponent", "getPlanCUIApiComponent()Lcom/ss/android/ugc/aweme/shortvideo/component/PlanCUIApiComponent;", 0);
    ...
    public final InterfaceC45999I3n getPlanCUIApiComponent() {
        return (InterfaceC45999I3n) this.LJLJJL.LIZ(this, LJLJJLL[0]);
    }

    @Override // X.AbstractC29891Fh
    public void onCreate() {
        super.onCreate();
        this.LJLIL.add(R.id.iri, new C143685kS(this.LJLJI), "TnSNoticeScene");
        getPlanCUIApiComponent().Et().LIZIZ(this, new AObjectS84S0100000_2(this, 217));
    }

    @Override // X.AbstractC29891Fh
    public /* bridge */ /* synthetic */ InterfaceC143715kV getApiComponent() {
        return this.LJLJJI;
    }
    ...
    public final void LJJLI(boolean z) {
        WMH wmh = this.LJLIL;
        if (z) {
            C79234V7u.LJJJ(wmh, "TnSNoticeScene");
        } else {
            C79234V7u.LJIL(wmh, "TnSNoticeScene");
        }
    }
    ...
    public C143705kU(WMH parentScene, C82622Wbi diContainer, int i) {
        ...
        this.LJLJI = i;
        this.LJLJJI = this;
        this.LJLJJL = UCI.LJI(getDiContainer(), InterfaceC45999I3n.class, null);
    }

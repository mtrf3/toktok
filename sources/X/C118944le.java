...
public final /* synthetic */ class C118944le extends TBS implements InterfaceC65784Pro<C76800UCe> {
    public C118944le(QnaAskQuestionFragment qnaAskQuestionFragment) {
        super(0, qnaAskQuestionFragment, QnaAskQuestionFragment.class, "postQuestion", "postQuestion()V", 0);
    }

    @Override // X.InterfaceC65784Pro
    public final C76800UCe invoke() {
        ((QnaAskQuestionFragment) this.receiver).Il();

...
public final class UA6 implements Runnable {
    ...
    public UA6(U66 u66, String str, String str2, String str3, String str4, String str5, JSONObject jSONObject, long j, long j2, long j3) {
        this.LJLIL = u66;
        this.LJLILLLLZI = str;
        this.LJLJI = str2;
        this.LJLJJI = str3;
    ...
    public final void LIZ() {
        UAS LIZ = UAO.LIZ(UA9.LIZLLL(), this.LJLIL, this.LJLILLLLZI, this.LJLJI, U85.INVITER, this.LJLJJI, this.LJLJJL, this.LJLJJLL, null, null, 0, 896);
        C76786UBq LJ = UA9.LJ();
        ...
        LJIIZILJ.put("msg_id", this.LJLL);
        C77119UOl.LJJIFFI(LJ, LIZ, jSONObject2, "join_direct_message", LJIIZILJ, this.LJLJLJ, this.LJLJLLL);
        UA9.LJJJI(LIZ);
    }

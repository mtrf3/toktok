...
public final class VYN extends VYP {
    @Override // X.VYP
    public final float LIZ() {
        return 0.0f;
    }

    public final VYY getBean() {
        return null;
    }

    public final VYR getLongTimeClickRunnable() {
        return null;
    }

    public final void setListener(VYQ vyq) {
    }

    public final void setLongTimeClickRunnable(VYR vyr) {
        o.LJIIIZ(vyr, "<set-?>");
    }

    static {
        C16880lQ.LJLLJ(VYN.class);
    }

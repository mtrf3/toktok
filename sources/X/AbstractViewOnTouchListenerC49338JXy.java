...
public abstract class AbstractViewOnTouchListenerC49338JXy implements View.OnTouchListener {
    ...
    public InterfaceC49337JXx LJLJLJ;
    public View.OnTouchListener LJLJLLL;
    public long LJLL;
    public final ARunnableS44S0100000_8 LJLLI;

    public abstract void LIZ(boolean z);

    public AbstractViewOnTouchListenerC49338JXy(Context context) {
        o.LJIIIZ(context, "context");
        this.LJLIL = -1;
        this.LJLJL = LiveMaxRetainAlogMessageSizeSetting.DEFAULT;
        this.LJLIL = ViewConfiguration.get(context).getScaledTouchSlop();
        this.LJLLI = new ARunnableS44S0100000_8(this, 182);
    }

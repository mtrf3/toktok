...
public final class C6KU extends FrameLayout {
    ...
    public C6KU(Context context, AttributeSet attributeSet) {
        ...
        if (view != null) {
            ...
            this.LJLILLLLZI = new C6KT(context2);
            ...
            if (view2 != null) {
                ...
                ofFloat.addUpdateListener(new AUListenerS91S0100000_2(this, 15));
                ofFloat2.addUpdateListener(new AUListenerS91S0100000_2(this, 16));
                return;
            }
            o.LJIJI("centerView");
            throw null;

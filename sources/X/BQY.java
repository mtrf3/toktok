...
public final class BQY extends C31073CHl {
    public final /* synthetic */ SubscribeIconWidget LJLJL;

    @Override // X.C31073CHl
    public final void LJFF() {
        C2A4 c2a4 = this.LJLJL.LJLJJLL;
        if (c2a4 != null) {
            C29306Beo.LJIIIZ(c2a4);
        }
    }

    public BQY(SubscribeIconWidget subscribeIconWidget) {
        this.LJLJL = subscribeIconWidget;
    }
    ...
    public final void LJI(Animatable anim) {
        ...
        LJII.LJIIJJI(this.LJLJL.LJLJJL);
    }

    @Override // X.C31073CHl
    public final void LJII(Animatable anim) {
        o.LJIIIZ(anim, "anim");
        ImageView imageView = this.LJLJL.LJLJJL;
        if (imageView != null) {

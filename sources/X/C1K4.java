...
public class C1K4 extends FrameLayout implements C0RR {
    public C0RP LJLIL;
    ...
    public C1K4(Context context, AttributeSet attributeSet) {
        super(context, attributeSet);
    }

    public C1K4(Context context, AttributeSet attributeSet, int i) {

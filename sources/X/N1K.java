...
public final class N1K extends AbstractC65781Prl implements InterfaceC88472Yns<M95, String> {
    public static final N1K LJLIL = new N1K();
    ...
    public final String invoke(M95 m95) {
        ...
        if (LIZ != null) {
            return ((AdWebLogModel) LIZ).getWebUrl();
        }

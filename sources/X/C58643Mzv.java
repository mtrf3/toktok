...
public final class C58643Mzv extends AbstractC65781Prl implements InterfaceC88472Yns<M95, Long> {
    public static final C58643Mzv LJLIL = new C58643Mzv();
    ...
    public final Long invoke(M95 m95) {
        ...
        if (LIZ != null) {
            return Long.valueOf(((InterfaceC58799N5v) LIZ).getCurrentPosition());
        }

...
public final class LIE extends AbstractC65781Prl implements InterfaceC65784Pro<Boolean> {
    public static final LIE LJLIL = new LIE();
    ...
    public final Boolean invoke() {
        ...
        boolean z = true;
        if (friendsTabPreloadStrategyModel.enablePollingOnBackground != 1) {
            z = false;
        }

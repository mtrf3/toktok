...
public class C80676VlQ extends LinearLayout {
    public int LJLIL;
    ...
    public int LJLLJ;
    public final /* synthetic */ C80675VlP LJLLL;
    ...
    public C80676VlQ(C80675VlP c80675VlP, Context context) {
        super(context);
        this.LJLLL = c80675VlP;
        this.LJLJI = -1;
        this.LJLJJL = -1;
        this.LJLJJLL = -1;
        this.LJLJL = -1;
        c80675VlP.LJIIIIZZ(27);
    ...
    public final void LIZ(int i, int i2) {
        ...
        if (i4 != left || i3 != right) {
            ...
            valueAnimator2.setInterpolator(C80675VlP.LLIIIZ);
            valueAnimator2.setDuration(i2);
            valueAnimator2.setFloatValues(0.0f, 1.0f);
            valueAnimator2.addUpdateListener(new AUListenerS1S0104000_14(this, i4, left, i3, right, 2));
            valueAnimator2.addListener(new ALAdapterS3S0101000_14(this, i, 2));
    ...
    public final void onMeasure(int i, int i2) {
        ...
        C80675VlP c80675VlP = this.LJLLL;
        int i6 = c80675VlP.LJZL;
        if (i6 == 1) {
            if (c80675VlP.LJZI != 1 || i4 <= 0) {
                return;
            }
            if (i4 * childCount <= getMeasuredWidth() - (c80675VlP.LJIIIIZZ(16) * 2)) {
                boolean z2 = false;
                while (i3 < childCount) {
                ...
                C80675VlP c80675VlP2 = this.LJLLL;
                c80675VlP2.LJZI = 0;
                c80675VlP2.LJIJJ(false);
            }
            super.onMeasure(i, i2);
            return;
        }
        if (i6 != 0 || !c80675VlP.LLD || i4 <= 0) {
            return;
        }
        int i7 = 0;

...
public final class C202597xH extends FrameLayout {
    ...
    public final void LIZIZ() {
        ...
        ofFloat.addUpdateListener(new AUListenerS95S0200000_3(activeIcon, this, 3));
        ValueAnimator ofFloat2 = ObjectAnimator.ofFloat(1.0f, 0.0f);
        ofFloat2.setInterpolator(new DecelerateInterpolator(1.5f));
        ofFloat2.setDuration(200L);
        ofFloat2.addUpdateListener(new AUListenerS95S0200000_3(inactiveIcon, this, 4));
        ofFloat.start();
        ofFloat2.start();
    }
    ...
    public C202597xH(Context context, AttributeSet attributeSet) {
        super(context, attributeSet, 0);
        this.LJLJI = C62850Ola.LJFF(context, "context");
        this.LJLIL = C221108m2.LIZIZ(new AqS153S0100000_3(this, 1761));
        this.LJLILLLLZI = C221108m2.LIZIZ(new AqS153S0100000_3(this, 1760));
        C16880lQ.LLLZIIL(R.layout.cpd, C16880lQ.LLZIL(context), this);
    }
}

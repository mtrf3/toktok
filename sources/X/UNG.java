...
public final class UNG extends DataChannelSceneObserver<EnumC30738C4o, LiveCenterStatusChannel> {
    ...
    public final void onEvent(LayeredElementContext layeredElementContext, ConstraintProperty constraintProperty, EnumC30738C4o enumC30738C4o) {
        ...
        if (!LiveMemoryOptSetting.INSTANCE.enableMemoryOpt()) {
            ...
            this.LIZ.LIZ().addUpdateListener(new AUListenerS100S0100000_13(constraintProperty, 85));
            this.LIZ.LIZ().start();
        }
    }
}

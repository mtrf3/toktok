...
public class C1K6 extends LinearLayout implements C0RR {
    public C0RP LJLIL;
    ...
    public C1K6(Context context, AttributeSet attributeSet) {
        super(context, attributeSet);
    }

    public C1K6(Context context, AttributeSet attributeSet, int i) {

...
public final class C43959HNb implements InterfaceC84907XTz {
    ...
    public final void LIZIZ(AVMusic aVMusic) {
        ...
        if (AVCommerceServiceImpl.LJIIJ().LIZ() && !aVMusic.isCommerceMusic()) {
            this.LIZ.invoke();
            return;
        }
        ...
        if (!z && FileUtils.INSTANCE.checkFileExists(LIZIZ)) {
            ...
            LJJIJ2.LJIILL(application, aVMusic, 0, false, new C43960HNc(this.LIZJ, this.LIZLLL, aVMusic, this.LIZ));
        }
    }

    public C43959HNb(String str, InterfaceC65784Pro interfaceC65784Pro, InterfaceC88472Yns interfaceC88472Yns, InterfaceC88471Ynr interfaceC88471Ynr, boolean z) {

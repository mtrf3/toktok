...
public final class C69058R8k extends R4N {
    public final /* synthetic */ C45R<R40<C69061R8n>> LIZ;
    public final /* synthetic */ InterfaceC69056R8i LIZIZ;

    @Override // X.AbstractC67055QTj
    /* renamed from: LIZIZ, reason: merged with bridge method [inline-methods] */
    public final void onSuccess(R40<C69061R8n> response) {
        o.LJIIIZ(response, "response");
        C69061R8n c69061R8n = response.LJIIIZ;
        if (c69061R8n != null && c69061R8n.LJFF != null) {
            ((C73516StE) this.LIZ).onSuccess(response);
            return;
        }
        C45R<R40<C69061R8n>> c45r = this.LIZ;
    ...
    public C69058R8k(InterfaceC69056R8i interfaceC69056R8i, C73516StE c73516StE) {
        this.LIZ = c73516StE;
    ...
    public final void onError(R40<C69061R8n> r40, int i) {
        String str;
        C45R<R40<C69061R8n>> c45r = this.LIZ;
        if (r40 != null) {
            str = r40.LJFF;

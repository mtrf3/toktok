...
public class C81213Vu5 extends View {
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (action != 0) {
            if (action != 1) {
                if (action != 2) {
                    ...
                    if (this.LJLLILLLL && !this.LJLLJ && (gbj3 = this.LJLLLLLL) != null) {
                        gbj3.LIZIZ(this.LJLIL[this.LJLILLLLZI]);
                    }
                    invalidate();
                    return true;
                }
            }
            if (this.LJLLJ && (gbj2 = this.LJLLLLLL) != null) {
                gbj2.LIZIZ(this.LJLIL[this.LJLILLLLZI]);
            }
            this.LJLILLLLZI = -1;
        ...
        if (this.LJLJLLL.contains(x, y)) {
            this.LJLLILLLL = true;
            if (!this.LJLLJ && (gbj = this.LJLLLLLL) != null) {
                gbj.LIZIZ(this.LJLIL[this.LJLILLLLZI]);
            }
            invalidate();
            return true;
        }
    ...
    public void setOnSelectIndexItemListener(GBJ gbj) {
        this.LJLLLLLL = gbj;
    }
    ...
    public C81213Vu5(Context context, AttributeSet attributeSet) {

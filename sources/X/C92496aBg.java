...
public final class C92496aBg extends AbstractC65781Prl implements InterfaceC88473Ynt<InterfaceC07790Sh, InterfaceC24520xk, Integer, C76800UCe> {
    ...
    public C92496aBg(int i, int i2, String str, String str2, String str3, InterfaceC88472Yns interfaceC88472Yns, InterfaceC88472Yns interfaceC88472Yns2, boolean z, boolean z2) {
        super(3);
        this.LJLIL = str;
    ...
    public final C76800UCe invoke(InterfaceC07790Sh interfaceC07790Sh, InterfaceC24520xk interfaceC24520xk, Integer num) {
        ...
        if (((intValue & 91) ^ 18) != 0 || !interfaceC24520xk2.LIZ()) {
            ...
            int i4 = i3 >> 3;
            String str4 = str;
            C92026a46.LIZ(str2, it, interfaceC88472Yns, interfaceC88472Yns2, i2, c18880oe, null, null, str3, str4, z, z2, false, null, null, null, false, 0, null, interfaceC24520xk2, ((intValue << 3) & 112) | (i3 & 14) | (i4 & 896) | (i4 & 7168) | (i4 & 57344) | ((i3 << 18) & 234881024), ((i3 >> 21) & 14) | ((i3 >> 24) & 112), 520384);
        } else {

...
public final class C92983aJX extends AbstractC65781Prl implements InterfaceC88471Ynr<InterfaceC24520xk, Integer, C76800UCe> {
    ...
    public C92983aJX(boolean z, boolean z2, InterfaceC88471Ynr<? super InterfaceC24520xk, ? super Integer, C76800UCe> interfaceC88471Ynr, int i, boolean z3) {
        super(2);
        this.LJLIL = z;
        this.LJLILLLLZI = z2;
        ...
        if (((num.intValue() & 11) ^ 2) != 0 || !interfaceC24520xk2.LIZ()) {
            if (!this.LJLIL) {
                ...
                if (interfaceC24520xk2.LJJ() instanceof InterfaceC24420xa) {
                    ...
                    if (z) {
                        interfaceC24520xk2.LJJIIJ(1215860815);
                        interfaceC24520xk2.LJJIIJ(1215860858);
                        if (interfaceC88471Ynr != null) {
                            interfaceC88471Ynr.invoke(interfaceC24520xk2, Integer.valueOf((i >> 24) & 14));
                        }
                        interfaceC24520xk2.LJJIJIIJIL();
                        C92010a3q.LIZ(null, interfaceC24520xk2, 0, 1);
                        interfaceC24520xk2.LJJIJIIJIL();
                    } else {
                        interfaceC24520xk2.LJJIIJ(1215860937);
                        if (z2) {
                            interfaceC24520xk2.LJJIIJ(1215860978);
                            C92009a3p.LIZ(interfaceC24520xk2, 0);
                            interfaceC24520xk2.LJJIJIIJIL();
                        } else {
                            interfaceC24520xk2.LJJIIJ(1215861061);
                            C92010a3q.LIZ(null, interfaceC24520xk2, 0, 1);
                            interfaceC24520xk2.LJJIJIIJIL();
                        }
                        interfaceC24520xk2.LJJIJIIJIL();

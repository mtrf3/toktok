...
public final class ULC extends AbstractC65781Prl implements InterfaceC88472Yns<GroupableElementSpecImpl, C76800UCe> {
    public static final ULC LJLIL = new ULC();
    ...
    public final C76800UCe invoke(GroupableElementSpecImpl groupableElementSpecImpl) {
        ...
        groupableElement.bindGroup(UKC.LIZJ);

...
public final class C57234MdC extends AbstractC65781Prl implements InterfaceC88471Ynr<VideoMusicCoverAssem, C43I<? extends Integer>, C76800UCe> {
    public static final C57234MdC LJLIL = new C57234MdC();
    ...
    public final C76800UCe invoke(VideoMusicCoverAssem videoMusicCoverAssem, C43I<? extends Integer> c43i) {
        ...
        o.LJIIIZ(it, "it");
        if (((Number) it.LIZ).intValue() != 0) {
            VideoMusicCoverVM D4 = selectSubscribeOnAsync.D4();
            if (D4.LJLJLLL && !D4.kv0()) {
                if (!L4E.LIZ.needFixMarqueeAnim) {
                    D4.LJLJLLL = false;
                    new Handler(C16880lQ.LLJJJJ()).post(new ARunnableS45S0100000_9(D4, 143));
                } else {
                    new Handler(C16880lQ.LLJJJJ()).post(new ARunnableS45S0100000_9(D4, 145));
                }
            }
        }

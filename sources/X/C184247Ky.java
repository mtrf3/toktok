...
public final class C184247Ky extends AbstractC65781Prl implements InterfaceC88472Yns<C8V4, C76800UCe> {
    public static final C184247Ky LJLIL = new C184247Ky();
    ...
    public final C76800UCe invoke(C8V4 c8v4) {
        ...
        uiContentAssem.LIZ = C65352Pkq.LIZ(StickerSetDetailFooterAssem.class);
        uiContentAssem.LJIIIIZZ = new StickerSetDetailFooterAssem();
        uiContentAssem.LJI = R.id.kje;

...
public final class UY3 implements InterfaceC14120gy {
    public final /* synthetic */ InterfaceC88471Ynr<Integer, String, C76800UCe> LJLIL;

    /* JADX WARN: Multi-variable type inference failed */
    public UY3(InterfaceC88471Ynr<? super Integer, ? super String, C76800UCe> interfaceC88471Ynr) {
    ...
    public final void LJ(View v, C0KG c0kg, LiveActionSheetDialog liveActionSheetDialog) {
        o.LJIIIZ(v, "v");
        this.LJLIL.invoke(Integer.valueOf(R.raw.icon_misc), "Misc");

...
public final class SKS extends SKX {
    ...
    public SKS(MutableLiveData<Integer> currentValue) {
    ...
    public final void LIZLLL(SKV holder) {
        ...
        int i = 8;
        holder.itemView.findViewById(R.id.wi).setVisibility(8);
        View findViewById = holder.itemView.findViewById(R.id.ihn);

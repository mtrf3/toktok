...
public final class C79448VGa implements InterfaceC72616Sei {
    ...
    public final void LJJLI() {
        ...
        GLES20.glTexParameteri(3553, 10241, 9729);
        GLES20.glTexParameteri(3553, 10240, 9729);
        GLES20.glTexImage2D(3553, 0, 6408, this.LJ, this.LJFF, 0, 6408, 5121, null);
        int[] iArr16 = this.LJJJJZI;
        o.LJI(iArr16);
        GLES20.glFramebufferTexture2D(36160, 36064, 3553, iArr16[0], 0);
        int[] iArr17 = this.LJJJJIZL;
        o.LJI(iArr17);
        ...
        if (this.LIZJ != null) {
            ...
            if (z) {
                if (this.LJIILL) {
                    ...
                    int[] iArr3 = this.LJJJJZ;
                    o.LJI(iArr3);
                    LIZIZ(1.0f, i, iArr3[0]);
                } else {
                    int i3 = this.LJFF;
            ...
            if (this.LJIILL) {
                ...
                long j2 = this.LIZ;
                int[] iArr5 = this.LJJJJZI;
                o.LJI(iArr5);
                BEFEffectNative.nativeProcessAlgorithm(j2, iArr5[0], this.LJ, this.LJFF, nanoTime);
                long j3 = this.LIZ;
                ...
                int[] iArr7 = this.LJJJJL;
                o.LJI(iArr7);
                BEFEffectNative.nativeProcessFrame(j3, i4, iArr7[0], this.LJ, this.LJFF, nanoTime);
            } else {
                StringBuilder LIZ5 = X1D.LIZ();
                LIZ5.append("process algorithm: preview texture dimensions - mWidth=");
                LIZ5.append(this.LJ);
                LIZ5.append(", mHeight=");
                LIZ5.append(this.LJFF);
                H78.LIZIZ("NaviRender", X1D.LIZIZ(LIZ5));
                StringBuilder LIZ6 = X1D.LIZ();
                LIZ6.append("process frame: output texture dimensions - mWidth=");
                LIZ6.append(this.LJ);
                LIZ6.append(", mHeight=");
                ...
                if (!C34506DgU.LIZ) {
                    long j4 = this.LIZ;
                    int[] iArr8 = this.LJJJJLL;
                    o.LJI(iArr8);
                    BEFEffectNative.nativeProcessAlgorithm(j4, iArr8[0], this.LJ, this.LJFF, nanoTime);
                }
                if (this.LJIILLIIL) {
                    ...
                    int[] iArr10 = this.LJJJJJ;
                    o.LJI(iArr10);
                    i2 = iArr10[0];
                }
                long j5 = this.LIZ;
                int[] iArr11 = this.LJJJJL;
                o.LJI(iArr11);
                BEFEffectNative.nativeProcessFrame(j5, i2, iArr11[0], this.LJ, this.LJFF, nanoTime);
            }
        } else {
            GLES20.glViewport(0, 0, this.LJ, this.LJFF);
            int[] iArr12 = this.LJJJJJ;
            o.LJI(iArr12);
            int i5 = iArr12[0];
            int[] iArr13 = this.LJJJJJL;
            o.LJI(iArr13);
            LIZIZ(0.0f, i5, iArr13[0]);
        }
        if (this.LJIILJJIL) {
            ...
            float f10 = 2;
            float f11 = f7 * f5;
            GLES20.glViewport((int) ((f3 - f9) / f10), (int) ((f6 - f11) / f10), (int) f9, (int) f11);
            int[] iArr14 = this.LJJJJL;
            o.LJI(iArr14);
            LIZIZ(0.0f, iArr14[0], 0);
            GLES20.glFlush();
    ...
    public final void LJJL(int i, int i2) {
        ...
        if (C34505DgT.LIZ) {
            ...
            i3 = ((TikTokResolution.TiktokResolution) c62822Ol8.getValue()).width;
            i4 = ((TikTokResolution.TiktokResolution) c62822Ol8.getValue()).height;
        } else {
            i3 = i;
            i4 = i2;
        }

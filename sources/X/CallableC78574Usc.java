...
public class CallableC78574Usc implements Callable {
    ...
    public final Object call() {
        ...
        try {
            ...
            C78579Ush.LIZLLL(context);
            InterfaceC30442Bx8.LJJJJZI.LIZJ().booleanValue();
        ...
        try {
            ...
            if (((IHostAppContext) CN1.LIZ(IHostAppContext.class)).isLocalTest()) {
                new Handler(C16880lQ.LLJJJJ()).post(new ARunnableS42S0100000_6(th2, 69));
            } else {
                C78579Ush.LJ(4, th2);
            }
        }
    ...
    public CallableC78574Usc(int i, int i2, String str, String str2, JSONObject jSONObject, String str3) {
        this.LJLILLLLZI = i;
        this.LJLJI = i2;
        this.LJLJJI = str;
        this.LJLJJL = str2;

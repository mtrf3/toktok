...
public final class C78297Uo9 extends IO1 {
    public long LIZ;
    ...
    public final void LIZ() {
        ...
        c78263Unb.getClass();
        c78263Unb.LIZ(enumC77751UfL, "livesdk_iap_start_check_order_receipt", jSONObject2, null, jSONObject);
    }

    public final void LIZIZ(boolean z, int i, C78368UpI c78368UpI) {
        long j;
        String str;
        long j2 = 0;
        if (this.LIZ > 0) {
        ...
        add(jSONObject2, "merchant_id", this.LIZLLL);
        if (c78368UpI != null) {
            add(jSONObject2, "result_code", c78368UpI.getCode());
            add(jSONObject2, "result_detail_code", c78368UpI.getDetailCode());
            add(jSONObject2, "result_message", c78368UpI.getMessage());
        } else {
        ...
        EnumC77751UfL enumC77751UfL = EnumC77751UfL.BOTH;
        if (z) {
            str = "livesdk_iap_check_order_receipt_success";
        } else {
            str = "livesdk_iap_check_order_receipt_fail";
        }
        C78263Unb c78263Unb = (C78263Unb) LJFF;
        c78263Unb.getClass();
        c78263Unb.LIZ(enumC77751UfL, str, jSONObject2, jSONObject, jSONObject3);
    }

    public C78297Uo9(OrderData orderData, PayType payType, String str, String str2, boolean z) {
        this.LIZIZ = str;
        this.LIZJ = str2;
        this.LJ = z;
        this.LJI = orderData;

...
public final class C82037WHp extends AbstractC029409q<C82032WHk> {
    ...
    public final void onBindViewHolder(C82032WHk c82032WHk, int i) {
        ...
        C82033WHl LIZIZ = this.LJLILLLLZI.LIZIZ(i);
        if (LIZIZ != null) {
            holder.L(LIZIZ);
        }
    }
    ...
    public final C82032WHk com_ss_android_ugc_aweme_ecommerce_global_osp_module_usertrust_UserTrustItemAdapter__onCreateViewHolder$___twin___(ViewGroup parent, int i) {
        ...
        View itemView = C16880lQ.LLLLIILL(C16880lQ.LLZIL(this.LJLIL), R.layout.crt, parent, false);
    ...
    public C82037WHp(Context context, WJA toolbarManager, C82091WJr uiAction, boolean z) {

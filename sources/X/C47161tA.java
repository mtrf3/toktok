...
public class C47161tA extends C45081po implements InterfaceC36821cU {
    public C55632Gh<C47161tA> LJLJJI;
    ...
    public C47161tA(final Context context, final AttributeSet attributeSet) {
        new C1K8(context, attributeSet) { // from class: X.1po
        ...
        C55632Gh<C47161tA> c55632Gh = new C55632Gh<>(this);

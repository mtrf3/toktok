...
public final class TZ4 implements InterfaceC75414Tik<InviteResult> {
    ...
    public final void onSuccess(InviteResult value) {
        ...
        map.put(valueOf, LIZ);
        if (this.LJLJI.LIZJ == 4 && C74726TUk.LIZ()) {
            TZK tzk = this.LJLIL.LJLJL;
            if (tzk != null) {
                this.LJLJI.LIZ.getId();
                tzk.LJJ();
                return;
            }
            return;
    ...
    public final void LJ(LinkCoreError error, Throwable th) {
        ...
        if (this.LJLJI.LIZJ == 4 && C74726TUk.LIZ() && (tzk = this.LJLIL.LJLJL) != null) {
            tzk.LJIILLIIL(this.LJLJI.LIZ.getId(), th);
        }
    }

    public TZ4(C74842TYw c74842TYw, long j, TZQ tzq, String str, int i) {

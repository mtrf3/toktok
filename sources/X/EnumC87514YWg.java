...
public enum EnumC87514YWg {
    ...
    COLUMN_WELCOME_MESSAGE_ENABLED("WELCOME_MESSAGE_ENABLED", "INTEGER NOT NULL DEFAULT 0");

    public final String key;
    public final String type;

    public static EnumC87514YWg valueOf(String str) {
        return (EnumC87514YWg) V0N.LJJJ(EnumC87514YWg.class, str);
    }

    EnumC87514YWg(String str, String str2) {
        this.key = str;
        this.type = str2;
    }
}

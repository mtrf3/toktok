...
public final class GAC extends GUX {
    ...
    public GAC(InterfaceC88471Ynr<? super Integer, Object, C76800UCe> interfaceC88471Ynr, InterfaceC88471Ynr<? super Boolean, ? super String, C76800UCe> interfaceC88471Ynr2) {
    ...
    public final void onFinish(AbstractC41479GPr result, Object obj, PublishModel publishModel) {
        ...
        if (result instanceof C41505GQr) {
            ...
            this.LJLILLLLZI.invoke(Boolean.FALSE, obj);
        }
    }
}

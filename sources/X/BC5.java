...
public final class BC5 implements InterfaceC72822Si2 {
    public final /* synthetic */ LiveCommentSettingFragmentSheet LJLIL;

    public BC5(LiveCommentSettingFragmentSheet liveCommentSettingFragmentSheet) {
        this.LJLIL = liveCommentSettingFragmentSheet;
    }
    ...
    public final void onReceiveJsEvent(C199097rd c199097rd) {
        ...
        if (o.LJ(c199097rd.LJLIL, "star_comment_setting_event") && (interfaceC78280Uns = c199097rd.LJLILLLLZI) != null) {
            LiveCommentSettingFragmentSheet liveCommentSettingFragmentSheet = this.LJLIL;
            try {
                ...
                if (o.LJ(liveCommentSettingFragmentSheet.LLFFF, "from_page_preview")) {
                    DataChannel LJIILIIL = C51029K0z.LJIILIIL(liveCommentSettingFragmentSheet);
                    if (LJIILIIL != null) {
                        ((C32536Cpo) LJIILIIL.gv0(C2E0.class)).LIZ = starCommentConfig;
                    }
                    liveCommentSettingFragmentSheet.LLFZ = true;
                    return;
                }
                Room Ol = liveCommentSettingFragmentSheet.Ol();
                if (Ol != null) {
                    Ol.starCommentConfig = starCommentConfig;
                }

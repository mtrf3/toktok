...
public final class TR1 implements U62 {
    public final /* synthetic */ C75103Tdj LJLIL;
    ...
    public TR1(C75103Tdj c75103Tdj) {
        this.LJLIL = c75103Tdj;
    }
    ...
    public final void LJJIIZI(String linkMicId, long j) {
        o.LJIIIZ(linkMicId, "linkMicId");
        C75103Tdj c75103Tdj = this.LJLIL;
        User user = c75103Tdj.LLD;
        String str = null;
        if (user != null) {
            LinkPlayerInfo LJJIIZI = c75103Tdj.LJJIIZI(user);
            if (LJJIIZI != null) {

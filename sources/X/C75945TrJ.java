...
public final class C75945TrJ implements C15M {
    public final /* synthetic */ C34K LIZ;

    public C75945TrJ(C34K c34k) {
        this.LIZ = c34k;
    }
    ...
    public final View LIZ(Context context, ViewGroup viewGroup, DialogInterface dialogInterface) {
        ...
        compoundButton.setText(C15380j0.LJIILJJIL(R.string.n9t));
        compoundButton.setOnCheckedChangeListener(new IDCListenerS209S0100000_13(this.LIZ, 1));
        return LLLLIILL;
    }
}

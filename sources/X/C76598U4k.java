...
public final class C76598U4k implements InterfaceC76768UAy<LeaveChannelResult> {
    public final /* synthetic */ InterfaceC75414Tik<LeaveChannelResult> LJLIL;
    ...
    public final void LIZIZ(LeaveChannelResult value) {
        ...
        LIZ.append("leaveChannel success value=");
        LIZ.append(value);
        U4R.LIZLLL("LiveLinkMicSession", X1D.LIZIZ(LIZ));
        InterfaceC75414Tik<LeaveChannelResult> interfaceC75414Tik = this.LJLIL;
        if (interfaceC75414Tik != null) {
            interfaceC75414Tik.onSuccess(value);
        }
    }

    public C76598U4k(InterfaceC75414Tik<LeaveChannelResult> interfaceC75414Tik, U65 u65) {
    ...
    public final void LIZJ(LinkCoreError error, Throwable th) {
        ...
        String LJIIIIZZ = U65.LJIIIIZZ(1019);
        StringBuilder LIZ = X1D.LIZ();
        LIZ.append("leaveChannel fail error=");
        LIZ.append(error);

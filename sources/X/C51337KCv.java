...
public final class C51337KCv extends KD0 {
    ...
    public final RecyclerView.ViewHolder LIZIZ() {
        ...
        if (K7B.LJLILLLLZI.LJJII()) {
            itemView = C50365Jph.LIZIZ(R.layout.ch1, parent);
        } else {
            itemView = C28289B8j.LIZ(parent, R.layout.ch1, parent, false);
        }
        o.LJIIIIZZ(itemView, "itemView");
        return new C51326KCk(itemView, k75, abstractSearchIntermediateFragmentNew, k5c, str);
    }

    public C51337KCv(C51341KCz c51341KCz) {
        this.LIZJ = c51341KCz;
    }
}

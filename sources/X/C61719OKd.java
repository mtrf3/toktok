...
public final class C61719OKd implements InterfaceC65753PrJ<PromoteEntryCheck> {
    public final /* synthetic */ C61723OKh LIZ;
    public final /* synthetic */ Context LIZIZ;

    @Override // X.InterfaceC65753PrJ
    public final void onFailure(Throwable t) {
        o.LJIIIZ(t, "t");
        Activity activity = this.LIZ.LJLJI;
        if (activity != null) {
    ...
    public final void onSuccess(PromoteEntryCheck promoteEntryCheck) {
        ...
        if (!z) {
            ...
            if (!TextUtils.isEmpty(str2)) {
                if (promoteEntryCheck2 != null && (statusMsg = promoteEntryCheck2.getStatusMsg()) != null && (activity = this.LIZ.LJLJI) != null) {
        ...
        if (promoteEntryCheck2 != null && !TextUtils.isEmpty(promoteEntryCheck2.getUrl())) {
            String builder = UriProtector.parse(promoteEntryCheck2.getUrl()).buildUpon().appendQueryParameter("promote_by", "others").toString();
    ...
    public C61719OKd(C61723OKh c61723OKh, Context context) {
        this.LIZ = c61723OKh;
        this.LIZIZ = context;
    }
}

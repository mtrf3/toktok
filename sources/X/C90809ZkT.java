...
public final class C90809ZkT implements IPlayerListener {
    public boolean LIZ;
    ...
    public final void onCompletion() {
        ...
        if (c90444Zea != null && TextUtils.equals(c90444Zea.LIZJ, "BDLink")) {
            this.LIZIZ.LJIIL.d("PlayerController", "BDLink PlayerListener onCompletion");
            this.LIZIZ.LJFF();
        }
    }
    ...
    public final void onLoading() {
        C90444Zea c90444Zea = this.LIZIZ.LJIIJJI;
        if (c90444Zea != null && TextUtils.equals(c90444Zea.LIZJ, "BDLink")) {
            this.LIZIZ.LJIIL.d("PlayerController", "BDLink PlayerListener onLoading");
            this.LIZIZ.LJIIJ();
            TeaEventTrack teaEventTrack = this.LIZIZ.LJIILJJIL;
            if (teaEventTrack != null) {
                teaEventTrack.trackSourceEvent(TeaEventTrack.BYTECASTSDK_INDICATOR_PLAY_PROTOCOL, new C90437ZeT());
            }
        }
    }
    ...
    public final void onPause() {
        C90444Zea c90444Zea = this.LIZIZ.LJIIJJI;
        if (c90444Zea != null && TextUtils.equals(c90444Zea.LIZJ, "BDLink")) {
            this.LIZIZ.LJIIL.d("PlayerController", "BDLink PlayerListener onPause");
            this.LIZIZ.LJIIJJI();
    ...
    public final void onStart() {
        ...
        C90444Zea c90444Zea = this.LIZIZ.LJIIJJI;
        if (c90444Zea != null && TextUtils.equals(c90444Zea.LIZJ, "BDLink")) {
            this.LIZIZ.LJIIL.d("PlayerController", "BDLink PlayerListener onStart");
            ...
            if (TextUtils.equals(this.LIZIZ.LJIIIZ, "STOPPED")) {
                ...
                this.LIZIZ.LJIILIIL.getSourceMonitor().trackByteCastPlaySuccessProtocol("BDLink", str);
                this.LIZIZ.LJIILJJIL.getSourceMonitorUtils().trackByteCastPlaySuccessProtocol("BDLink", str);
                this.LIZ = false;
            }
            this.LIZIZ.LJIIIZ = "PLAYING";
            Dispatcher.getInstance().printThreadPool(this.LIZIZ.LJIIZILJ, "source", "BDLink PlayerListener onStart");
        }
    }
    ...
    public final void onStop() {
        C90444Zea c90444Zea = this.LIZIZ.LJIIJJI;
        if (c90444Zea != null && TextUtils.equals(c90444Zea.LIZJ, "BDLink")) {
            this.LIZIZ.LJIIL.d("PlayerController", "BDLink PlayerListener onStop");
            this.LIZIZ.LJIILL();
        }
    }

    public C90809ZkT(C90442ZeY c90442ZeY) {
    ...
    public final void onSeekComplete(long j) {
        ...
        if (c90444Zea != null && TextUtils.equals(c90444Zea.LIZJ, "BDLink")) {
            ...
            LIZ.append("BDLink PlayerListener onSeekComplete position:");
            LIZ.append(j);
    ...
    public final void onVolumeChanged(float f) {
        ...
        if (c90444Zea != null && TextUtils.equals(c90444Zea.LIZJ, "BDLink")) {
            CastLogger castLogger = this.LIZIZ.LJIIL;
            StringBuilder LIZ = X1D.LIZ();
            LIZ.append("BDLink PlayerListener onVolumeChanged percent:");
            LIZ.append(f);
            castLogger.d("PlayerController", X1D.LIZIZ(LIZ));
    ...
    public final void onDramaId(ServiceInfo serviceInfo, String str) {
        if (str != null) {
            CastLogger castLogger = this.LIZIZ.LJIIL;
            StringBuilder LIZ = X1D.LIZ();
            LIZ.append("BDLink PlayerListener onDramaId id:");
            LIZ.append(str);
            castLogger.d("PlayerController", X1D.LIZIZ(LIZ));
    ...
    public final void onDramaList(ServiceInfo serviceInfo, DramaBean[] dramaBeanArr) {
        if (dramaBeanArr != null) {
            CastLogger castLogger = this.LIZIZ.LJIIL;
            StringBuilder LIZ = X1D.LIZ();
            LIZ.append("BDLink PlayerListener onDramaList dramaBeans:");
    ...
    public final void onError(int i, int i2) {
        ...
        if (c90444Zea != null && TextUtils.equals(c90444Zea.LIZJ, "BDLink")) {
            CastLogger castLogger = this.LIZIZ.LJIIL;
            StringBuilder LIZ = X1D.LIZ();
            LIZ.append("BDLink PlayerListener onError what:");
            LIZ.append(i);
            LIZ.append(", extra:");
            LIZ.append(i2);
            castLogger.d("PlayerController", X1D.LIZIZ(LIZ));
    ...
    public final void onInfo(int i, int i2) {
        ...
        if (c90444Zea != null && TextUtils.equals(c90444Zea.LIZJ, "BDLink")) {
            CastLogger castLogger = this.LIZIZ.LJIIL;
            StringBuilder LIZ = X1D.LIZ();
            LIZ.append("BDLink PlayerListener onInfo what:");
            LIZ.append(i);
            LIZ.append(", extra:");
            LIZ.append(i2);
            castLogger.d("PlayerController", X1D.LIZIZ(LIZ));
    ...
    public final void onPositionUpdate(long j, long j2) {
        ...
        if (c90444Zea != null && TextUtils.equals(c90444Zea.LIZJ, "BDLink")) {
            CastLogger castLogger = this.LIZIZ.LJIIL;
            StringBuilder LIZ = X1D.LIZ();
            LIZ.append("BDLink PlayerListener onPositionUpdate duration:");
            LIZ.append(j);
            LIZ.append(", position:");
            LIZ.append(j2);
            castLogger.d("PlayerController", X1D.LIZIZ(LIZ));
            ...
            if (!this.LIZ && j > 0) {
                this.LIZ = true;
                this.LIZIZ.LJIILIIL.getSourceMonitor().trackVideoDuration("BDLink", j / 1000);
            }
        }
    }
}

...
public final class C70983RtT extends AbstractC70875Rrj {
    public C70983RtT() {
        super("tiktokec_report_entrance_click", "lib_track_builtin_lane_business");
    }

    @Override // X.AbstractC71002Rtm
    public final C71007Rtr LIZ() {
        QSQ qsq = new QSQ(2);
        qsq.LIZ(new C71006Rtq("button_for", new C71008Rts[0]));

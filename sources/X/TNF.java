...
public final class TNF<T, R> implements InterfaceC48038ItG<OSZ<? extends List<? extends ProviderEffect>, ? extends ProviderEffectModel>, List<? extends ProviderEffect>> {
    public static final TNF LJLIL = new TNF();

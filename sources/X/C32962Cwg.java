...
public final class C32962Cwg extends AbstractC39455Fe7 {
    ...
    public C32962Cwg() {
        ...
        dij.LJIIJ(0.15f, -0.02f, 0.3f, 0.02f, 0.45f, 0.1f);
        C32856Cuy.ve(dij);
        ...
        DIJ dij3 = new DIJ();
        this.LJIIIZ = dij3;
        dij3.LJIILIIL(39.77f, 24.0f);
        dij3.LJIIL(-1.25f, -0.93f);
        dij3.LJIIJ(0.0f, 0.02f, 0.02f, 0.03f, 0.03f, 0.04f);
        ...
        dij3.LJIILL(7.77f);
        dij3.LJIIJ(0.0f, 0.3f, -0.34f, 0.48f, -0.59f, 0.3f);
        ...
        dij3.LJIIIZ(0.72f, 0.72f, false, true, 0.44f, 0.1f);
        dij3.LJIIL(0.01f, 0.01f);

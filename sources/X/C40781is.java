...
public final class C40781is extends V1B {
    public long LJLJJL;
    public boolean LJLJJLL;
    public final /* synthetic */ LiveEffect LJLJL;
    public final /* synthetic */ C40771ir LJLJLJ;
    ...
    public C40781is(C40771ir c40771ir, LiveEffect liveEffect) {
        String str;
        List<String> list;
        List<String> list2;
        this.LJLJL = liveEffect;
        this.LJLJLJ = c40771ir;
        ...
        IDqS416S0100000 iDqS416S0100000 = new IDqS416S0100000(this, 28);
    ...
    public final void LJIILL(Exception exc, String str) {
        this.LJLJLJ.LLJJI(System.currentTimeMillis() - this.LJLJJL, this.LJLJL, false);
    }
    ...
    public final void LJIILJJIL(int i, int i2, String str) {
        ...
        this.LJLJLJ.LLJJI(System.currentTimeMillis() - this.LJLJJL, this.LJLJL, true);
    }
}

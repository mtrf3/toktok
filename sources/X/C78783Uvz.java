...
public final class C78783Uvz extends AbstractC32664Crs<C81392Vwy<InterfaceC81378Vwk>> {
    public final /* synthetic */ XJL<C76800UCe> LIZ;
    public final /* synthetic */ C78774Uvq LIZIZ;
    ...
    public final void LJFF(W4W<C81392Vwy<InterfaceC81378Vwk>> w4w) {
        if (w4w != null) {
            ...
            if (result != null) {
                C78774Uvq c78774Uvq = this.LIZIZ;
                W5O w5o = this.LIZJ;
                try {
                    InterfaceC81378Vwk LJI = result.LJI();
                    byte[] bArr = new byte[LJI.size()];
                    LJI.read(0, bArr, 0, LJI.size());
                    InterfaceC81714W5e interfaceC81714W5e = c78774Uvq.LIZ;
                    W5N LJI2 = W5N.LJI();
                    LJI2.getClass();
                    interfaceC81714W5e.LJI(LJI2.LJ(w5o.LIZIZ), new C78785Uw1(bArr));
                    StringBuilder LIZ = X1D.LIZ();
                    LIZ.append("Image has been downloaded successfully ");
                    LIZ.append(w5o.LIZIZ);
                    LIZ.append(" and cached? ");
                    LIZ.append(C78685UuP.LJJJZ(c78774Uvq.LIZIZ(w5o)));
                    LIZ.append(" and cached path is ");
                    LIZ.append(c78774Uvq.LIZIZ(w5o));
                    X1D.LIZIZ(LIZ);
    ...
    public C78783Uvz(XKS xks, C78774Uvq c78774Uvq, W5O w5o) {
        this.LIZ = xks;
        this.LIZIZ = c78774Uvq;
        this.LIZJ = w5o;
    }
}

...
public final class S9P extends S8Q {
    public final /* synthetic */ SizeChartTemplateEditAssem LJLIL;

    public S9P(SizeChartTemplateEditAssem sizeChartTemplateEditAssem) {
    ...
    public final void afterTextChanged(Editable editable) {
        ...
        K3.getClass();
        K3.setState(new AqS53S1200000_12(str, K3, K3.getState(), 9));

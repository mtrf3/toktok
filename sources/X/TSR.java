...
public final class TSR {
    ...
    public boolean LJFF;
    public final TSL LJI;

    public final void LIZJ() {
        LJII = false;
        LIZIZ(EnumC30204BtI.MULTI_GUEST_MIC, new ARunnableS49S0100000_13(this, LiveCoverMinSizeSetting.DEFAULT));
        LIZIZ(EnumC30204BtI.MULTI_GUEST_MANAGE, new ARunnableS49S0100000_13(this, 251));
    ...
    public final void LIZ(EnumC30204BtI enumC30204BtI) {
        ...
        if (view != null) {
            ...
            ofFloat.addListener(new IDAListenerS6S0300000_13(view, enumC30204BtI, this, 7));
    ...
    public final void LIZIZ(EnumC30204BtI enumC30204BtI, Runnable runnable) {
        ...
        if (view != null) {
            ...
            ofFloat.addListener(new IDAListenerS43S0200000_13(runnable, view, 16));
            ofFloat.start();
            ((ArrayList) list).add(ofFloat);
        }
    }

    public TSR(Room room, TTR gameLinkManager, DataChannel dataChannel, GameLinkWidget lifeCycleOwner) {

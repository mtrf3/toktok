...
public final class MYY extends AbstractC116364hU<StoryInboxItem> {
    public final C62822Ol8 LIZJ;
    public final SkylightMediaListViewModel LIZLLL;
    ...
    public final Object LIZLLL() {
        ...
        while (true) {
            ...
            Aweme next = it.next();
            UserStory userStory = next.getUserStory();
            if (userStory != null) {
                bool = Boolean.valueOf(userStory.getAllViewed());
            }
            ...
            this.LIZIZ.add(new StoryInboxItem(next, interfaceC116134h7.LJI(i), false, 4, null));
        }
        if (!C53339KwZ.LIZLLL()) {
            ...
            if (iStoryInboxService.shouldShowShootingEntrance(z, z2) && ((c55723Ltv.LJIILJJIL().LIZIZ() || z4) && ((IStoryInboxService) this.LIZJ.getValue()).canShowStoryCell())) {
    ...
    public final C76800UCe LIZ() {
        SkylightMediaListViewModel skylightMediaListViewModel = this.LIZLLL;
        if (skylightMediaListViewModel != null) {
            AssemViewModel.asyncSubscribe$default(skylightMediaListViewModel, new TBT() { // from class: X.MYw
                @Override // X.TBT, X.TBZ, X.TBW
                public final Object get(Object obj) {
                    return ((InboxSkylightListState) obj).getRefreshState();
                }
            }, C213688a4.LIZLLL(), null, null, new AqS175S0100000_9(this, 402), 12, null);
        }
    ...
    public final Object LIZJ() {
        ...
        for (Aweme aweme : list) {
            ...
            int LJI = interfaceC116134h7.LJI(i);
            if (this.LIZ.LJFF(LJI, LJIIIIZZ) && !C54838Lfe.LJIIJJI(LJIIIIZZ) && z) {
                this.LIZ.LIZ().put(LJIIIIZZ, new Integer(LJI));
                arrayList.add(aweme);
            }
        }
    ...
    public MYY(InterfaceC116134h7 ft) {
        super(ft);
        SkylightMediaListViewModel skylightMediaListViewModel;
        o.LJIIIZ(ft, "ft");
        this.LIZJ = C221108m2.LIZIZ(C57002MYs.LJLIL);
        LifecycleOwner LIZJ = ft.LIZJ();
        if (LIZJ instanceof SkylightMediaListViewModel) {
            skylightMediaListViewModel = (SkylightMediaListViewModel) LIZJ;
        } else {
            skylightMediaListViewModel = null;
        }
        this.LIZLLL = skylightMediaListViewModel;
    ...
    public final Object LIZIZ(InterfaceC67352kd<? super AbstractC116364hU<StoryInboxItem>> interfaceC67352kd) {
        ...
        if (((IStoryInboxService) this.LIZJ.getValue()).canShowStoryCell()) {
            ...
            C114304eA.LIZIZ(new AqS159S0100000_9(LJII, 788));

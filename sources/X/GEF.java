...
public final class GEF extends AbstractC65781Prl implements InterfaceC88472Yns<BaseActivityViewModel, C76800UCe> {
    public static final GEF LJLIL = new GEF();
    ...
    public final C76800UCe invoke(BaseActivityViewModel baseActivityViewModel) {
        ...
        activityConfiguration.config(GEG.LJLIL);

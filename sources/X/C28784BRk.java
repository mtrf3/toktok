...
public final class C28784BRk implements C15M {
    public final /* synthetic */ C34K LIZ;

    public C28784BRk(C34K c34k) {
        this.LIZ = c34k;
    }
    ...
    public final View LIZ(Context context, ViewGroup viewGroup, DialogInterface dialogInterface) {
        ...
        compoundButton.setOnCheckedChangeListener(new IDCListenerS206S0100000_5(this.LIZ, 36));
        return LLLLIILL;
    }
}

...
public final class C71592S7w implements Parcelable.Creator<DiscountTemplateItem> {
    @Override // android.os.Parcelable.Creator
    public final DiscountTemplateItem createFromParcel(Parcel parcel) {
        boolean z;
        boolean z2;
        ...
        return new DiscountTemplateItem(readString, readInt, arrayList, readString2, readString3, z, readString4, readString5, z2, arrayList2);
    }

    @Override // android.os.Parcelable.Creator
    public final DiscountTemplateItem[] newArray(int i) {
        return new DiscountTemplateItem[i];
    }
}

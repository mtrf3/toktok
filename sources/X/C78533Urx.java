...
public final class C78533Urx implements InterfaceC78502UrS {
    public final JSONArray LIZ;

    @Override // X.InterfaceC78502UrS
    public final List<Object> LIZ() {
        return C38384F4q.LIZ(this.LIZ);
    }
    ...
    public C78533Urx(JSONArray origin) {
    ...
    public final InterfaceC78505UrV get(int i) {
        return new C78537Us1(this.LIZ.opt(i));
    }

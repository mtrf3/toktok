...
public final class C32379CnH extends AbstractC32375CnD {
    static {
        C221108m2.LIZIZ(C32383CnL.INSTANCE);
    }

    @Override // X.InterfaceC32340Cme
    public final boolean LIZ(AssetsModel assetsModel) {
        List list;
        C32420Cnw LJFF = AbstractC32375CnD.LJFF(assetsModel, 0);
        if (LJFF != null) {
            list = C47261Igj.LJJIJ(LJFF);
        } else {
    ...
    public final C32420Cnw LIZJ(AssetsModel assetsModel, int i) {
        C32420Cnw LJFF = AbstractC32375CnD.LJFF(assetsModel, i);
        if (LJFF != null) {
            return LJFF;
        }

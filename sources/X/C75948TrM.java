...
public final class C75948TrM implements C15M {
    public final InterfaceC88472Yns<Boolean, C76800UCe> LIZ;

    /* JADX WARN: Multi-variable type inference failed */
    public C75948TrM(InterfaceC88472Yns<? super Boolean, C76800UCe> interfaceC88472Yns) {
        this.LIZ = interfaceC88472Yns;
    }

    @Override // X.C15M
    public final View LIZ(Context context, ViewGroup viewGroup, DialogInterface dialogInterface) {
        View LLLLIILL = C16880lQ.LLLLIILL(C16880lQ.LLZIL(context), R.layout.cvm, viewGroup, false);
        ...
        compoundButton.setOnCheckedChangeListener(new IDCListenerS209S0100000_13(this, 6));

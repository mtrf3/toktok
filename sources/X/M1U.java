...
public final class M1U extends AbstractC65781Prl implements InterfaceC88472Yns<O26, Boolean> {
    public static final M1U LJLIL = new M1U();
    ...
    public final Boolean invoke(O26 o26) {
        ...
        if ((resInfo instanceof O2Z) && o.LJ(((O2Z) resInfo).LJIJJ, "template")) {
            ...
            if (s.LJJJLZIJ(uri, "tiktok_live_ecommerce_ttmall_v3", false)) {
                z = true;
            }
        }

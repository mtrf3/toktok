...
public final class C29571Eb extends C0G1 {
    ...
    public final void LIZ() {
        if (this.LJIIIZ) {
            XKX.LIZLLL(ViewModelKt.getViewModelScope(this.LJIILJJIL), null, null, new C539429u(this, null), 3);
        }
    }

    @Override // X.C0G1
    public final void LIZJ() {
        XKX.LIZLLL(ViewModelKt.getViewModelScope(this.LJIILJJIL), null, null, new C539529v(this, null), 3);
    }
    ...
    public C29571Eb(ViewGroup parent, RecyclerView.RecycledViewPool viewPool, C0WF c0wf, StickerEffectViewModel viewModel, DataChannel dataChannel) {
        ...
        this.LJIILL = c0wf;
        C16880lQ.LJIIJ(new IDCListenerS135S0100000(this, 11), this.LJII);
        XKX.LIZLLL(ViewModelKt.getViewModelScope(viewModel), null, null, new C539329t(this, null), 3);
    }
}

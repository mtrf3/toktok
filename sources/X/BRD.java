...
public final class BRD extends AbstractC65781Prl implements InterfaceC88472Yns<AnchorLevelPermission, EnumC12540eQ> {
    public static final BRD LJLIL = new BRD();
    ...
    public final EnumC12540eQ invoke(AnchorLevelPermission anchorLevelPermission) {
        ...
        int i = anchorLevelPermission.goodyBag;
        c12530eP.getClass();

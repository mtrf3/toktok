...
public final class C33077CyX extends AbstractC39455Fe7 {
    ...
    public C33077CyX() {
        ...
        DIJ p = this.LIZJ;
        o.LJIIIZ(p, "p");
        p.LJIIJ(-1.7f, 0.87f, -3.95f, 0.87f, -8.43f, 0.87f);
        p.LJIIJJI(-9.9f);
        p.LJIIJ(-4.48f, 0.0f, -6.72f, 0.0f, -8.43f, -0.87f);
        p.LJIIIZ(8.0f, 8.0f, false, true, -3.5f, -3.5f);
        DIJ p2 = this.LIZJ;
        o.LJIIIZ(p2, "p");
        p2.LJ(10.0f, 31.93f, 10.0f, 29.68f, 10.0f, 25.2f);
        p2.LJIILL(-2.4f);
        p2.LIZLLL();

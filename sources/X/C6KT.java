...
public final class C6KT extends View {
    ...
    public C6KT(Context context) {
        super(context);
        new LinkedHashMap();
        Paint paint = new Paint();
        this.LJLIL = paint;
        float LIZJ = KL2.LIZJ(getContext(), 3.5f);
        float LIZJ2 = KL2.LIZJ(getContext(), 13.0f);
        ...
        ofFloat.addUpdateListener(new AUListenerS91S0100000_2(this, 12));
        ofFloat.setDuration(250L);
        ofFloat2.addUpdateListener(new AUListenerS91S0100000_2(this, 13));

...
public final class C145725nk extends F9E {
    ...
    */
    public C145725nk() {
        /*
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: X.C145725nk.<init>():void");
    }
    ...
    public static C145725nk L(C145725nk c145725nk, int i, int i2) {
        String path = c145725nk.LJLIL;
        int i3 = c145725nk.LJLJJL;
        int i4 = c145725nk.LJLJJLL;
        int i5 = c145725nk.LJLJL;
        int i6 = c145725nk.LJLJLJ;
        int i7 = c145725nk.LJLJLLL;
        String codecInfo = c145725nk.LJLL;
        o.LJIIIZ(path, "path");
        o.LJIIIZ(codecInfo, "codecInfo");
        return new C145725nk(i, i2, 0, i3, i4, i5, i6, i7, path, codecInfo);
    }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public /* synthetic */ C145725nk(int r13, int r14, int r15, int r16, int r17, int r18, int r19, java.lang.String r20, java.lang.String r21) {
        /*
            r12 = this;
            r1 = r19
            r11 = r21
        ...
        L3b:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: X.C145725nk.<init>(int, int, int, int, int, int, int, java.lang.String, java.lang.String):void");
    }

    public C145725nk(int i, int i2, int i3, int i4, int i5, int i6, int i7, int i8, String path, String codecInfo) {
        o.LJIIIZ(path, "path");
        o.LJIIIZ(codecInfo, "codecInfo");
        this.LJLIL = path;
        this.LJLILLLLZI = i;

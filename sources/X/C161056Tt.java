...
public final class C161056Tt extends C6OX {
    public final Context LJIIJ;
    public final SingleHashTagStickerModel LJIIJJI;
    ...
    public final C1NS<SingleHashTagStickerModel> LJJIZ() {
    ...
    public final void LJI(StickerModel stickerModel) {
        SingleHashTagStickerModel singleHashTagStickerModel;
        o.LJIIIZ(stickerModel, "stickerModel");
        super.LJI(stickerModel);
        if ((stickerModel instanceof SingleHashTagStickerModel) && (singleHashTagStickerModel = (SingleHashTagStickerModel) stickerModel) != null) {
            LJJIZ().LJ(new AqS168S0100000_2(singleHashTagStickerModel, 363));
            LJJIL(((SingleHashTagStickerModel) stickerModel).getBaseStickerModel());
        }
    }
    ...
    public final void LJJIJIIJIL(BaseStickerModel baseState) {
        ...
        LJJIZ().LJ(new AqS168S0100000_2(baseState, 362));
    }

    @Override // X.C6OX, X.C6QO
    public final void setVisible(boolean z) {
        LJJIZ().LJ(new AqS7S0010000_2(z, 39));
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C161056Tt(Context context, SingleHashTagStickerModel hashTagStickerModel, FrameLayout stickerContainer, C159636Oh c159636Oh, LifecycleOwner lifecycleOwner, C160056Px stickerObjectContainer) {
        ...
        this.LJIILL = C221108m2.LIZIZ(new AqS152S0100000_2(this, 642));
        this.LJIILLIIL = C221108m2.LIZIZ(new AqS152S0100000_2(this, 643));

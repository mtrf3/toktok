...
public final class C51220K8i extends C0CJ {
    public final WeakReference<C74053T4n> LJLIL;
    public int LJLILLLLZI;
    public int LJLJI;

    public C51220K8i(C74053T4n tabLayout) {
    ...
    */
    public final void LIZIZ(int r7, float r8, int r9) {
        ...
        L21:
            ...
            goto L18
        */
        throw new UnsupportedOperationException("Method not decompiled: X.C51220K8i.LIZIZ(int, float, int):void");
    }
}

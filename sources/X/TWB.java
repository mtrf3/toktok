...
public final class TWB implements InterfaceC14120gy {
    ...
    public final void LJ(View view, C0KG c0kg, LiveActionSheetDialog liveActionSheetDialog) {
        ...
        if (dataChannel != null) {
            dataChannel.qv0(MultiGuestV3PreviewPanelV2OpenEvent.class, new C74601TPp(null, "guest_icon", "button_icon"));
        }
    }
}

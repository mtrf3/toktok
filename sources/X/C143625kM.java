...
public final class C143625kM extends WMH implements InterfaceC143795kd, InterfaceC135635Tz {
    ...
    static {
        TBT tbt = new TBT(C143625kM.class, "mModel", "getMModel()Lcom/ss/android/ugc/aweme/shortvideo/edit/VideoPublishEditModel;", 0);
    ...
    public C143625kM(C82622Wbi diContainer) {
        o.LJIIIZ(diContainer, "diContainer");
        this.LJLIL = diContainer;
        UCI.LJI(diContainer, VideoPublishEditModel.class, null);
    ...
    public final void onViewCreated(View view, Bundle bundle) {
        ...
        C16880lQ.LJIILLIIL(imageView, new IDlS62S0100000_2(this, (AbstractC156316Bn<Object>) 37));
        ...
        if (constraintLayout != null) {
            ...
            if ((layoutParams instanceof ViewGroup.MarginLayoutParams) && (marginLayoutParams = (ViewGroup.MarginLayoutParams) layoutParams) != null) {
                marginLayoutParams.topMargin = LJFF;
    ...
    public final ViewGroup onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ConstraintLayout constraintLayout = (ConstraintLayout) C6D8.LIZJ(layoutInflater, "inflater", viewGroup, "container", layoutInflater, R.layout.cu5, viewGroup, false, "null cannot be cast to non-null type androidx.constraintlayout.widget.ConstraintLayout");

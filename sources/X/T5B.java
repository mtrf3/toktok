...
public final class T5B extends DmtTextView {
    ...
    private final int getSpanWidth() {
        return (int) Math.ceil(new T59(getContext(), this.LJLJLJ).getDrawable().getIntrinsicWidth());
    }
    ...
    public final SpannableString LJJIJIL(String str) {
        ...
        t59.LJLIL = this.LJLL;
        spannableString.setSpan(t59, LIZIZ.length() - 1, LIZIZ.length(), 33);
    ...
    public T5B(Context context, AttributeSet attributeSet) {
        super(context, attributeSet, 0);
        a1.LJFF(context, "context");
        this.LJLJL = "...";
        this.LJLJLJ = R.drawable.au4;
        this.LJLJLLL = "";
    }

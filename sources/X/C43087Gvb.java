...
public final class C43087Gvb extends AbstractC41473GPl {
    @Override // X.AbstractC43051Gv1
    public final String LJIIIIZZ() {
        return "CreativeTool-Persistent";
    }

    @Override // X.InterfaceC37286EkE
    public final File LIZLLL() {
        return new File(C60903NvH.LJIIJJI().LJJIJL().getPathService().getPersistentRoot());
    }

...
public final class K97 implements C0C3 {
    public final WeakReference<C74053T4n> LJLIL;
    public int LJLILLLLZI;
    public int LJLJI;

    public K97(C74053T4n tabLayout) {
    ...
    */
    public final void onPageScrolled(int r7, float r8, int r9) {
        ...
        L21:
            ...
            goto L18
        */
        throw new UnsupportedOperationException("Method not decompiled: X.K97.onPageScrolled(int, float, int):void");
    }
}

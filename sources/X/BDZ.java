...
public final class BDZ implements CompoundButton.OnCheckedChangeListener {
    public final /* synthetic */ BasePreviewSettingMainFragment LJLIL;
    public final /* synthetic */ String LJLILLLLZI;
    public final /* synthetic */ String LJLJI;

    public BDZ(BasePreviewSettingMainFragment basePreviewSettingMainFragment, String str, String str2) {
        this.LJLIL = basePreviewSettingMainFragment;
        this.LJLILLLLZI = str;
        this.LJLJI = str2;
    }
    ...
    public final void onCheckedChanged(CompoundButton compoundButton, boolean z) {
        ...
        if (z) {
            BasePreviewSettingMainFragment basePreviewSettingMainFragment = this.LJLIL;
            if (basePreviewSettingMainFragment.LJLJJL) {
                String str = this.LJLILLLLZI;
                String str2 = this.LJLJI;
                Context context = basePreviewSettingMainFragment.getContext();
                if (context != null) {
                    ...
                    if (LJIILIIL != null && o.LJ(LJIILIIL.kv0(UserIsAnchorChannel.class), bool) && !TextUtils.isEmpty(value)) {
                        aRunnableS5S2200000_5 = new ARunnableS5S2200000_5(basePreviewSettingMainFragment, value, LJIILJJIL, context, 1);
                    } else {
                        aRunnableS5S2200000_5 = null;
                    }
                    C29306Beo.LJJJJIZL(BAY.LIZ(C51029K0z.LJIILIIL(basePreviewSettingMainFragment), context, aRunnableS5S2200000_5, new ARunnableS41S0100000_5(basePreviewSettingMainFragment, 306), str, str2));

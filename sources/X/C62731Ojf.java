...
public final class C62731Ojf extends AbstractC62728Ojc {
    public C62731Ojf(View view) {
        super(view);
    }
    ...
    public final void L(InterfaceC62733Ojh interfaceC62733Ojh) {
        ...
        SmartImageView ivVideoCoverRight = (SmartImageView) this.itemView.findViewById(R.id.fcj);
        ...
        if (LIZLLL2 != null && (str = (String) LIZLLL2.LJLJI) != null) {
            ...
            LJIIIIZZ2.LJJIIJ = ivVideoCoverRight;
            o.LJIIIIZZ(ivVideoCoverRight, "ivVideoCoverRight");
            Context context2 = ivVideoCoverRight.getContext();
            o.LJIIIIZZ(context2, "ivVideoCoverRight.context");

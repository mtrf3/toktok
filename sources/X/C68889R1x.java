...
public class C68889R1x extends InputStream implements DataInput {
    ...
    public C68889R1x(InputStream inputStream) {
        this(inputStream, ByteOrder.BIG_ENDIAN);
    }

    public C68889R1x(InputStream inputStream, ByteOrder byteOrder) {

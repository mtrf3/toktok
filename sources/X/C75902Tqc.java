...
public final class C75902Tqc implements InterfaceC75414Tik<ApplyGroupResult> {
    ...
    public final void onSuccess(ApplyGroupResult applyGroupResult) {
        ApplyGroupResult value = applyGroupResult;
        ...
        if (interfaceC75706TnS != null) {
            ...
            interfaceC75706TnS.LJFF(new OLV(1, logId, 4));
        }
    }
    ...
    public C75902Tqc(InterfaceC75706TnS<OLV> interfaceC75706TnS, MultiHostCrossAdapterImpl multiHostCrossAdapterImpl, CMB cmb) {

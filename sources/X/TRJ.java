...
public final class TRJ implements U62 {
    ...
    public TRJ(MultiGuestSharedBgAnchorViewModel multiGuestSharedBgAnchorViewModel) {
    ...
    public final void LJLILLLLZI(InterfaceC75441TjB session, int i) {
        ...
        multiGuestSharedBgAnchorViewModel.setState(new AqS179S0100000_13(multiGuestSharedBgAnchorViewModel, 184));
    }
    ...
    public final void LJZL(InterfaceC75441TjB session, List<LinkUser> linkedUsers, List<LinkUser> applicants, List<LinkUser> invitees, List<LinkUser> willJoinGroupUsers, List<LinkUser> liveUsers, List<LinkUser> invitingList, List<LinkUser> applyingList, String str, CustomLinkMessage customLinkMessage) {
        ...
        StringBuilder LIZ = X1D.LIZ();
        LIZ.append("onLinkedCountChange linkedUserSize=");
        LIZ.append(linkedUsers.size());
        C74987Tbr.LIZJ("anchor_shared_bg", X1D.LIZIZ(LIZ));
        C75286Tgg c75286Tgg = this.LJLIL.LJLJI;
        if (c75286Tgg != null) {
            int size = linkedUsers.size();
            StringBuilder LIZ2 = X1D.LIZ();
            LIZ2.append("onLinkedCountChange, linkedCount=");
            LIZ2.append(size);
            C74987Tbr.LIZJ("anchor_shared_bg", X1D.LIZIZ(LIZ2));
            if (C75286Tgg.LIZ()) {
                if (size > 1) {
                    c75286Tgg.LIZIZ();
                } else {

...
public final class GDA extends AbstractC65781Prl implements InterfaceC88472Yns<BaseActivityViewModel, C76800UCe> {
    public static final GDA LJLIL = new GDA();
    ...
    public final C76800UCe invoke(BaseActivityViewModel baseActivityViewModel) {
        ...
        activityConfiguration.config(GD9.LJLIL);

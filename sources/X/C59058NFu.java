...
public final class C59058NFu implements InterfaceC48720JAe {
    ...
    public final boolean LIZJ(Aweme aweme) {
        ...
        if (awemeRawAd != null && (adDescriptiveCTA = awemeRawAd.getAdDescriptiveCTA()) != null && adDescriptiveCTA.getBottomContainer() != null) {
            return true;
        }
        return false;
    }
    ...
    public final void LIZ(Context context, Aweme aweme) {
        if (LIZJ(aweme)) {
            ...
            LIZ.append(C59056NFs.LIZ(aweme));
            C58582Rq.LIZ(X1D.LIZIZ(LIZ), "feed_fyp_descriptive_bottom_container");
            if (this.LIZIZ == null) {
                this.LIZIZ = AdHybridContainerManager.LIZLLL().LIZJ(C59056NFs.LIZJ(context, aweme), C59056NFs.LIZIZ(context, aweme));
            }
            AbstractC59064NGa abstractC59064NGa = this.LIZIZ;
            if (abstractC59064NGa != null) {
                abstractC59064NGa.LJIJI(C59056NFs.LIZ(aweme));
            }
        }
    }
    ...
    public final void LJFF(Context context, Aweme aweme) {
        ...
        this.LIZIZ = AdHybridContainerManager.LIZLLL().LIZIZ(C59056NFs.LIZJ(context, aweme), C59056NFs.LIZIZ(context, aweme));
    }

...
public final class C70977RtN extends AbstractC70875Rrj {
    public C70977RtN() {
        super("tiktokec_product_detail_fe_minipdpsheet_stay_time", "lib_track_builtin_lane_business");
    }
    ...
    public final C71007Rtr LIZ() {
        ...
        qsq.LIZ(new C71006Rtq("action_sheet_for", new C71008Rts[0]));

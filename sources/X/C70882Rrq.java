...
public final class C70882Rrq extends AbstractC70875Rrj {
    public C70882Rrq() {
        super("tiktokec_coupon_cancel", "lib_track_builtin_lane_business");
    }

    @Override // X.AbstractC71002Rtm
    public final C71007Rtr LIZ() {
        return new C71007Rtr(new C71006Rtq("EVENT_ORIGIN_FEATURE", new C71008Rts[0]), new C71006Rtq("entrance_info", new C71008Rts[0]), new C71006Rtq("page_name", new C71008Rts[0]), new C71006Rtq("previous_page", new C71008Rts[0]), new C71006Rtq("coupon_id", new C71008Rts[0]), new C71006Rtq("coupon_type_id", new C71008Rts[0]), new C71006Rtq("coupon_type_info", new C71008Rts[0]), new C71006Rtq("coupon_cost_role", new C71008Rts[0]), new C71006Rtq("coupon_zone", new C71008Rts[0]), new C71006Rtq("coupon_ignore_type", new C71008Rts[0]));
    }
}

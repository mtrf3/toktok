...
public final class C169016kD extends AbstractC169046kG {
    ...
    public final void LJI(AqS168S0100000_2 aqS168S0100000_2) {
        ...
        TDV tdv = this.LJ;
        if (tdv != null) {
            tdv.postDelayed(new ARunnableS38S0100000_2(this, 61), LiveMaxRetainAlogMessageSizeSetting.DEFAULT);
        }
    }

    public C169016kD(View view, TDV tdv) {
        super(null, view);
        this.LIZLLL = view;
        this.LJ = tdv;
        this.LJFF = 72;

...
public enum EnumC63625Oy5 implements WireEnum {
    IMCMD_NOT_USED(0),
    SEND_MESSAGE(100),
    ...
    GET_MESSAGES_BY_USER_COMBO_INBOX_TYPE(204),
    GET_MESSAGES_BY_USER_INIT_COMBO_INBOX_TYPE(205),
    ...
    SEND_ONLINE(LiveChatShowDelayForHotLiveSetting.DEFAULT),
    SEND_OFFLINE(401),
    SEND_CLIENT_FOREGROUND(402),
    SEND_CLIENT_BACKGROUND(403),
    SEND_USER_ACTION(410),
    SEND_INPUT_STATUS(411),
    NEW_MSG_NOTIFY(LiveMaxRetainAlogMessageSizeSetting.DEFAULT),
    ...
    DELETE_MULTI_STRANGER_CONVERSATIONS(1009),
    MARK_MULTI_STRANGER_CONVERSATIONS_READ(1010),
    ...
    GET_MESSAGES(2200),
    BATCH_GET_MESSAGES(2201),
    VCD_CLEAN(9999);

    public static final ProtoAdapter<EnumC63625Oy5> ADAPTER = new EnumAdapter<EnumC63625Oy5>() { // from class: X.Oy9
        @Override // com.squareup.wire.EnumAdapter
        public final EnumC63625Oy5 LIZ(int i) {
            return EnumC63625Oy5.fromValue(i);
        }
    };
    ...
    public static EnumC63625Oy5 fromValue(int i) {
        if (i != 0) {
            if (i != 210) {
                if (i != 211) {
                    if (i != 410) {
                        if (i != 411) {
                            switch (i) {
                                case 100:
                                    return SEND_MESSAGE;
                                case 510:
                                    return NEW_INPUT_STATUS_NOTIFY;
                                case 607:
                                ...
                                case 616:
                                    return GET_CONVERSATIONS_CHECK_INFO_V2;
                                case 617:
                                    return BATCH_DELETE_CONVERSATIONS;
                                case 701:
                                ...
                                case 1009:
                                    return DELETE_MULTI_STRANGER_CONVERSATIONS;
                                case 1010:
                                    return MARK_MULTI_STRANGER_CONVERSATIONS_READ;
                                case 1099:
                                ...
                                default:
                                    switch (i) {
                                        ...
                                        case 204:
                                            return GET_MESSAGES_BY_USER_COMBO_INBOX_TYPE;
                                        case 205:
                                            return GET_MESSAGES_BY_USER_INIT_COMBO_INBOX_TYPE;
                                        default:
                                            switch (i) {
                                                case 300:
                                                ...
                                                case 303:
                                                    return GET_MESSAGES_CHECK_INFO_V2;
                                                default:
                                                    switch (i) {
    ...
    public static EnumC63625Oy5 valueOf(String str) {
        return (EnumC63625Oy5) V0N.LJJJ(EnumC63625Oy5.class, str);
    }

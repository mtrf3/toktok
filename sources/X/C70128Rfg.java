...
public final class C70128Rfg extends AbstractC70571Rmp {
    ...
    public final java.util.Map<String, Object> LIZ() {
        ...
        if (pdpEnterParam != null) {
            str = C27739Aud.LJI(pdpEnterParam);
        } else {
            str = null;
        }
        ...
        if (pdpEnterParam2 != null) {
            ...
            linkedHashMap.put("fullScreen", Boolean.valueOf(pdpEnterParam2.getFullScreen()));
            linkedHashMap.put("requestParams", C27739Aud.LJI(pdpEnterParam2.getRequestParams()));
            HashMap<String, Object> orderRequestParams = pdpEnterParam2.getOrderRequestParams();
            if (orderRequestParams != null) {
                linkedHashMap.put("orderRequestParams", C27739Aud.LJI(orderRequestParams));
            }
            HashMap<String, Object> visitReportParams = pdpEnterParam2.getVisitReportParams();
            if (visitReportParams != null) {
                linkedHashMap.put("visitReportParams", C27739Aud.LJI(visitReportParams));
            }
        }
    ...
    public C70128Rfg(IPdpStarter.PdpEnterParam pdpEnterParam, View view, String str) {
        super(str, null);

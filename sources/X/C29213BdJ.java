...
public final class C29213BdJ implements InterfaceC74869TZx {
    @Override // X.InterfaceC74869TZx
    public final boolean LIZ(C29215BdL checkParam) {
        ...
        c77437UaH.LJFF(new DialogInterfaceOnClickListenerC29214BdK(c29216BdM, context, currentUserId, checkParam, this), C15380j0.LJIILJJIL(R.string.me9), false);
        c77437UaH.LIZLLL(new IDCListenerS49S0200000_5(checkParam, this, 9), C15380j0.LJIILJJIL(R.string.me7), false);
        c77437UaH.LJJII = false;
        DialogC77438UaI LIZ2 = c77437UaH.LIZ();
        if (!new C03880Dg(2).LIZJ(300000, "com/bytedance/android/livesdk/dialog/LiveModalDialog", "show", LIZ2, new Object[0], "void", new C65300Pk0(false, "()V", "6528720976614221614")).LIZ) {
            LIZ2.show();
        }

...
public final class C49981JjV implements InterfaceC49992Jjg {
    public final InterfaceC49985JjZ LIZ;

    public C49981JjV(JVP jvp) {
        this.LIZ = jvp;
    }
    ...
    public final boolean LIZIZ(C50420Jqa videoEvent, Aweme aweme) {
        o.LJIIIZ(videoEvent, "videoEvent");
        return o.LJ(aweme.getSearchFeedType(), "SearchFeaturedAnswer");
    }
    ...
    public final int LIZJ(C50420Jqa videoEvent, Aweme aweme) {
        ...
        o.LJIIIZ(videoEvent, "videoEvent");
        return this.LIZ.LJLJL(aweme.getAid());
    }

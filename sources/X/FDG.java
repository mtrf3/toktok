...
public final class FDG implements FDH {
    public static final FDG LIZ = new FDG();
    ...
    public final EcomGeckoFrontUpdateModel[] config() {
        ...
        LJIIIZ.getClass();
        EcomGeckoFrontUpdateModel[] ecomGeckoFrontUpdateModelArr2 = (EcomGeckoFrontUpdateModel[]) FFL.LJIJ(true, "ecom_common_gecko_front_update", 31744, EcomGeckoFrontUpdateModel[].class, ecomGeckoFrontUpdateModelArr);

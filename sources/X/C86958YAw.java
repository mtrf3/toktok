...
public final class C86958YAw extends AbstractC86959YAx {
    ...
    public final void onSensorChanged(SensorEvent event) {
        ...
        if (this.LJLIL) {
            ...
            interfaceC86960YAy.E7(fArr[0], fArr[1], fArr[2], LIZ);
        }
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C86958YAw(InterfaceC86960YAy processor, boolean z) {
        super(z);

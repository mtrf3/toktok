...
public final class C77184UQy implements InterfaceC64672gJ<C77216USe> {
    ...
    public final Object emit(C77216USe c77216USe, InterfaceC67352kd<? super C76800UCe> interfaceC67352kd) {
        ...
        int i = UR4.LIZ[c77216USe2.LJLILLLLZI.ordinal()];
        if (i != 1) {
            if (i == 2) {
            ...
            c77177UQr2.getClass();
            C77177UQr.LJIIZILJ(str2, 1, z2, ura2, ur72, z3);
        }
        return C76800UCe.LIZ;
    }

    public C77184UQy(String str, boolean z, URA ura, UR7 ur7, boolean z2) {
        this.LJLIL = str;
        this.LJLILLLLZI = z;
        this.LJLJI = ura;
        this.LJLJJI = ur7;

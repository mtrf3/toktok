...
public final class C143595kJ extends AbstractC29891Fh<InterfaceC81630W1y> implements InterfaceC143795kd, InterfaceC81630W1y, InterfaceC135635Tz {
    public static final /* synthetic */ InterfaceC74236TBo<Object>[] LJLJJLL;
    public final WMH LJLIL;
    public final C82622Wbi LJLILLLLZI;
    public final InterfaceC81630W1y LJLJI;
    public final InterfaceC115514g7 LJLJJI;
    public final C40871j1<Boolean> LJLJJL;

    static {
        TBT tbt = new TBT(C143595kJ.class, "planCUiApi", "getPlanCUiApi()Lcom/ss/android/ugc/aweme/shortvideo/component/PlanCUIApiComponent;", 0);
    ...
    private final InterfaceC45999I3n LJJLI() {
        return (InterfaceC45999I3n) this.LJLJJI.LIZ(this, LJLJJLL[0]);
    }

    @Override // X.AbstractC29891Fh
    public void onCreate() {
        super.onCreate();
        this.LJLIL.add(R.id.irq, new C143925kq(this.LJLJJL, LJJLI().Na0(), LJJLI().RH()), "FTCRecordMaskScene");
    }

    @Override // X.AbstractC29891Fh
    public /* bridge */ /* synthetic */ InterfaceC81630W1y getApiComponent() {
        return this.LJLJI;
    }
    ...
    public C143595kJ(WMH parent, C82622Wbi diContainer) {
        ...
        this.LJLJJL = new C40871j1<>(Boolean.TRUE);
    }

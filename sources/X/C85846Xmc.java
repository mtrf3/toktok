...
public final class C85846Xmc implements IAVPublishExtension<PoiPublishModel> {
    ...
    public final PoiPublishModel provideExtensionData() {
        PoiPublishExtensionVM poiPublishExtensionVM = this.LJLIL;
        if (poiPublishExtensionVM != null) {
            PoiData poiData = poiPublishExtensionVM.getState().LJLILLLLZI;
            PoiPublishExtensionVM poiPublishExtensionVM2 = this.LJLIL;
    ...
    public final void onBackPressed(PublishOutput publishOutput) {
        ...
        if (c85278XdS != null) {
            ...
            if (poiPublishExtensionVM != null) {
                ...
                C85850Xmg c85850Xmg = new C85850Xmg();
                try {
                    C85278XdS c85278XdS2 = C85242Xcs.LIZ;
                    if (c85278XdS2 != null) {
                        PoiEventApi.LIZ.getClass();
                        C85270XdK.LIZ(c85278XdS2, c85850Xmg);
                        return;
                    }
                    return;
    ...
    public final void onPublish(PublishOutput publishOutput) {
        ...
        if (c85278XdS != null) {
            ...
            if (poiPublishExtensionVM != null) {
                ...
                C85851Xmh c85851Xmh = new C85851Xmh();
                try {
                    C85278XdS c85278XdS2 = C85242Xcs.LIZ;
                    if (c85278XdS2 != null) {
                        PoiEventApi.LIZ.getClass();
                        C85270XdK.LIZ(c85278XdS2, c85851Xmh);
                        return;
                    }
                    return;
                } catch (Exception unused) {
    ...
    public final void onSaveDraft(PublishOutput publishOutput) {
        ...
        if (c85278XdS != null) {
            ...
            if (poiPublishExtensionVM != null) {
                ...
                ((List) c85278XdS.LIZJ).add(new C79536VJk(EnumC85314Xe2.SAVE_DRAFT, null));
                C85852Xmi c85852Xmi = new C85852Xmi();
                try {
                    C85278XdS c85278XdS2 = C85242Xcs.LIZ;
                    if (c85278XdS2 != null) {
                        PoiEventApi.LIZ.getClass();
                        C85270XdK.LIZ(c85278XdS2, c85852Xmi);
                        return;
                    }
                    return;
                } catch (Exception unused) {
    ...
    */
    public final void onActivityResult(int r6, int r7, android.content.Intent r8) {
        /*
            ...
            r2 = 0
            if (r4 == 0) goto L21
            com.ss.android.ugc.aweme.poi.videopublish.PoiPublishExtensionVM r1 = r5.LJLIL
            if (r1 == 0) goto L6c
        ...
        L3d:
            ...
            if (r1 == 0) goto L4b
            com.ss.android.ugc.aweme.poi.videopublish.PoiPublishExtensionVM r0 = r5.LJLIL
            if (r0 == 0) goto L60
            r0.LJLILLLLZI = r1
        L4b:
        ...
        L6c:
            ...
            throw r2
        */
        throw new UnsupportedOperationException("Method not decompiled: X.C85846Xmc.onActivityResult(int, int, android.content.Intent):void");
    }
    ...
    public final void onCreate(Fragment fragment, View view, LifecycleOwner lifecycleOwner, LinearLayout extensionWidgetContainer, Bundle bundle, AVPublishContentType contentType, PublishOutput publishOutput, ExtensionMisc extensionMisc, IAVPublishExtension.Callback callback) {
        ...
        C9BE c9be = C9BE.LIZ;
        AqS165S0100000_15 aqS165S0100000_15 = new AqS165S0100000_15(LIZ, 765);
        C85841XmX c85841XmX = C85841XmX.INSTANCE;
        if (o.LJ(c9be, C9BD.LIZ)) {
            r1 = 1;
            c214298b3 = new C214298b3(aqS165S0100000_15, C214528bQ.LJLIL, C78926UyI.LJJII(fragment, true), C78926UyI.LJJIIJZLJL(fragment, true), C184077Kh.LJLIL, C78926UyI.LJJ(fragment, true), C78926UyI.LJIILLIIL(fragment, true), c85841XmX, LIZ);
        } else {
            r1 = 1;
            if (c9be == null || o.LJ(c9be, c9be)) {
                c214298b3 = new C214298b3(aqS165S0100000_15, C214528bQ.LJLIL, C78926UyI.LJJII(fragment, false), C78926UyI.LJJIIJZLJL(fragment, false), C184077Kh.LJLIL, C78926UyI.LJJ(fragment, false), C78926UyI.LJIILLIIL(fragment, false), c85841XmX, LIZ);
            } else {
                throw new IllegalArgumentException("Do not support this scope here.");
            }
        }
        this.LJLIL = (PoiPublishExtensionVM) c214298b3.getValue();
        C8VV.LIZ(fragment, false, new AqS19S0500000_15(publishOutput, fragment, contentType, extensionMisc, C16880lQ.LLLLIILL(C16880lQ.LLZIL(fragment.getContext()), R.layout.c16, extensionWidgetContainer, r1), 0));

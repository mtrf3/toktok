...
public final class C49380JZo implements InterfaceC49388JZw {
    public final /* synthetic */ SearchCardBottomBarAssem LIZ;

    @Override // X.InterfaceC49388JZw
    public final List<HighlightInfo> LIZ() {
        Aweme aweme = this.LIZ.LLIIIJ;
        if (aweme != null) {
    ...
    public C49380JZo(SearchCardBottomBarAssem searchCardBottomBarAssem) {
        this.LIZ = searchCardBottomBarAssem;
    }

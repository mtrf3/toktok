...
public final class SM2 extends AbstractC71980SMu {
    public final ProfileViewHistorySettingViewModel LJLLILLLL;
    ...
    */
    public final void LLIIII() {
        ...
        L2a:
            ...
            java.lang.String r0 = "enter_profile_viewers_permission"
            X.C07250Qf.LIZLLL(r2, r1, r3, r0, r2)
            android.content.Context r1 = r5.LJLIL
            java.lang.String r0 = "aweme://privacy/setting/page?target=profile_view_history"
        ...
        L47:
            ...
            goto L14
        */
        throw new UnsupportedOperationException("Method not decompiled: X.SM2.LLIIII():void");
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public SM2(ProfileViewHistorySettingViewModel viewModel, Context context, LifecycleOwner lifecycleOwner, PrivacySettingsAdapterConfigs configs, SKL toastHolder) {
        ...
        this.LJLLJ = bundle != null ? bundle.getBoolean("isProfileViewersEnable", false) : false;
        SK9 sk9 = new SK9();
        AbstractC71980SMu.LLFZ(this, sk9);
        sk9.LJIILIIL = new SM3(this);
        AbstractC71913SKf.LIZJ(sk9, R.string.pgu);
        sk9.LIZIZ(R.raw.icon_footprint_fill);
        sk9.LJII = new SM4(this);
        SKZ LIZ = sk9.LIZ();
        LJLLLLLL(LIZ);
        viewModel.LJLJI.observe(lifecycleOwner, new AObserverS75S0200000_12(this, LIZ, 26));
    }
}

...
public class XPH<K, V> extends SoftReference<V> implements XPL<K, V> {
    ...
    public XPH(ReferenceQueue<V> referenceQueue, V v, InterfaceC84796XPs<K, V> interfaceC84796XPs) {
    ...
    public XPL<K, V> LJ(ReferenceQueue<V> referenceQueue, V v, InterfaceC84796XPs<K, V> interfaceC84796XPs) {
        return new XPH(referenceQueue, v, interfaceC84796XPs);
    }
}

...
public final class C67666Qh4 implements InterfaceC67677QhF<BeginSignInResult> {
    ...
    public final void onSuccess(BeginSignInResult beginSignInResult) {
        ...
        try {
            ...
            GoogleOneTapLogger.LIZLLL().LIZ(this.LJLILLLLZI, 0, 1);
            ...
            GoogleOneTapLogger.LIZLLL().LIZ(this.LJLILLLLZI, 0, 0);
        }
    }

    public C67666Qh4(Bundle bundle, ActivityC45651qj activityC45651qj, GoogleOneTapAuth googleOneTapAuth, Long l) {

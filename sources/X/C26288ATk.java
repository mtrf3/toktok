...
public final class C26288ATk extends C60094NiE {
    ...
    public final S1E clone() {
        return new C26288ATk();
    }

    @Override // X.C60094NiE, X.HSS, X.S1E
    public final int type() {
        return EnumC42934Gt8.ANCHOR_TICKETMASTER.getTYPE();
    }
    ...
    public final void LJIIIIZZ(C188727au eventMapBuilder) {
        ...
        if (C25740A8i.LIZ()) {
            ...
            LJJJJIZL(new AqS170S0100000_4(this, 950));
        }
    }

...
public final class C74584TOy implements XDR<ProviderEffectModel> {
    ...
    public final void onFail(ProviderEffectModel providerEffectModel, C84418XBe exception) {
        ...
        if (th == null) {
            ...
            LIZ.append("Failed on material fetching from effect platform, msg: ");

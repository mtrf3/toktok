...
public final class C20500rG {
    static {
        C0VW.LIZIZ("ProcessUtils");
    }

    public static boolean LIZ(Context context, C0CW c0cw) {
        String str;
        ...
        if (Build.VERSION.SDK_INT >= 28) {
            ...
            try {
                Method declaredMethod = Class.forName("android.app.ActivityThread", false, C20500rG.class.getClassLoader()).getDeclaredMethod("currentProcessName", new Class[0]);

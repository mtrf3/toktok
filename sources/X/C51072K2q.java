...
public final class C51072K2q extends C0CJ {
    public final WeakReference<C74053T4n> LJLIL;
    public int LJLILLLLZI;
    public int LJLJI;

    public C51072K2q(C74053T4n tabLayout) {
        o.LJIIIZ(tabLayout, "tabLayout");
        this.LJLIL = new WeakReference<>(tabLayout);
        this.LJLJI = 0;
        this.LJLILLLLZI = 0;
    }
    ...
    */
    public final void LIZIZ(int r7, float r8, int r9) {
        ...
        L21:
            ...
            goto L18
        */
        throw new UnsupportedOperationException("Method not decompiled: X.C51072K2q.LIZIZ(int, float, int):void");
    }
}

...
public final /* synthetic */ class KML extends TBS implements InterfaceC88472Yns<java.util.Map<String, ? extends String>, C76800UCe> {
    public KML(C56092Lzs c56092Lzs) {
        super(1, c56092Lzs, C56092Lzs.class, "sendCartEntryShowEvent", "sendCartEntryShowEvent(Ljava/util/Map;)V", 0);
    }
    ...
    public final C76800UCe invoke(java.util.Map<String, ? extends String> map) {
        ...
        if (intValue > 0) {
            ...
            C56092Lzs.LJIILIIL("tiktokec_cart_entrance_show", LIZJ);
        }

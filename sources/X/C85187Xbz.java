...
public final class C85187Xbz implements R47 {
    public final /* synthetic */ boolean LIZ;
    public final /* synthetic */ TwoStepVerificationDetailFragment LIZIZ;

    public C85187Xbz(boolean z, TwoStepVerificationDetailFragment twoStepVerificationDetailFragment) {
        this.LIZ = z;
    ...
    public final void onResult(int i, int i2, Object obj) {
        ...
        if (i2 == 1) {
            ...
            ((AI8) twoStepVerificationDetailFragment._$_findCachedViewById(i3)).setTitle(R41.LIZJ().getBindPhone());
        }
    }
}

...
public final class C227098vh extends View {
    ...
    public C227098vh(Context context, AttributeSet attributeSet) {
        super(context, attributeSet, 0);
        a1.LJFF(context, "context");
        Drawable drawable = context.getResources().getDrawable(R.drawable.c6q, null);
        o.LJIIIIZZ(drawable, "context.resources.getDra…le.star_un_shining, null)");
        this.LJLIL = drawable;

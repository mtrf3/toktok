...
public final class C55396Loe implements InterfaceC62486Ofi {
    ...
    public final int LJFF() {
        return R.raw.icon_2pt_widget_stroke;
    }
    ...
    public final int LJJII() {
        ...
        if (LJJJLL != null && (LJJIJIL = LJJJLL.LJJIJIL()) != null) {
            return LJJIJIL.LJJLJLI("follow_widget");
        }
        return 0;
    }
    ...
    public final void LIZLLL(Context context, BaseSharePackage sharePackage) {
        ...
        hashMap.put("position", "share_panel");
        FMX.LJIIL("livesdk_widget_tutorial_click", hashMap);
        LiveOuterService.LJJJLL().LJIIJJI();
        if (C55661Lsv.LJIIL(context)) {
            C16880lQ.LLZILL(Toast.makeText(context, R.string.lzv, 0));
        } else {
            LiveOuterService.LJJJLL().LJIIJJI();
            C55661Lsv.LJIILJJIL("share_panel");
        }
    }

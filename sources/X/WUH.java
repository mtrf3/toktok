...
public final class WUH extends AbstractC83672Wse {
    ...
    public WUH(C83622Wrq cameraApiComponent) {
        o.LJIIIZ(cameraApiComponent, "cameraApiComponent");
        this.LIZ = "action_name_stop_audio_capture";
        this.LIZIZ = C47261Igj.LJJIJ(3);
        this.LIZJ = new AqS180S0100000_14(cameraApiComponent, 330);
    }
}

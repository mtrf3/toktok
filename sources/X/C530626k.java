...
public final class C530626k extends AbstractC65781Prl implements InterfaceC88473Ynt<InterfaceC24420xa<?>, C24570xp, InterfaceC24350xT, C76800UCe> {
    public final /* synthetic */ Object LJLIL;
    public final /* synthetic */ int LJLILLLLZI;
    public final /* synthetic */ int LJLJI;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C530626k(int i, int i2, Object obj) {
        super(3);
        this.LJLIL = obj;
        this.LJLILLLLZI = i;
        this.LJLJI = i2;
    ...
    public final C76800UCe invoke(InterfaceC24420xa<?> interfaceC24420xa, C24570xp c24570xp, InterfaceC24350xT interfaceC24350xT) {
        ...
        if (o.LJ(this.LJLIL, c24570xp2.LJJIL(this.LJLILLLLZI, this.LJLJI))) {
            interfaceC24350xT2.LIZIZ((InterfaceC24390xX) this.LJLIL);
            int i = this.LJLJI;

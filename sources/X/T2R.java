...
public final class T2R implements T2Y, S3A, InterfaceC31127CJn, InterfaceC62096OYq, J03 {
    ...
    @Override // X.S3A
    public void LIZIZ(S3B style) {
        o.LJIIIZ(style, "style");
    }

    @Override // X.InterfaceC62096OYq
    public void LJFF(String str, String str2, Bundle bundle) {
    }
    ...
    public static C60741Nsf LJIIJJI() {
        return new C60741Nsf(null);
    }

    public static LiveCore LJIJJ() {
        ...
        if (interfaceC21020s6 != null) {
            return interfaceC21020s6.getLiveCore();
        }
        return null;
    }
    ...
    @Override // X.T2Y
    public void V3() {
        C72818Shy.LIZ(new C76052yf(System.currentTimeMillis(), null, "subscription_badge_keyboard_confrim"));
    }
    ...
    public long LJ() {
        ...
        LiveCore LJIJJ = LJIJJ();
        if (LJIJJ != null && (adm2 = LJIJJ.getADM()) != null) {
            adm2.startPlayer();
        }
        LiveCore LJIJJ2 = LJIJJ();
        if (LJIJJ2 != null && (adm = LJIJJ2.getADM()) != null) {
            audioRenderSink = adm.createRenderSink();
        ...
        LiveCore LJIJJ3 = LJIJJ();
        int i2 = 0;
        if (LJIJJ3 != null && (builder2 = LJIJJ3.getBuilder()) != null) {
            i = builder2.getAudioSampleHZ();
        } else {
            i = 0;
        }
        LiveCore LJIJJ4 = LJIJJ();
        if (LJIJJ4 != null && (builder = LJIJJ4.getBuilder()) != null) {
            i2 = builder.getAudioChannel();
        }
        long audioLongAddress = ShortVideoAudioPushManager.getAudioLongAddress(audioRenderSink, i, i2);
        if (audioLongAddress < 0) {
            return audioLongAddress & 4294967295L;
        }
        return audioLongAddress;
    }

    public static String LJIJ(byte[] bArr) {
    ...
    public static final JSONArray LJJII(String str) {
        boolean z;
        String str2;
        if (str.length() > 0) {
            z = true;
    ...
    */
    public static java.lang.String LJJIII(com.google.gson.g r4) {
        /*
        ...
        L6:
            int r0 = r4.size()
            if (r2 >= r0) goto L36
            com.google.gson.j r0 = r4.LJJIIZ(r2)     // Catch: java.lang.Exception -> L18
            if (r0 != 0) goto L13
            goto L18
        L13:
            java.lang.String r1 = r0.LJJIFFI()     // Catch: java.lang.Exception -> L18
            goto L19
        L18:
            r1 = 0
        L19:
        ...
        L36:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: X.T2R.LJJIII(com.google.gson.g):java.lang.String");
    }

    @Override // X.S3A
    public SmartImageView LIZJ(Object containerView) {
        o.LJIIIZ(containerView, "containerView");
        return null;
    }

    @Override // X.S3A
    public TuxTextView LIZLLL(Object obj) {
        ViewGroup containerView = (ViewGroup) obj;
        o.LJIIIZ(containerView, "containerView");
        Context context = containerView.getContext();
        o.LJIIIIZZ(context, "containerView.context");
        TuxTextView tuxTextView = new TuxTextView(context, null, 6, 0);
        tuxTextView.setId(R.id.cls);
        Resources resources = tuxTextView.getContext().getResources();
        tuxTextView.setTextColorRes(R.attr.dj);
        tuxTextView.setTuxFont(92);
        tuxTextView.setWidth(resources.getDimensionPixelSize(R.dimen.p5));
        tuxTextView.setHeight(resources.getDimensionPixelSize(R.dimen.ov));
        tuxTextView.setGravity(17);
        tuxTextView.setMaxLines(1);
        tuxTextView.setEllipsize(TextUtils.TruncateAt.END);
        tuxTextView.setBackground(C04270Et.LIZIZ(tuxTextView.getContext(), R.drawable.apl));
    ...
    @Override // X.S3A
    public SmartImageView LJII(Object obj) {
        View containerView = (View) obj;
        o.LJIIIZ(containerView, "containerView");
        View findViewById = containerView.findViewById(R.id.cly);
        ...
        o.LJIIIIZZ(findViewById, "containerView.findViewBy…HolderDrawable)\n        }");
        return (SmartImageView) findViewById;
    }

    @Override // X.S3A
    public TuxTextView LJIIIIZZ(Object containerView) {
        o.LJIIIZ(containerView, "containerView");
        return null;
    }

    @Override // X.S3A
    public AppCompatImageView LJIIJ(Object containerView) {
        o.LJIIIZ(containerView, "containerView");
        return null;
    }

    public static final void LJIIL(LifecycleOwner lifecycleOwner, LifecycleEventObserver observer) {
        Lifecycle lifecycle;
        ...
        XKX.LJ(C36636EZk.LIZ.LJJIJIL(), new C68162lw(lifecycleOwner, observer, null));
    }

    public static final void LJIILIIL(Object obj, C65776Prg c65776Prg) {
        if (c65776Prg.LIZ(obj)) {
            return;
        }
        StringBuilder LIZ = X1D.LIZ();
        LIZ.append("Value cannot be cast to ");
        LIZ.append(c65776Prg.LIZLLL());
        throw new ClassCastException(X1D.LIZIZ(LIZ));
    }

    public static void LJIILJJIL(Object obj, boolean z) {
        if (z) {
        } else {
    ...
    public static void LJIILL(Object obj, String str) {
        LJIILLIIL(str, obj);
        LJIILJJIL(obj, !TextUtils.isEmpty(str));
    }

    public static void LJIILLIIL(Object obj, Object obj2) {
        if (obj != null) {
        } else {
    ...
    public static void LJIIZILJ(Object obj, String str) {
        if (str != null) {
            LJIILL(obj, str);
        }
    }

    public static final Object LJIL(Object obj, InterfaceC65350Pko interfaceC65350Pko) {
        o.LJIIIZ(interfaceC65350Pko, "<this>");
        if (interfaceC65350Pko.LIZ(obj)) {
            o.LJII(obj, "null cannot be cast to non-null type T of kotlin.reflect.KClasses.safeCast");
            return obj;
        }
        return null;
    }

    public static final Object LJJIFFI(InterfaceC88471Ynr interfaceC88471Ynr, final InterfaceC67352kd interfaceC67352kd) {
        final MBA context = interfaceC67352kd.getContext();
        C84662XKo<T> c84662XKo = new C84662XKo<T>(interfaceC67352kd, context) { // from class: X.3Bs
    ...
    public void F8(Context context, String str) {
        if (((IHostResource) CN1.LIZ(IHostResource.class)).h50(context, str)) {
            C01R.LIZIZ(System.currentTimeMillis(), new C78528Urs(C1B8.LIZIZ("value", str, "keyboardType", 0)), "subscription_badge_keyboard_transvalue");
        } else {
            C30868C9o.LIZLLL(R.string.oim, context);
        }
    }

    @Override // X.T2Y
    public void ca(Context context, BadgeIcon badgeIcon, BadgeIconTab badgeIconTab) {
        String str;
        o.LJIIIZ(context, "context");
        o.LJIIIZ(badgeIcon, "badgeIcon");
        long currentTimeMillis = System.currentTimeMillis();
        JSONObject jSONObject = new JSONObject();
        if (badgeIcon.iconType == 2) {
            str = badgeIcon.iconUrl;
        } else {
            str = badgeIcon.iconStr;
        }
        jSONObject.put("value", str);
        jSONObject.put("keyboardType", 1);
        jSONObject.put("iconType", badgeIcon.iconType);
        jSONObject.put("iconStr", badgeIcon.iconStr);
        jSONObject.put("tabId", badgeIconTab.tabId);
        jSONObject.put("iconUri", badgeIcon.iconUri);
        C01R.LIZIZ(currentTimeMillis, new C78528Urs(jSONObject), "subscription_badge_keyboard_transvalue");
    }
}

...
public final class C74643TRf implements U62 {
    ...
    public C74643TRf(C74648TRk c74648TRk) {
    ...
    public final void LJIIJJI(InterfaceC75441TjB session, LeaveMessage leaveMessage) {
        ...
        if (userId != null) {
            C74648TRk c74648TRk = this.LJLIL;
            if (userId.longValue() == ((C29374Bfu) B83.LIZ().LIZIZ()).getCurrentUserId()) {
                c74648TRk.LIZIZ.LIZJ();
            }
        }
    }
    ...
    public final void LJLLILLLL(InterfaceC75441TjB session, PermitApplyMessage permitApplyMessage) {
        ...
        LinkUser LJIJI;
        o.LJIIIZ(session, "session");
        if ((this.LJLIL.LIZIZ instanceof C74992Tbw) && permitApplyMessage.getPermitStatus() == 1) {
            C74992Tbw c74992Tbw = (C74992Tbw) this.LJLIL.LIZIZ;
            c74992Tbw.getClass();
            InterfaceC75441TjB R6 = C8E.LJ().R6();
            if (R6 == null || (LLIIJI = R6.LLIIJI()) == null || (LJIJI = LLIIJI.LJIJI(((C29374Bfu) B83.LIZ().LIZIZ()).getCurrentUserId())) == null || (str = LJIJI.getLinkMicId()) == null) {
                str = "";
            }
            C1EW.LIZ(((MultiLiveApi) Q7L.LIZIZ(MultiLiveApi.class)).zoom(C74995Tbz.LIZLLL(6, str, false))).LJJJLIIL(new AfS65S0100000_13(c74992Tbw, 186), C74644TRg.LJLIL);
        }
    }
    ...
    public final void LJLLI(InterfaceC75441TjB session, String linkMicId, String messageContent) {
        ...
        this.LJLIL.LIZLLL.getValue().getClass();
        LinkLayerRTCMessage LIZIZ = TQ0.LIZIZ(messageContent);
        if (LIZIZ != null) {
            C74648TRk c74648TRk = this.LJLIL;
            if (o.LJ(LIZIZ.getMethod(), "linkMicSDKLayoutChange") && (param = LIZIZ.getParam()) != null) {
                if (param.getZoomLinkMicId().length() != 0) {
                    C74995Tbz c74995Tbz = c74648TRk.LIZIZ;
                    if (c74995Tbz instanceof C74992Tbw) {
                        ((C74992Tbw) c74995Tbz).LJIIZILJ(param.getZoomLinkMicId(), true);
                        C28733BPl LJIILIIL = C28733BPl.LJIILIIL();
                        String str = c74648TRk.LIZJ;
                        C74995Tbz.LJII.getClass();
                        LJIILIIL.LJIIIIZZ(str, C113554cx.LJJLIIIIJ(new OSZ("action", "loadZoomDataFromRoomMsg"), new OSZ(C74995Tbz.LJIIL, param.getZoomLinkMicId())));
                        return;
                    }
                }
                C74995Tbz c74995Tbz2 = c74648TRk.LIZIZ;
                if (c74995Tbz2 instanceof C74992Tbw) {
                    ((C74992Tbw) c74995Tbz2).LJIIZILJ("", false);
                }
            }
        }
    }

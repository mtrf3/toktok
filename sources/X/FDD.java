...
public final class FDD implements FDH {
    public static final FDD LIZ = new FDD();
    ...
    public final EcomGeckoFrontUpdateModel[] config() {
        ...
        LJIIIZ.getClass();
        EcomGeckoFrontUpdateModel[] ecomGeckoFrontUpdateModelArr2 = (EcomGeckoFrontUpdateModel[]) FFL.LJIJ(true, "ecom_common_gecko_front_update_ext2", 31744, EcomGeckoFrontUpdateModel[].class, ecomGeckoFrontUpdateModelArr);

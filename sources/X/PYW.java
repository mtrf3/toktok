...
public final class PYW extends HttpURLConnection {
            ...
            synchronized (this) {
                if (this.LJFF == null) {
                    ...
                    if (PZR.LIZ(getHeaderField("Content-Type"))) {
                        inputStream = new C61655OHr(inputStream2, new PYX(this));
                    } else {
                        C65299Pjz.LIZ(this, null, this.LJ);
    ...
    public PYW(HttpURLConnection httpURLConnection) {
        super(httpURLConnection.getURL());
        this.LJIIIZ = httpURLConnection;
        this.LIZ = -1;
        this.LIZLLL = new PZQ(httpURLConnection);

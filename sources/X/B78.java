...
public final class B78 implements InterfaceC75158Tec {
    public final /* synthetic */ BQM LJLIL;
    ...
    public final void LJIILJJIL(int i, int i2, String str) {
        ...
        if (!bqm.LJ) {
            bqm.LJ = true;
            Room room = (Room) bqm.LIZJ.kv0(RoomChannel.class);
            if (room != null) {
                long LIZ = B76.LIZ();
                if (LIZ > 0) {
                    long currentTimeMillis = System.currentTimeMillis() - LIZ;
                    BZI LIZ2 = C28787BRn.LIZ("livesdk_live_real_audience_avatar_load_duration");

...
public final class C43763HFn extends AbstractC43762HFm {
    ...
    public final ExtractFramesModel LJI() {
        ...
        if ((interfaceC65784Pro != null && (extractFramesModel = interfaceC65784Pro.invoke()) != null) || (extractFramesModel = this.LJ.extractFramesModel) != null) {
            int i = HGF.LIZ[this.LIZLLL.LIZ.ordinal()];
            if (i != 1) {
                if (i == 2) {
    ...
    public final void LJFF(HGQ hgq) {
        ...
        C10K.LIZJ(new CallableC43760HFk(this)).LIZLLL(new AgS110S0200000_7((HGD) hgq, this, 19));
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C43763HFn(HG7 hg7, VideoPublishEditModel videoPublishEditModel) {

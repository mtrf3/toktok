...
public final class NXO extends AbstractC65781Prl implements InterfaceC88471Ynr<FeedCommerceAssem, C43I<? extends Boolean>, C76800UCe> {
    public static final NXO LJLIL = new NXO();
    ...
    public final C76800UCe invoke(FeedCommerceAssem feedCommerceAssem, C43I<? extends Boolean> c43i) {
        ...
        if (c43i2 != null) {
            if (((Boolean) c43i2.LIZ).booleanValue()) {
                ...
                if (dataCenter2 != null) {
                    dataCenter2.jv0(null, "on_ad_pop_up_web_page_hide");
                }
            }
        }

...
public final class QWU implements InterfaceC67148QWy {
    ...
    public final void LJIJJLI(WsChannelMsg msg) {
        ...
        try {
            ...
            ReplaceMusicServiceImpl.LIZ().showWindow(jSONObject, JSONObjectProtectorUtils.getBoolean(jSONObject, "success"));
            LIZ = C76800UCe.LIZ;

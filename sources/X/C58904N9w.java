...
public final class C58904N9w implements InterfaceC60850NuQ {
    ...
    public final void LJFF(SparkActivity activity) {
        ...
        String LLJJIJIIJIL = C16880lQ.LLJJIJIIJIL(activity.getIntent(), "is_audit_country");
        if (LLJJIJIIJIL != null) {
            C2U8.LIZ(new C190737e9(o.LJ(LLJJIJIIJIL, "1")));
        }
    }

...
public final class C74049T4j extends C47121t6 {
    public final C47121t6 LJLLLL;
    public final LinearGradient LJLLLLLL;
    public int LJLZ;
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (c47121t6 != null && (paint = c47121t6.getPaint()) != null) {
            ...
            paint.setStrokeWidth((B9K.LIZ(context, 4.0f) / TypedValue.applyDimension(2, 28.0f, context.getResources().getDisplayMetrics())) * getTextSize());
        }
    ...
    public C74049T4j(Context context, AttributeSet attributeSet) {
        super(context, attributeSet, 0);
        a1.LJFF(context, "context");
        this.LJLLLLLL = new LinearGradient(0.0f, 0.0f, 0.0f, C15380j0.LIZ(12.0f), ColorProtector.parseColor("#3DFFE5"), ColorProtector.parseColor("#4FBEFF"), Shader.TileMode.CLAMP);
        if (attributeSet != null) {
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, new int[]{R.attr.bf_});
            o.LJIIIIZZ(obtainStyledAttributes, "context.obtainStyledAttr…eShowTimeStickerTextView)");
            this.LJLZ = obtainStyledAttributes.getColor(0, 0);
    ...
    public final void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        if (z) {
            getPaint().setShader(this.LJLLLLLL);
        }
    }
}

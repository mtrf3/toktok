...
public class C80685VlZ extends LinearLayout {
    public int LJLIL;
    ...
    public int LJLLJ;
    public final /* synthetic */ C80684VlY LJLLL;
    ...
    public C80685VlZ(C80684VlY c80684VlY, Context context) {
        super(context);
        this.LJLLL = c80684VlY;
        this.LJLJI = -1;
        this.LJLJJL = -1;
        this.LJLJJLL = -1;
        this.LJLJL = -1;
        c80684VlY.LJIIIIZZ(27);
    ...
    public final void LIZ(int i, int i2) {
        ...
        if (Math.abs(i - this.LJLJI) <= 1) {
            ...
            int LJIIIIZZ = this.LJLLL.LJIIIIZZ(24);
            if (i >= this.LJLJI ? !z : z) {
                i3 = left - LJIIIIZZ;
            } else {
                i3 = LJIIIIZZ + right;
        ...
        if (i4 != left || i3 != right) {
            ...
            valueAnimator2.setInterpolator(C80684VlY.LLIIJI);
            valueAnimator2.setDuration(i2);
            valueAnimator2.setFloatValues(0.0f, 1.0f);
            valueAnimator2.addUpdateListener(new AUListenerS1S0104000_14(this, i4, left, i3, right, 3));
            valueAnimator2.addListener(new ALAdapterS3S0101000_14(this, i, 3));
    ...
    public final void onMeasure(int i, int i2) {
        ...
        C80684VlY c80684VlY = this.LJLLL;
        int i6 = c80684VlY.LJZL;
        if (i6 == 1) {
            if (c80684VlY.LJZI != 1 || i4 <= 0) {
                return;
            }
            if (i4 * childCount <= getMeasuredWidth() - (c80684VlY.LJIIIIZZ(16) * 2)) {
                boolean z2 = false;
                while (i3 < childCount) {
                ...
                C80684VlY c80684VlY2 = this.LJLLL;
                c80684VlY2.LJZI = 0;
                c80684VlY2.LJIJ(false);
            }
            super.onMeasure(i, i2);
            return;
        }
        if (i6 != 0 || !c80684VlY.LLD || c80684VlY.LLIIIZ != getResources().getConfiguration().orientation || i4 <= 0) {
            return;
        }
        int i7 = 0;
        ...
        if (i7 > 0 && i7 < (measuredWidth = (this.LJLLL.getMeasuredWidth() - this.LJLLL.LJLJI.getPaddingLeft()) - this.LJLLL.LJLJI.getPaddingRight())) {

...
public final class C92355a9P extends C92219a7D {
    ...
    public C92355a9P(String str, InterfaceC88472Yns interfaceC88472Yns, Elements elements) {
        super(elements, null, true, null, interfaceC88472Yns, null, null, 438);
        this.LJIIZILJ = str;
        this.LJIJ = 14;
        this.LJ = ORZ.LLIIIZ(C47261Igj.LJJIJ(C92185a6f.LIZ), this.LJ);
        this.LJIJI = new IDqS418S0100000_31(this, 47);
    }
}

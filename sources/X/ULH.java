...
public final class ULH extends DataChannelSceneObserver<C30744C4u, ProgrammedLiveMenuVisibilityChannel> {
    ...
    public ULH(C1O4 c1o4) {
        super(false);
        this.LIZ = C78996UzQ.LJJIJIIJI(new AqS163S0100000_13(c1o4, 9));
    }
    ...
    public final void onEvent(LayeredElementContext layeredElementContext, ConstraintProperty constraintProperty, C30744C4u c30744C4u) {
        ...
        valueAnimator.addUpdateListener(new AUListenerS100S0100000_13(constraintProperty, 2));
        valueAnimator.start();
    }
}

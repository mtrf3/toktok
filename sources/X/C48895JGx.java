...
public final class C48895JGx extends AbstractC65781Prl implements InterfaceC65784Pro<C222908ow> {
    public static final C48895JGx LJLIL = new C48895JGx();
    ...
    public final C222908ow invoke() {
        ?? r4 = new JH1() { // from class: X.8ow
            @Override // X.JH1
            public final void Fk0() {
            }
        ...
        C113554cx.LJJJLZIJ(new OSZ("enter_from", "general_search"), new OSZ("bundle", "player_core"));
        return r4;
    }
}

...
public final class CQ8 implements InterfaceC31318CQw<LikeMessage> {
    public long LIZ;
    public int LIZIZ;

    @Override // X.InterfaceC31318CQw
    public final boolean LIZIZ(LikeMessage message) {
    ...
    public final boolean LIZ(CQQ context, CR6 cr6) {
        C19690px c19690px;
        LikeMessage message = (LikeMessage) cr6;
        o.LJIIIZ(message, "message");
        ...
        if (this.LIZIZ == 0) {
            ...
            if (dataChannel == null || (c19690px = (C19690px) dataChannel.kv0(C54812Dd.class)) == null || !c19690px.LIZJ || SystemClock.uptimeMillis() - context.LJIILL <= c19690px.LJI) {
                return false;
            }

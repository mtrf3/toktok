...
public final class SMX extends SN1<DuetViewModel> {
    ...
    public final String LLIIIILZ() {
        ...
        if (LLIIIILZ == null) {
            if (C78966Uyw.LJJIJL()) {
                return this.LJLIL.getString(R.string.h15);
            }
            return null;
        }
        return LLIIIILZ;
    ...
    public static final SKZ LLIIIZ(InterfaceC65784Pro<Boolean> interfaceC65784Pro) {
        ...
        if (LIZLLL2 != null) {
            videoCount = LIZLLL2.duet;
        } else {
            videoCount = null;
        }
        return LIZLLL.LJFF(interfaceC65784Pro, videoCount, R.string.b60, R.plurals.ai, R.plurals.aj);
    }

    @Override // X.SN1
    public final void LLIIIL(int i) {
        if (C78966Uyw.LJJIJL() && i == 3) {
            SMT.LIZIZ(3, 3, ((DuetViewModel) this.LJLL).LJLJL);
        }
        super.LLIIIL(i);
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public SMX(DuetViewModel viewModel, Context context, LifecycleOwner lifecycleOwner, PrivacySettingsAdapterConfigs configs, SKL toastHolder) {
        ...
        LJLLLLLL(C78966Uyw.LJI(R.string.p9h));
        SL4 sl4 = new SL4();
        sl4.LJIILLIIL = 0;
        ...
        LJLLLLLL(sl4.LIZ());
        LJLLLLLL(LLIIIZ(new AqS162S0100000_12(this, 978)));
        C71909SKb.LIZ.getClass();
        C71909SKb.LIZJ().LIZ();
        ...
        sl42.LJ = valueOf;
        LJLLLLLL(sl42.LIZ());
        LJLLLLLL(LLIIIZ(new AqS162S0100000_12(this, 979)));
        SL4 sl43 = new SL4();
        sl43.LJIILLIIL = 3;
        LLIFFJFJJ(sl43, 3, false);
        AbstractC71913SKf.LIZJ(sl43, R.string.jdf);
        sl43.LJI = new AqS159S0200000_12(this, context, 41);
        LJLLLLLL(sl43.LIZ());
        viewModel.LJLJI.observe(lifecycleOwner, new AObserverS75S0200000_12(lifecycleOwner, this, 19));
        viewModel.LJLJJI.observe(lifecycleOwner, new AObserverS75S0200000_12(this, viewModel, 20));
    }
}

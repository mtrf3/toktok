...
public final class GCB extends AbstractC65781Prl implements InterfaceC88472Yns<BaseActivityViewModel, C76800UCe> {
    public static final GCB LJLIL = new GCB();
    ...
    public final C76800UCe invoke(BaseActivityViewModel baseActivityViewModel) {
        ...
        activityConfiguration.config(GCA.LJLIL);

...
public final class CLX implements InterfaceC60949Nw1 {
    public final /* synthetic */ C31187CLv LIZ;

    public CLX(C31187CLv c31187CLv) {
        this.LIZ = c31187CLv;
    }
    ...
    public final void LJIILLIIL(SparkPopup popup) {
        ...
        if (this.LIZ.LJLJJL) {
            C73943T0h.LIZ().LIZIZ(new B89(false));
        }
    }

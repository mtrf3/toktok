...
public final class C44641HfZ {
    public final C44639HfX LIZ;

    public final CompileConfigResolution LIZ() {
        C44628HfM c44628HfM = new C44628HfM();
        C44650Hfi LJIILIIL = C78685UuP.LJIILIIL();
        LJIILIIL.LIZIZ(C44636HfU.LIZ, new AqS138S0200000_7(this, c44628HfM, 119));
        return ((CanvasCompileConfigParams) LJIILIIL.execute()).getOutputSize();
    }

    public C44641HfZ(C44639HfX c44639HfX) {
        this.LIZ = c44639HfX;
    }
}

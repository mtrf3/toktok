...
public final class C81838W9y implements IHD<C81392Vwy<W5A>> {
    public final /* synthetic */ InterfaceC73573Su9<Void> LIZ;
    public final /* synthetic */ C43773HFx LIZIZ;
    ...
    public final void LIZLLL(W4W<C81392Vwy<W5A>> w4w) {
        ...
        if (w4w != null && (result = w4w.getResult()) != null && (LJI = result.LJI()) != null) {
            C43773HFx c43773HFx = this.LIZIZ;
            InterfaceC73573Su9<Void> interfaceC73573Su9 = this.LIZ;
            ...
            if (z) {
                ...
                for (int i2 = 0; i2 < frameCount; i2 += i) {
                    ...
                    LIZ.append(c43773HFx.LJ);
                    LIZ.append("extract-frame-custom_sticker-");
            ...
            c43773HFx.getClass();
            Bitmap LIZIZ = C42299Git.LIZIZ(path, iArr2, Bitmap.Config.ARGB_4444);
            StringBuilder LIZ2 = X1D.LIZ();
            LIZ2.append(c43773HFx.LJ);
            LIZ2.append("extract-frame-custom_sticker-");
    ...
    public C81838W9y(C73433Srt c73433Srt, C43773HFx c43773HFx, String str) {
        this.LIZ = c73433Srt;
        this.LIZIZ = c43773HFx;
        this.LIZJ = str;
    }
}

...
public final class MZJ extends C8HS<BaseNotice> {
    public final MusNotificationDetailActivity LJLIL;
    ...
    public final int getBasicItemViewType(int i) {
        ...
        if (data != null && (baseNotice = (BaseNotice) ListProtector.get(data, i)) != null && baseNotice.templateNotice != null) {
            return -10000;
        }
        return 0;
    }
    ...
    public final void onBindBasicViewHolder(RecyclerView.ViewHolder viewHolder, int i) {
        ...
        if (list != 0) {
            baseNotice = (BaseNotice) ListProtector.get(list, i);
        } else {
            baseNotice = null;
        }
        int i2 = 0;
        ...
        if (baseNotice != null) {
            if (!z && this.LJLJJLL.get(baseNotice.nid) != null) {
                z = true;
            }
            if (viewHolder != null) {
    ...
    public MZJ(MusNotificationDetailActivity ctx, MZI mzi, MZI mzi2, int i) {
        super(false, 1, null);
        o.LJIIIZ(ctx, "ctx");
        this.LJLIL = ctx;
        this.LJLILLLLZI = mzi;
        this.LJLJI = mzi2;
        this.LJLJJI = i;
        C5H3 LJZI = V1B.LJZI(new AqS159S0100000_9(this, 1072));
        this.LJLJJL = LJZI;
        this.LJLJJLL = new HashMap<>(this.LJLJJI);
        this.LJLJL = (int) KL2.LIZJ(EF7.LIZIZ(), 8.0f);
        ((LiveData) ((NotificationDetailVM) LJZI.getValue()).LJLILLLLZI.getValue()).observe(ctx, new AObserverS77S0100000_9(this, 149));
    }
}

...
public final class LY2 implements LDY {
    public final /* synthetic */ FollowSkyLightHelper LJLIL;

    public LY2(FollowSkyLightHelper followSkyLightHelper) {
    ...
    public final void LIZ(String str, String to) {
        ...
        if (TextUtils.equals(to, "Following")) {
            this.LJLIL.LJFF();
        }
        ...
        if (TextUtils.equals(to, "Following") && (weakReference = this.LJLIL.LJII) != null && (activityC45651qj = weakReference.get()) != null && (LJJLIIIJJI = C78866UxK.LJJLIIIJJI(activityC45651qj)) != null && (LJIL = C87277YNd.LJIL(LJJLIIIJJI)) != null && LJIL.zW("HOME")) {
            z = true;
        }

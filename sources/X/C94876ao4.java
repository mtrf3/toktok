...
@InterfaceC65848Psq(c = "com.ss.android.ugc.aweme.music.app.auth.addtodsp.AddToMusicDspAuthUtil$onActivityResultFromAmazonMusicAuth$6$1$1$1", f = "AddToMusicDspAuthUtil.kt", l = {}, m = "invokeSuspend")
/* renamed from: X.ao4, reason: case insensitive filesystem */
/* loaded from: classes34.dex */
public final class C94876ao4 extends AbstractC65782Prm implements InterfaceC88471Ynr<InterfaceC70422pa, InterfaceC67352kd<? super C76800UCe>, Object> {
    public final /* synthetic */ XGX<C94478ahe> LJLIL;
    ...
    public C94876ao4(XGX<C94478ahe> xgx, Fragment fragment, Activity activity, InterfaceC65784Pro<C76800UCe> interfaceC65784Pro, InterfaceC67352kd<? super C94876ao4> interfaceC67352kd) {
    ...
    public final InterfaceC67352kd<C76800UCe> create(Object obj, InterfaceC67352kd<?> interfaceC67352kd) {
        return new C94876ao4(this.LJLIL, this.LJLILLLLZI, this.LJLJI, this.LJLJJI, interfaceC67352kd);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (xgx instanceof XGW) {
            ...
            if (C78977Uz7.LJJJJI(this.LJLIL.LIZJ) == EnumC78982UzC.Optimistic) {
                C94302aeo.LL.add(C94302aeo.LJLJJL);
                C9A8 c9a8 = C94302aeo.LJLLILLLL;
                if (c9a8 != null) {
                    int i = C93874aXu.LIZ[c9a8.ordinal()];
                    if (i != 1) {
                        if (i != 2) {
                ...
                AmazonAccessTokenResponse amazonAccessTokenResponse = ((C94478ahe) d).LIZ;
                if (amazonAccessTokenResponse == null || (str = amazonAccessTokenResponse.accessToken) == null) {
                    str = "";
                }
                AmazonAccessTokenResponse amazonAccessTokenResponse2 = ((C94478ahe) d).LIZ;
                ...
                C94302aeo.LJLJL = new DspAuthToken(null, new AmazonMusicToken(str), null);
            ...
            if (xgx instanceof XGT) {
                ...
                if (c57301MeH instanceof C57300MeG) {
                    ...
                    DspPlatform dspPlatform2 = DspPlatform.AMAZON_MUSIC;
                ...
                DspPlatform dspPlatform3 = DspPlatform.AMAZON_MUSIC;

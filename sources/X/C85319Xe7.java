...
public final class C85319Xe7 implements InterfaceC19530ph {
    public final /* synthetic */ PoiSearchCell LIZ;

    public C85319Xe7(PoiSearchCell poiSearchCell) {
    ...
    public final void LIZ(View view, String itemID) {
        ...
        if (o.LJ(str, ((C85192Xc4) this.LIZ.M().getState()).LJLIL)) {
            ...
            poiSearchCell.getClass();
            HashMap hashMap = new HashMap();
            C85316Xe4 item2 = poiSearchCell.getItem();
            if (item2 != null && (c85317Xe54 = item2.LJLJJI) != null) {
                str2 = c85317Xe54.LIZJ;
            } else {
                str2 = null;
            }
            PoiMobParam poiMobParam = poiSearchCell.M().LJLLILLLL;
            if (poiMobParam != null) {
            ...
            C85316Xe4 item3 = poiSearchCell.getItem();

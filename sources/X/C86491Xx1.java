...
/* renamed from: X.Xx1, reason: case insensitive filesystem */
/* loaded from: classes16.dex */
public final class C86491Xx1 extends C86492Xx2 {
    ...
    public final void LIZIZ(Bitmap bitmap) {
        ...
        if (bitmap != null && (innerPushUITemplate = this.LJLJI) != null) {
            innerPushUITemplate.setPreloadTopImage(bitmap);
        }
        this.LJLIL.getTracker().LJIIJJI = System.currentTimeMillis() - this.LJLILLLLZI.element;
    }
    ...
    public final void onProgress(float f) {
        ...
        LIZ.append("topImageUrl onProgress progress:");
        LIZ.append(f);
        C86478Xwo.LIZ("InnerPushViewPreload", X1D.LIZIZ(LIZ));
    }

    public C86491Xx1(InnerPushMessage innerPushMessage, C72242sW c72242sW, InnerPushUITemplate innerPushUITemplate) {

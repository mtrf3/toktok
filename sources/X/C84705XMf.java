...
public final class C84705XMf extends AbstractC65781Prl implements InterfaceC65784Pro<Boolean> {
    public final /* synthetic */ SignupViewModel LJLIL;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C84705XMf(SignupViewModel signupViewModel) {
        super(0);
    ...
    public final Boolean invoke() {
        ...
        if (intent != null) {
            ...
            if (LJJLIIIIJ != null) {
                z = LJJLIIIIJ.getBoolean("age_gate_block");
            } else {
                z = false;
            }

...
public final class C23Q extends F9E implements InterfaceC44951pb {
    ...
    public final InterfaceC273515n LJIILL(InterfaceC44861pS measure, InterfaceC39071g7 interfaceC39071g7, long j) {
        ...
        if (interfaceC39071g7.LJJLJLI(C23360vs.LJI(j)) < C23360vs.LJII(j)) {
            LIZ = j;
        } else {
            LIZ = C23360vs.LIZ(j, 0, Integer.MAX_VALUE, 0, 0, 13);
        }
        AbstractC39201gK LJJJIL = interfaceC39071g7.LJJJIL(LIZ);
        int min = Math.min(LJJJIL.LJLIL, C23360vs.LJII(j));
        LJJLIL = measure.LJJLIL(min, LJJJIL.LJLILLLLZI, C113554cx.LJJJLIIL(), new IDqS0S0301000(measure, this, LJJJIL, min, 3));
        return LJJLIL;
    }

    public C23Q(C18690oL c18690oL, int i, C14770i1 c14770i1, IDqS420S0100000 iDqS420S0100000) {
        this.LJLIL = c18690oL;
        this.LJLILLLLZI = i;
        this.LJLJI = c14770i1;

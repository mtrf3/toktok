...
public final class C44366Hb8 implements IEffectDownloadProgressListener {
    ...
    public final void onSuccess(Effect effect) {
        ...
        c145995oB.LJ("is_auto_download", this.LIZJ);
        if (effect2 != null) {
    ...
    public C44366Hb8(String str, IFetchEffectListener iFetchEffectListener, boolean z, java.util.Map<String, String> map) {
        this.LIZ = str;

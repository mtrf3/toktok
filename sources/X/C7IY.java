...
public final class C7IY extends AbstractC65781Prl implements InterfaceC88473Ynt<C119624mk, C119624mk, C119624mk, C76800UCe> {
    public final /* synthetic */ long LJLIL;
    public final /* synthetic */ C183907Jq LJLILLLLZI;
    public final /* synthetic */ List<UpvoteStruct> LJLJI;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C7IY(long j, C183907Jq c183907Jq, List<UpvoteStruct> list) {
        super(3);
        this.LJLIL = j;
        this.LJLILLLLZI = c183907Jq;
        this.LJLJI = list;
    }
    ...
    public final C76800UCe invoke(C119624mk c119624mk, C119624mk c119624mk2, C119624mk c119624mk3) {
        ...
        if (this.LJLIL > 0) {
            ...
            C183907Jq.LJJLL(context, avatarStart, urlModel2);
        }
        if (this.LJLIL > 1) {
            ...
            C183907Jq.LJJLL(context2, avatarMiddle, urlModel);
        }
        if (this.LJLIL > 2) {
            ...
            C183907Jq.LJJLL(context3, avatarEnd, urlModel3);
        }
        avatarMiddle.bringToFront();
        avatarStart.bringToFront();

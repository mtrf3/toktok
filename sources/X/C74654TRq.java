...
public final class C74654TRq<T> implements InterfaceC64592gB {
    public static final C74654TRq<T> LJLIL = new C74654TRq<>();
    ...
    public final void accept(Object obj) {
        ...
        if (j2 > 0) {
            C75159Ted.LJ = (C73411SrX) TMC.LJJI(j2, TimeUnit.SECONDS).LJJJ(T16.LIZ()).LJJJLIIL(C74642TRe.LJLIL, new InterfaceC64592gB() { // from class: X.9DE
                @Override // X.InterfaceC64592gB

...
public final class CMS extends ElementSpecImpl {
    ...
    public CMS(LayeredElementContext layeredElementContext) {
        super(C77067UMl.LIZIZ);
        this.LJLIL = layeredElementContext;
        this.LJLILLLLZI = C78996UzQ.LJJIJIIJI(new AqS155S0100000_5(this, 317));
    }
}

...
public final class C7XD {
    ...
    public static void LIZIZ(String str, String msg) {
        ...
        String LIZLLL = LIZLLL(str);
        if (C36922EeM.LIZ) {
            C36922EeM.LIZLLL(6, LIZLLL, msg);
        }
    }

    public static void LJ(String tag, String msg) {
        o.LJIIIZ(tag, "tag");
        o.LJIIIZ(msg, "msg");
    ...
    public static void LIZJ(String str, String msg, Throwable t) {
        o.LJIIIZ(msg, "msg");
        o.LJIIIZ(t, "t");
        String LIZLLL = LIZLLL(str);
        if (C36922EeM.LIZ) {

...
public final class C85845Xmb implements IAVPublishExtension<PoiPublishModel> {
    public final String LJLIL = "PoiEditPostPublishExtensionV2";
    public PoiPublishExtensionVMV2 LJLILLLLZI;
    ...
    public final PoiPublishModel provideExtensionData() {
        PoiPublishExtensionVMV2 poiPublishExtensionVMV2 = this.LJLILLLLZI;
        if (poiPublishExtensionVMV2 != null) {
            PoiData poiData = poiPublishExtensionVMV2.getState().LJLILLLLZI;
            PoiPublishExtensionVMV2 poiPublishExtensionVMV22 = this.LJLILLLLZI;
    ...
    public final void onExtensionEnable(java.util.Map<AVPublishExtensionBiz, ? extends AVPublishExtensionVisible> map) {
        ...
        if (view != null) {
            ...
            int i = C42291Gil.LIZ[aVPublishExtensionVisible2.ordinal()];
            if (i != 1) {
                if (i != 2) {
                    if (i != 3) {
                        return;
                ...
                sy1.setOnClickListener(new ViewOnClickListenerC13880ga(new ACListenerS35S0100000_15(this, 190)));
    ...
    */
    public final void onActivityResult(int r6, int r7, android.content.Intent r8) {
        /*
            ...
            r2 = 0
            if (r4 == 0) goto L21
            com.ss.android.ugc.aweme.poi.videopublish.v2.PoiPublishExtensionVMV2 r1 = r5.LJLILLLLZI
            if (r1 == 0) goto L6c
        ...
        L3d:
            ...
            if (r1 == 0) goto L4b
            com.ss.android.ugc.aweme.poi.videopublish.v2.PoiPublishExtensionVMV2 r0 = r5.LJLILLLLZI
            if (r0 == 0) goto L60
            r0.LJLILLLLZI = r1
        L4b:
        ...
        L6c:
            ...
            throw r2
        */
        throw new UnsupportedOperationException("Method not decompiled: X.C85845Xmb.onActivityResult(int, int, android.content.Intent):void");
    }
    ...
    public final void onCreate(Fragment fragment, View view, LifecycleOwner lifecycleOwner, LinearLayout extensionWidgetContainer, Bundle bundle, AVPublishContentType contentType, PublishOutput publishOutput, ExtensionMisc extensionMisc, IAVPublishExtension.Callback callback) {
        ...
        C9BE c9be = C9BE.LIZ;
        AqS165S0100000_15 aqS165S0100000_15 = new AqS165S0100000_15(LIZ, 781);
        C85842XmY c85842XmY = C85842XmY.INSTANCE;
        if (o.LJ(c9be, C9BD.LIZ)) {
            z = false;
            c214298b3 = new C214298b3(aqS165S0100000_15, C214528bQ.LJLIL, C78926UyI.LJJII(fragment, true), C78926UyI.LJJIIJZLJL(fragment, true), C184077Kh.LJLIL, C78926UyI.LJJ(fragment, true), C78926UyI.LJIILLIIL(fragment, true), c85842XmY, LIZ);
        } else {
            z = false;
            if (c9be == null || o.LJ(c9be, c9be)) {
                c214298b3 = new C214298b3(aqS165S0100000_15, C214528bQ.LJLIL, C78926UyI.LJJII(fragment, false), C78926UyI.LJJIIJZLJL(fragment, false), C184077Kh.LJLIL, C78926UyI.LJJ(fragment, false), C78926UyI.LJIILLIIL(fragment, false), c85842XmY, LIZ);
            } else {
                throw new IllegalArgumentException("Do not support this scope here.");
            }
        }
        this.LJLILLLLZI = (PoiPublishExtensionVMV2) c214298b3.getValue();
        View LLLLIILL = C16880lQ.LLLLIILL(C16880lQ.LLZIL(fragment.getContext()), R.layout.c17, extensionWidgetContainer, true);
        o.LJIIIIZZ(LLLLIILL, "from(fragment.context)\n …ionWidgetContainer, true)");
        this.LJLJJI = LLLLIILL;
        C8VV.LIZ(fragment, z, new AqS60S0400000_15(fragment, contentType, extensionMisc, this, 1));

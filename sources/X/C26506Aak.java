...
public final class C26506Aak extends C26505Aaj {
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C26506Aak(LifecycleOwner owner) {
        super(owner);
    ...
    public final void LIZLLL(ActivityC45651qj activityC45651qj, AddressListViewModel vm) {
        ...
        C73156SnQ.LJIIIIZZ(this, vm, new TBT() { // from class: X.AcT
            @Override // X.TBT, X.TBZ, X.TBW
            public final Object get(Object obj) {
                return Integer.valueOf(((AddressListState) obj).getStatus());
            }
        }, new AqS167S0200000_4(activityC45651qj, vm, 38));
    }
    ...
    public final void LIZ(AddressListViewModel vm, View view) {
        o.LJIIIZ(vm, "vm");
        o.LJIIIZ(view, "view");
        ((RecyclerView) view.findViewById(R.id.isf)).LJII(new C71312Rym(C32151Nz.LJIIZILJ(16), C1EU.LIZ(view, "view.context", R.attr.dz), 2, 0), -1);

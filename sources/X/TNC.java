...
public final class TNC<T, R> implements InterfaceC48038ItG<OSZ<? extends List<? extends ProviderEffect>, ? extends ProviderEffectModel>, List<? extends ProviderEffect>> {
    public static final TNC LJLIL = new TNC();

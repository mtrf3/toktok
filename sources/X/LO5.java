...
public final class LO5 {
    ...
    public final void LIZIZ() {
        ...
        if (i > 0 && ((tuxIconView = this.LJI) == null || tuxIconView.getParent() == null)) {
            ...
            tuxIconView3.setIconWidth(LIZIZ);
            tuxIconView3.setIconHeight(LIZIZ);
            if (!this.LJIIIIZZ) {
            ...
            C16880lQ.LJJJ(tuxIconView3, new ACListenerS29S0100000_9(this, 203));
    ...
    public LO5(ActivityC45651qj activityC45651qj, LOS host, FrameLayout frameLayout, LOF lof, boolean z, ITabStrip mainTabStrip) {
        o.LJIIIZ(host, "host");
        ...
        this.LJIIIIZZ = C90193gN.LIZIZ(activityC45651qj);
    }
}

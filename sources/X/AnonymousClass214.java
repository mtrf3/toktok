...
public final class AnonymousClass214 extends AbstractC65781Prl implements InterfaceC88472Yns<Double, Double> {
    public final /* synthetic */ double LJLIL;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public AnonymousClass214(double d) {
        super(1);
        this.LJLIL = d;
    }
    ...
    public final Double invoke(Double d) {
        ...
        return Double.valueOf(Math.pow(doubleValue, 1.0d / this.LJLIL));
    }
}

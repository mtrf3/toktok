...
public final class C105304Bi extends C105364Bo<InterfaceC105334Bl> {
    public TextView LJLIL;
    public final /* synthetic */ C105254Bd LJLILLLLZI;
    ...
    public C105304Bi(C105254Bd c105254Bd, View view) {
        super(view);
        this.LJLILLLLZI = c105254Bd;
    }
    ...
    public final void bind(InterfaceC105334Bl interfaceC105334Bl, final int i) {
        ...
        if (textView != null) {
            ...
            if (!TextUtils.isEmpty(tabItem.getName())) {
                ...
                if (textView3 != null) {
                    h0.LJIJI(textView3, new IDaS464S0100000(new InterfaceC025608e() { // from class: X.4DJ
            ...
            int i2 = this.LJLILLLLZI.LJLIL.LJLJLJ.LJII;
            ...
            if (textView4 != null) {
                ...
                if (textView5 != null) {
                    C16880lQ.LJIJI(textView5, new ACListenerS19S0201000_1(this, this.LJLILLLLZI, i, 6));
                    ...
                    if (interfaceC88471Ynr != null) {
                        ...
                        if (textView6 != null) {
                            textView6.setOnLongClickListener(new View.OnLongClickListener() { // from class: X.3TN

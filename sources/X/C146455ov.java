...
public final class C146455ov extends C147685qu implements InterfaceC135635Tz {
    ...
    static {
        TBT tbt = new TBT(C146455ov.class, "editAdapterApi", "getEditAdapterApi()Lcom/ss/android/ugc/gamora/editor/adapter/EditAdapterApi;", 0);
    ...
    private final C146475ox LJJLIIIJILLIZJL() {
        return (C146475ox) this.LLIL.getValue();
    }
    ...
    public C146455ov(C82622Wbi diContainer, WMH parentScene, int i) {
        super(diContainer);
        ...
        this.LLIIZ = i;
        this.LLIL = C221108m2.LIZIZ(new AqS152S0100000_2(this, 115));
        this.LLILII = UCI.LJI(getDiContainer(), InterfaceC142515iZ.class, null);
        C146475ox LJJLIIIJILLIZJL = LJJLIIIJILLIZJL();

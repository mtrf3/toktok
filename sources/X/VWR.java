...
public final class VWR extends C80217Ve1 implements InterfaceC33971Uz {
    public final C16610kz LJLZ;
    public final VWS LJZ;
    ...
    public final void onDetachedFromWindow() {
        ...
        VWS vws = this.LJZ;
        VelocityTracker velocityTracker = vws.LIZ;
    ...
    public VWR(Context context, AttributeSet attributeSet) {
        super(context, attributeSet);
        a1.LJFF(context, "context");
        this.LJLZ = new C16610kz(this);
        this.LJZ = new VWS(this);
    ...
    */
    public final boolean LJIIIZ(android.view.MotionEvent r18, X.InterfaceC88471Ynr<? super java.lang.Float, ? super java.lang.Float, java.lang.Boolean> r19) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: X.VWR.LJIIIZ(android.view.MotionEvent, X.Ynr):boolean");
    }

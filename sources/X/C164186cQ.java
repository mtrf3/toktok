...
public final class C164186cQ extends AbstractC29891Fh<InterfaceC164226cU> implements InterfaceC164226cU, InterfaceC143795kd, InterfaceC135635Tz {
    ...
    public final InterfaceC164206cS LJLJJL;
    public final C29901Fi<Integer> LJLJJLL;
    public int LJLJL;
    public WM7 LJLJLJ;
    public final LiveEvent<Integer> LJLJLLL;
    public final WOR LJLL;

    static {
        TBT tbt = new TBT(C164186cQ.class, "recordControlApi", "getRecordControlApi()Lcom/bytedance/creativex/recorder/camera/api/RecordControlApi;", 0);
        C65352Pkq.LIZ.getClass();
        LJLLI = new InterfaceC74236TBo[]{tbt};
    }

    public InterfaceC164226cU LJJLI() {
        return this;
    }
    ...
    public final I3X getRecordControlApi() {
        return (I3X) this.LJLJJI.LIZ(this, LJLLI[0]);
    }

    @Override // X.InterfaceC164226cU
    ...
    public /* bridge */ /* synthetic */ InterfaceC164226cU getApiComponent() {
        LJJLI();
        return this;
    }
    ...
    public void f2(boolean z) {
        ...
        if (z && !C79057V0z.LJIIZILJ(LJIL, WOD.class)) {
            WOD wod = new WOD(this.LJLL);
            this.LJLJLJ = wod;
            C42663Gol c42663Gol = new C42663Gol();
            c42663Gol.LIZ = true;
            c42663Gol.LIZJ = new C81013Vqr();
            LJIL.LLJJJJ(wod, c42663Gol.LIZ());
            return;
        }
        if (!C79057V0z.LJIIZILJ(LJIL, WOD.class)) {
            return;
        }
        LJIL.onBackPressed();
    }
    ...
    public C164186cQ(WMH parentScene, C82622Wbi diContainer) {
        ...
        this.LJLJJL = (InterfaceC164206cS) getDiContainer().LJ(InterfaceC164206cS.class, null);
        C29901Fi<Integer> c29901Fi = new C29901Fi<>();
        this.LJLJJLL = c29901Fi;
        this.LJLJLLL = c29901Fi;
        this.LJLL = new WOR() { // from class: X.6cR
            @Override // X.WOR
            public final void LIZ() {
                C164186cQ c164186cQ = C164186cQ.this;
                if (c164186cQ.LJLIL.mActivity == null) {
                    return;
                }
                c164186cQ.LJLJJL.s3(false);
                C164186cQ.this.getRecordControlApi().mc(true);
            }
            ...
            public final void LIZIZ() {
                ...
                c164186cQ.getRecordControlApi().mc(false);
                C78928UyK.LIZIZ(true, false, false, C164186cQ.this.LJLJI);
                C164186cQ c164186cQ2 = C164186cQ.this;
                WM7 wm7 = c164186cQ2.LJLJLJ;
                if (wm7 != null && (LJIL = C78897Uxp.LJIL(c164186cQ2.LJLIL)) != null) {
                    LJIL.remove(wm7);
                }
            }
            ...
            public final void LIZJ(long j) {
                ...
                c164186cQ.getRecordControlApi().r10(new C44237HXt(3, C164186cQ.this.LJLJL, 28));
                C164186cQ.this.getRecordControlApi().Sk0(C164186cQ.this.LJLJL);
                InterfaceC164206cS interfaceC164206cS = (InterfaceC164206cS) C164186cQ.this.getDiContainer().LJIIIIZZ(null, InterfaceC164206cS.class);
                if (interfaceC164206cS != null) {
                    interfaceC164206cS.s3(true);
                    interfaceC164206cS.h(1);
                    interfaceC164206cS.LLLLLLLLLL(true);
                    interfaceC164206cS.LLILIL();
                }
                C164186cQ.this.getRecordControlApi().mc(false);
                C164186cQ.this.getRecordControlApi().VE(j);
            }

            @Override // X.WOR
            public final void LIZLLL(boolean z) {
                C164186cQ.this.LJLJI.PY(new V8S(!z, false, false));
            }

            @Override // X.WOR
            public final void LJ(int i) {
                C164186cQ.this.S8(i, true);
            }
        };
    }
    ...
    public void S8(int i, boolean z) {
        this.LJLJL = i;
        if (z) {
            this.LJLJJLL.LJII(Integer.valueOf(i));
        }
    }

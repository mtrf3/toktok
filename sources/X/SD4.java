...
public final class SD4 extends SD2 {
    ...
    public SD4(Context context) {
        ...
        this.LJLJLLL = SDQ.LJLIL;
        this.LJLL = "";
        this.LJLLILLLL = C34399Del.LJLIL;
    ...
    public final void LIZ(ElementDTO elementDTO, PaymentMethod paymentMethod, List<PaymentElement> list, Object obj) {
        ...
        if (str != null) {
            ...
            C16880lQ.LJJJ((TuxIconView) LIZIZ(R.id.e_q), new ACListenerS46S1100000_12(this, str, 5));
        } else {
        ...
        SD9 sd9 = this.LJLJLJ;
        if (sd9 != null) {
            ((TextView) LIZIZ(R.id.eof)).removeTextChangedListener(sd9);
        }
        this.LJLJLJ = new SD9(this, LIZIZ(R.id.eof));
        ((TextView) LIZIZ(R.id.eof)).addTextChangedListener(this.LJLJLJ);
        ((C71731SDf) LIZIZ(R.id.eod)).setOnEditTextFocusChangeListener(new IDCListenerS157S0200000_4(this, elementDTO, 1));
        if (list != null) {
            ...
            c71731SDf4.setText(ORZ.LLD(arrayList, "/", null, null, SDI.LJLIL, 30));
        }

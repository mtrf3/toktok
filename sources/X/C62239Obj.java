...
public final class C62239Obj implements InterfaceC62085OYf {
    public final InterfaceC62225ObV LIZ;

    public C62239Obj(InterfaceC62225ObV channel) {
    ...
    public final boolean LIZ(Context context, View view, AwemeSharePackage sharePackage, InterfaceC62573Oh7 interfaceC62573Oh7, InterfaceC88472Yns<? super Boolean, C76800UCe> interfaceC88472Yns) {
        ...
        if (C62359Odf.LJII(sharePackage.LJIILLIIL(), this.LIZ)) {
            return C62340OdM.LJIILJJIL(context, sharePackage, this.LIZ.key(), new C62238Obi(context, view, this, sharePackage, interfaceC88472Yns));
        }
        return C62340OdM.LJIJJLI(context, sharePackage, this.LIZ.key(), new C62237Obh(context, view, this, sharePackage, interfaceC88472Yns));
    }
}

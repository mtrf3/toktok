...
public final class C161006To extends AbstractC161116Tz<GlobalHashTagStickerModel> {
    ...
    public final void LJFF() {
        setOnClickListener(new ViewOnClickListenerC13880ga(new ACListenerS22S0100000_2(this, 18)));
    }
    ...
    public final void LIZ(C1NS<GlobalHashTagStickerModel> container, LifecycleOwner owner) {
        o.LJIIIZ(container, "container");
        o.LJIIIZ(owner, "owner");
        this.LJLJJL = container;
        this.LJLJJLL = owner;
        LIZLLL();
        getContentEditText().addTextChangedListener(new IDObjectS175S0100000_2(this, 1));
        C1NS<GlobalHashTagStickerModel> c1ns = this.LJLJJL;
        if (c1ns != null) {
            LiveState<V> LIZ = c1ns.LIZ(new TBT() { // from class: X.6Tc
                @Override // X.TBT, X.TBZ, X.TBW
                public final Object get(Object obj) {
                    return Boolean.valueOf(((GlobalHashTagStickerModel) obj).getVisible());
                }
            });
            ...
            LIZ.LJIIIIZZ(lifecycleOwner, Lifecycle.State.STARTED, new AqS168S0100000_2(this, 24));
            C1NS<GlobalHashTagStickerModel> c1ns2 = this.LJLJJL;
            if (c1ns2 != null) {
                LiveState<V> LIZ2 = c1ns2.LIZ(new TBT() { // from class: X.6Td
                    @Override // X.TBT, X.TBZ, X.TBW
                    public final Object get(Object obj) {
                        return Boolean.valueOf(((GlobalHashTagStickerModel) obj).getEditable());
                    }
                });
                ...
                LIZ2.LJIIIIZZ(lifecycleOwner2, Lifecycle.State.STARTED, new AqS168S0100000_2(this, 25));
                C1NS<GlobalHashTagStickerModel> c1ns3 = this.LJLJJL;
                if (c1ns3 != null) {
                    LiveState<V> LIZ3 = c1ns3.LIZ(new TBT() { // from class: X.6Tn
                        @Override // X.TBT, X.TBZ, X.TBW
                        public final Object get(Object obj) {
                            return ((GlobalHashTagStickerModel) obj).getContentText();
                        }
                    });
                    ...
                    LIZ3.LJIIIIZZ(lifecycleOwner3, Lifecycle.State.STARTED, new AqS168S0100000_2(this, 26));
                    C1NS<GlobalHashTagStickerModel> c1ns4 = this.LJLJJL;
                    if (c1ns4 != null) {
                        LiveState<V> LIZ4 = c1ns4.LIZ(new TBT() { // from class: X.6Te
                            @Override // X.TBT, X.TBZ, X.TBW
                            public final Object get(Object obj) {
                                return Boolean.valueOf(((GlobalHashTagStickerModel) obj).getClickable());
                            }
                        });
                        ...
                        LIZ4.LJIIIIZZ(lifecycleOwner4, Lifecycle.State.STARTED, new C161026Tq(this));
                        return;
                    }
    ...
    */
    public C161006To(android.content.Context r3, X.C6UA r4, int r5) {
        /*
            r2 = this;
            r0 = r5 & 8
            r1 = 0
        ...
        L6:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: X.C161006To.<init>(android.content.Context, X.6UA, int):void");
    }
}

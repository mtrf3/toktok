...
/* renamed from: X.Xe8, reason: case insensitive filesystem */
/* loaded from: classes16.dex */
public final class C85320Xe8 implements InterfaceC19530ph {
    public final /* synthetic */ PoiSearchCellV1 LIZ;

    public C85320Xe8(PoiSearchCellV1 poiSearchCellV1) {
        this.LIZ = poiSearchCellV1;
    }
    ...
    public final void LIZ(View view, String itemID) {
        ...
        if (o.LJ(str, ((C85192Xc4) this.LIZ.N().getState()).LJLIL)) {
            PoiSearchCellV1 poiSearchCellV1 = this.LIZ;
            poiSearchCellV1.getClass();
            HashMap hashMap = new HashMap();
            C85316Xe4 item2 = poiSearchCellV1.getItem();
            if (item2 != null && (c85317Xe54 = item2.LJLJJI) != null) {
                str2 = c85317Xe54.LIZJ;
            } else {
                str2 = null;
            }
            PoiMobParam poiMobParam = poiSearchCellV1.N().LJLLILLLL;
            if (poiMobParam != null) {
            ...
            C85316Xe4 item3 = poiSearchCellV1.getItem();
            ...
            C85316Xe4 item4 = poiSearchCellV1.getItem();
            if (item4 == null || (poiData2 = item4.LJLIL) == null || (str6 = poiData2.getPoiId()) == null) {
                str6 = "";
            }
            hashMap.put("poi_id", str6);
            if (poiSearchCellV1.getItem() != null) {
                num = Integer.valueOf(poiSearchCellV1.M());
            } else {
                num = null;
            }
            hashMap.put("index", String.valueOf(num));
            C85316Xe4 item5 = poiSearchCellV1.getItem();
            if (item5 == null || (str7 = item5.LJLJI) == null) {
                str7 = "";
            }
            hashMap.put("log_id", str7);
            C85316Xe4 item6 = poiSearchCellV1.getItem();
            if (item6 != null) {
                poiData = item6.LJLIL;
            } else {
                poiData = null;

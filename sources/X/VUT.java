...
public final class VUT extends C45631qh implements VPU {
    public VUS LLIFFJFJJ;
    public boolean LLII;
    public VUW LLIIII;
    public int LLIIIILZ;
    public int LLIIIJ;
    ...
    public VUT(Context context) {
        ...
        if (this.LLIFFJFJJ == null) {
            VUS vus = new VUS(this, getContext());
            this.LLIFFJFJJ = vus;
            vus.setOrientation(1);
            this.LLIFFJFJJ.setWillNotDraw(true);
            VUW vuw = new VUW(this, getContext());
            this.LLIIII = vuw;
            vuw.setHorizontalScrollBarEnabled(false);
    ...
    public final void LJIJI(MotionEvent motionEvent) {
        ...
        if (this.LLIIL) {
            LJIJJ(2);
            Iterator<VUZ> it = this.LLIILII.iterator();
            while (it.hasNext()) {
                it.next().LJ();
            }
        }
    ...
    public void setOnScrollListener(VUZ vuz) {
        this.LLIILII.add(vuz);
    }
    ...
    public final void onScrollChanged(int i, int i2, int i3, int i4) {
        ...
        if (this.LLIIJLIL && !this.LLIIL) {
            ...
            LJIJJ(this.LLILL);
            Iterator<VUZ> it2 = this.LLIILII.iterator();
            while (it2.hasNext()) {

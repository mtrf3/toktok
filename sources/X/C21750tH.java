...
public final class C21750tH {
    public static final float LIZ = 20;
    public static final float LIZIZ = 10;
    public static final float LIZJ = 4;

    public static final int LIZJ(float f, int i, int i2, int i3, int i4, int i5, long j, InterfaceC09420Yo interfaceC09420Yo, boolean z) {
        float f2;
        float f3 = LIZJ * f;
        float LIZLLL = interfaceC09420Yo.LIZLLL() * f;
        float LIZIZ2 = interfaceC09420Yo.LIZIZ() * f;
        int max = Math.max(i, i5);
        if (z) {
            f2 = i2 + f3 + max + LIZIZ2;
        } else {
            f2 = LIZLLL + max + LIZIZ2;
        }
        return Math.max(O6R.LJJIIZ(f2), Math.max(Math.max(i3, i4), C23360vs.LJIIIIZZ(j)));
    }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:77:0x00f9, code lost:
        ...
        if (r15 == X.C24500xi.LIZIZ) goto L64;
     */
    ...
    */
    public static final void LIZIZ(X.InterfaceC07790Sh r51, X.InterfaceC88471Ynr<? super X.InterfaceC24520xk, ? super java.lang.Integer, X.C76800UCe> r52, X.InterfaceC88471Ynr<? super X.InterfaceC24520xk, ? super java.lang.Integer, X.C76800UCe> r53, X.InterfaceC88473Ynt<? super X.InterfaceC07790Sh, ? super X.InterfaceC24520xk, ? super java.lang.Integer, X.C76800UCe> r54, X.InterfaceC88471Ynr<? super X.InterfaceC24520xk, ? super java.lang.Integer, X.C76800UCe> r55, X.InterfaceC88471Ynr<? super X.InterfaceC24520xk, ? super java.lang.Integer, X.C76800UCe> r56, boolean r57, float r58, X.InterfaceC09420Yo r59, X.InterfaceC24520xk r60, int r61) {
        /*
            Method dump skipped, instructions count: 1300
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: X.C21750tH.LIZIZ(X.0Sh, X.Ynr, X.Ynr, X.Ynt, X.Ynr, X.Ynr, boolean, float, X.0Yo, X.0xk, int):void");
    }
    ...
    public static final void LIZ(String value, InterfaceC88472Yns<? super String, C76800UCe> onValueChange, InterfaceC07790Sh interfaceC07790Sh, boolean z, boolean z2, C08370Un c08370Un, InterfaceC88471Ynr<? super InterfaceC24520xk, ? super Integer, C76800UCe> interfaceC88471Ynr, InterfaceC88471Ynr<? super InterfaceC24520xk, ? super Integer, C76800UCe> interfaceC88471Ynr2, InterfaceC88471Ynr<? super InterfaceC24520xk, ? super Integer, C76800UCe> interfaceC88471Ynr3, InterfaceC88471Ynr<? super InterfaceC24520xk, ? super Integer, C76800UCe> interfaceC88471Ynr4, boolean z3, InterfaceC14810i5 interfaceC14810i5, C18880oe c18880oe, C18850ob c18850ob, boolean z4, int i, C1OH c1oh, InterfaceC11790dD interfaceC11790dD, InterfaceC21550sx interfaceC21550sx, InterfaceC24520xk interfaceC24520xk, int i2, int i3, int i4) {
        ...
        C35931b3 LJIL = interfaceC24520xk.LJIL(-1690895095);
        if ((i4 & 1) != 0) {
            i5 = i2 | 6;
        } else if ((i2 & 14) == 0) {
            if (LJIL.LJIJJ(value)) {
        ...
        if (i38 != 0) {
            ...
            if (LJIL.LJIJJ(interactionSource)) {
                i19 = 1048576;
            } else {
                i19 = 524288;
            }
        ...
        if ((1533916891 & i5) != 306783378 || (191739611 & i15) != 38347922 || !LJIL.LIZ()) {
            LJIL.LJJZZIII();
            if ((i2 & 1) == 0 || LJIL.LJJJLIIL()) {
                ...
                if (i38 != 0) {
                    ...
                    LJIL.LJJJJJ(false);
                    interactionSource = (C1OH) LJJJZ;
                }
                if ((i4 & 131072) != 0) {
                    AbstractC34231Vz abstractC34231Vz = C21350sd.LIZIZ(LJIL).LIZ;
                    C1W0 c1w0 = C17470mN.LIZ;
                    interfaceC11790dD2 = abstractC34231Vz.LIZIZ(abstractC34231Vz.LIZ, abstractC34231Vz.LIZIZ, c1w0, c1w0);
                    i15 &= -29360129;
                }
                interfaceC21550sx2 = interfaceC21550sx4;
                if ((262144 & i4) != 0) {
                    i15 = (-234881025) & i15;
                    interfaceC21550sx2 = C21600t2.LJ(0L, 0L, 0L, 0L, LJIL, 2097151);
                }
            } else {
                LJIL.LIZLLL();
                if ((i4 & 32) != 0) {
            ...
            LJIL.LJJJJJL();
            LJIL.LJJIIJ(-833027444);
            long LIZIZ2 = c08370Un2.LIZIZ();
            if (LIZIZ2 == C11850dJ.LJI) {
                LIZIZ2 = ((C11850dJ) interfaceC21550sx2.LJ(z6, LJIL).getValue()).LIZ;
            }
            LJIL.LJJJJJ(false);
            C08370Un LIZJ2 = c08370Un2.LIZJ(new C08370Un(LIZIZ2, 0L, null, null, null, 0L, null, null, 0L, 262142));
            InterfaceC07790Sh indicatorLine = C78996UzQ.LIZLLL(interfaceC07790Sh2, ((C11850dJ) interfaceC21550sx2.LIZIZ(LJIL).getValue()).LIZ, interfaceC11790dD2);
            float f = C21600t2.LJ;
            float f2 = C21600t2.LIZLLL;
            o.LJIIIZ(indicatorLine, "$this$indicatorLine");
            ...
            C1OH c1oh2 = interactionSource;
            C18530o5.LIZ(value, onValueChange, C09290Yb.LIZLLL(C07770Sf.LIZ(indicatorLine, g1.LIZ, new AnonymousClass259(z6, z7, interactionSource, interfaceC21550sx2, f, f2)), C21600t2.LIZJ, C21600t2.LIZIZ), z9, z10, LIZJ2, c18880oe3, c18850ob3, z11, i40, interfaceC14810i53, null, c1oh2, new C32691Qb(((C11850dJ) interfaceC21550sx2.LJIIIIZZ(z7, LJIL).getValue()).LIZ), C1DJ.LJ(LJIL, -1994363936, new C25U(value, z6, z8, interfaceC14810i52, interactionSource, z7, interfaceC88471Ynr6, interfaceC88471Ynr5, interfaceC88471Ynr7, interfaceC88471Ynr8, interfaceC21550sx2, i5, i15)), LJIL, (i5 & 14) | (i5 & 112) | (i5 & 7168) | (i5 & 57344) | (i39 & 3670016) | (i39 & 29360128) | (i39 & 234881024) | (i39 & 1879048192), ((i15 >> 3) & 14) | 24576 | ((i15 >> 12) & 896), 2048);
        ...
        LJJJJLI.LIZLLL = new C25V(value, onValueChange, interfaceC07790Sh2, z6, z5, c08370Un2, interfaceC88471Ynr6, interfaceC88471Ynr5, interfaceC88471Ynr7, interfaceC88471Ynr8, z7, interfaceC14810i52, c18880oe2, c18850ob2, z8, i24, interactionSource, interfaceC11790dD2, interfaceC21550sx3, i2, i3, i4);
    }
}

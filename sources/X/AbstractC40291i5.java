...
public abstract class AbstractC40291i5<T extends Fragment> extends FragmentStateAdapter {
    public final int LJLL;
    public C0CM LJLLI;
    public C29061Cc LJLLILLLL;
    public final EcAdapterStateViewModel LJLLJ;
    ...
    /* JADX WARN: Type inference failed for: r1v1, types: [X.1Cc, X.0CJ] */
    @Override // androidx.viewpager2.adapter.FragmentStateAdapter, X.AbstractC029409q
    public final void onAttachedToRecyclerView(RecyclerView recyclerView) {
        ...
        if (parent instanceof C0CM) {
            ...
            ?? r1 = new C0CJ(this) { // from class: X.1Cc
                public final /* synthetic */ AbstractC40291i5<T> LJLIL;
                ...
                public final void LIZJ(int i) {
                    ...
                    AbstractC40291i5<T> abstractC40291i5 = this.LJLIL;
                    abstractC40291i5.getClass();
                    int i2 = i - 1;
                    int i3 = i + 1;
                    if (i2 > i3) {
                        return;
                    ...
                    while (true) {
                        if (i2 >= 0 && i2 < abstractC40291i5.LJLL && !abstractC40291i5.LJLZ.containsKey(Integer.valueOf(i2)) && abstractC40291i5.LJLLL.get(i2) == null) {
                            abstractC40291i5.LJLLL.put(i2, abstractC40291i5.LLF(i2));
                        }
                        if (i2 != i3) {
                            i2++;
                        } else {
    ...
    public final void onDetachedFromRecyclerView(RecyclerView recyclerView) {
        ...
        if (c0cm2 != null) {
            C29061Cc c29061Cc = this.LJLLILLLL;
            if (c29061Cc != null) {
                ((ArrayList) c0cm2.LJLJI.LJLIL).remove(c29061Cc);
            } else {
    ...
    public AbstractC40291i5(Fragment fragment, ActivityC45651qj activity, int i) {
        super(fragment);
        o.LJIIIZ(fragment, "fragment");
        o.LJIIIZ(activity, "activity");
        this.LJLL = i;
        this.LJLLJ = (EcAdapterStateViewModel) ViewModelProviders.of(activity).get(EcAdapterStateViewModel.class);

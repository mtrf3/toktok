...
public final class C91487ZvP extends View implements InterfaceC91366ZtS<C91077Zon>, InterfaceC91083Zot {
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C91487ZvP(Context context) {
        super(context);
        new LinkedHashMap();
    }
    ...
    public void setConfig(C91084Zou config) {
        ...
        getLayoutParams().height = config.LJIIL;
    }
}

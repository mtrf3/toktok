...
public final class C46956Ibo implements InterfaceC46972Ic4 {
    ...
    public final void LIZ() {
        ...
        if (IXN.LIZJ.getBitrateSelectMode() == 1) {
            ...
            C46953Ibl c46953Ibl = new C46953Ibl(LIZ2.getAdaptiveGearGroup());
            c46953Ibl.LIZIZ = LIZ2.getGearSet();
            c46953Ibl.LIZJ = LIZ2.getBandwidthSet();
            c46953Ibl.LIZLLL = autoBitrateSet;
            this.LIZ = new C46979IcB(c46953Ibl.LIZ(), autoBitrateSet);
        }
        if (IZ8.LJJII()) {
            try {

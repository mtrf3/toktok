...
public final class C145975o9 extends AbstractC143775kb implements InterfaceC143795kd {
    public I53 LJLIL;
    ...
    public final void onActivityCreated(Bundle bundle) {
        ...
        selectNonNullSubscribe(C0JT.LIZIZ((ActivityC45651qj) activity, CutVideoBottomBarViewModel.class, "of(activity as FragmentA…BarViewModel::class.java)"), new TBT() { // from class: X.I5T
            @Override // X.TBT, X.TBZ, X.TBW
            public final Object get(Object obj) {
                return ((CutVideoBottomBarState) obj).getSelectTime();
            }
        }, new C73165SnZ<>(), new AqS189S0100000_7(this, 25));
    }
    ...
    public final void onViewCreated(View view, Bundle bundle) {
        ...
        this.LJLILLLLZI = (TextView) requireViewById;
    }
    ...
    public final View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        return FP1.LIZ(layoutInflater, "inflater", viewGroup, "container", layoutInflater, R.layout.cee, viewGroup, false, "inflater.inflate(R.layou…om_bar, container, false)");
    }

...
public final class PYT extends HttpsURLConnection {
    public final HttpsURLConnection LIZ;
    ...
    public static Object LIZ(Object obj, Method method, Object[] objArr) {
        C39519Ff9 LIZJ = new C03880Dg(2).LIZJ(110000, "java/lang/reflect/Method", "invoke", method, new Object[]{obj, objArr}, "java.lang.Object", new C65300Pk0(true, "(Ljava/lang/Object;[Ljava/lang/Object;)Ljava/lang/Object;", "-1645260187604048932"));
    ...
    public final boolean LIZIZ() {
        try {
            Reflect field = Reflect.on(this.LIZ).field("delegate", new Class[0]).field("httpEngine", new Class[0]);
    ...
    public final String getCipherSuite() {
        return this.LIZ.getCipherSuite();
    }
    ...
    public final HostnameVerifier getHostnameVerifier() {
        return this.LIZ.getHostnameVerifier();
    }
    ...
    public final Certificate[] getLocalCertificates() {
        return this.LIZ.getLocalCertificates();
    }

    @Override // javax.net.ssl.HttpsURLConnection
    public final Principal getLocalPrincipal() {
        return this.LIZ.getLocalPrincipal();
    }
    ...
    public final Principal getPeerPrincipal() {
        return this.LIZ.getPeerPrincipal();
    }
    ...
    public final SSLSocketFactory getSSLSocketFactory() {
        return this.LIZ.getSSLSocketFactory();
    }

    @Override // javax.net.ssl.HttpsURLConnection
    public final Certificate[] getServerCertificates() {
        return this.LIZ.getServerCertificates();
    }
    ...
    public PYT(HttpsURLConnection httpsURLConnection) {
        super(httpsURLConnection.getURL());
        this.LIZJ = -1;
        this.LJ = PY3.LIZ();
        this.LIZIZ = httpsURLConnection.getClass().getName().contains("Cronet");
        this.LIZ = httpsURLConnection;
    }
    ...
    public final void setHostnameVerifier(HostnameVerifier hostnameVerifier) {
        this.LIZ.setHostnameVerifier(hostnameVerifier);
    }
    ...
    public final void setSSLSocketFactory(SSLSocketFactory sSLSocketFactory) {
        this.LIZ.setSSLSocketFactory(sSLSocketFactory);
    }

...
public final class SPI extends AbstractC65781Prl implements InterfaceC65784Pro<Boolean> {
    public final /* synthetic */ VideoVisibilitySelectFragment LJLIL;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public SPI(VideoVisibilitySelectFragment videoVisibilitySelectFragment) {
        super(0);
    ...
    public final Boolean invoke() {
        ...
        if (arguments != null) {
            z = arguments.getBoolean("is_promote");
        } else {
            z = false;
        }

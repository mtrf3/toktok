...
@InterfaceC65848Psq(c = "com.ss.android.ugc.aweme.ecommerce.base.osp.vm.OrderSubmitViewModel$queryBindInfo$1", f = "OrderSubmitViewModel.kt", l = {4099}, m = "invokeSuspend")
/* renamed from: X.Azn, reason: case insensitive filesystem */
/* loaded from: classes5.dex */
public final class C28059Azn extends AbstractC65782Prm implements InterfaceC88471Ynr<InterfaceC70422pa, InterfaceC67352kd<? super C76800UCe>, Object> {
    public int LJLIL;
    ...
    public C28059Azn(List<BindInfoReqInfo> list, OrderSubmitViewModel orderSubmitViewModel, boolean z, PaymentMethod paymentMethod, InterfaceC88472Yns<? super String, C76800UCe> interfaceC88472Yns, InterfaceC67352kd<? super C28059Azn> interfaceC67352kd) {
    ...
    public final InterfaceC67352kd<C76800UCe> create(Object obj, InterfaceC67352kd<?> interfaceC67352kd) {
        return new C28059Azn(this.LJLILLLLZI, this.LJLJI, this.LJLJJI, this.LJLJJL, this.LJLJJLL, interfaceC67352kd);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        try {
            if (i != 0) {
                ...
                ((PaymentApi) C74672wR.LIZIZ.create(PaymentApi.class)).getBindInfo(bindInfoRequest).LJJL(T16.LIZ()).LIZ(new IDxS305S0100000_4(c84654XKg, 17));
                obj = c84654XKg.LIZ();
            ...
            this.LJLJI.setState(C28062Azq.LJLIL);
        }
        if (response.isCodeOK() && bindInfoResponseData != null) {
            if (this.LJLJJI && (bindInfoList = bindInfoResponseData.getBindInfoList()) != null) {
                ...
                for (BindInfoItem bindInfoItem2 : bindInfoList) {
                    ...
                    if (paymentMethodId != null) {
                        orderSubmitViewModel2.LLLI.put(paymentMethodId, bindInfoItem2);
                    }
                }
            }
            ...
            this.LJLJI.setState(C28061Azp.LJLIL);
            return C76800UCe.LIZ;
        }
        this.LJLJI.setState(C28058Azm.LJLIL);
        return C76800UCe.LIZ;
    }

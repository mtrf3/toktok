...
public final class CLO implements InterfaceC60949Nw1 {
    ...
    public final void LJIILLIIL(SparkPopup popup) {
        ...
        BZI LIZ = C28787BRn.LIZ("scm_live_back");
        C06510Nj.LIZ((C29374Bfu) B83.LIZ().LIZIZ(), LIZ, "object_id");
        LIZ.LJIJJ(C64707PaR.LIZJ, "country_code");
        LIZ.LJJIIJZLJL();
    }

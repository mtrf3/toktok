...
public final class R9L extends R4O {
    public final /* synthetic */ C45R<C69078R9e> LIZ;
    ...
    public final void onSuccess(R40<C69078R9e> response) {
    ...
    public final void onError(R40<C69078R9e> r40, int i) {
        int i2;
        String str;
        C45R<C69078R9e> c45r = this.LIZ;
        if (r40 != null) {
            i2 = r40.LIZLLL;
            str = r40.LJFF;
        } else {
    ...
    public R9L(C73516StE c73516StE, EnumC69116RAq enumC69116RAq, EnumC69113RAn enumC69113RAn) {
        this.LIZ = c73516StE;

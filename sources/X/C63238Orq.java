...
public final class C63238Orq extends AbstractC63515OwJ<List<ParticipantMinIndex>> {
    @Override // X.AbstractC63515OwJ
    public final boolean LJFF() {
        return true;
    }

    public C63238Orq(C63229Orh c63229Orh) {
        super(EnumC63625Oy5.GET_CONVERSATION_PARTICIPANTS_MIN_INDEX_V3.getValue(), c63229Orh);
    }
    ...
    public final boolean LJIIIZ(C63622Oy2 c63622Oy2) {
        ...
        if (c63622Oy2 != null && (response = c63622Oy2.LJLJL) != null && (responseBody = response.body) != null && responseBody.participants_min_index_body != null) {
            return true;
        }
        return false;
    }
    ...
    public final void LJII(C63622Oy2 c63622Oy2, ARunnableS29S0200000_10 aRunnableS29S0200000_10) {
        ...
        if (z) {
            LIZLLL(c63622Oy2.LJLJL.body.participants_min_index_body.indexes);
        } else {
            LIZIZ(c63622Oy2);
        }

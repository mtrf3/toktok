...
public final class C65138PhO {
    ...
    public static void LJIILIIL(Throwable th) {
    ...
    public static Type LJI(Type type, Class<?> cls, Class<?> cls2) {
        if (cls2.isAssignableFrom(cls)) {
            return LJIIL(type, cls, LIZLLL(type, cls, cls2));
        }
        throw new IllegalArgumentException();
    }
    ...
    */
    public static java.lang.reflect.Type LJIIL(java.lang.reflect.Type r7, java.lang.Class<?> r8, java.lang.reflect.Type r9) {
        /*
            Method dump skipped, instructions count: 256
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: X.C65138PhO.LJIIL(java.lang.reflect.Type, java.lang.Class, java.lang.reflect.Type):java.lang.reflect.Type");
    }

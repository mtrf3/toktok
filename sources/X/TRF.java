...
public final class TRF implements U62 {
    public final /* synthetic */ AbstractC74705TTp LJLIL;
    ...
    public TRF(AbstractC74705TTp abstractC74705TTp) {
        this.LJLIL = abstractC74705TTp;
    }
    ...
    public final void LJZL(InterfaceC75441TjB session, List<LinkUser> linkedUsers, List<LinkUser> applicants, List<LinkUser> invitees, List<LinkUser> willJoinGroupUsers, List<LinkUser> liveUsers, List<LinkUser> invitingList, List<LinkUser> applyingList, String str, CustomLinkMessage customLinkMessage) {
        ...
        TRG trg = new TRG(linkedUsers, applicants, invitees);
        C74710TTu c74710TTu = (C74710TTu) this.LJLIL;
        c74710TTu.getClass();
        c74710TTu.LJII().LJII(false);
        c74710TTu.LJIIIIZZ().LIZJ(trg);
        c74710TTu.LJIIJJI(2);
    }
}

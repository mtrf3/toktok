...
public final class DialogInterfaceOnClickListenerC76920UGu implements DialogInterface.OnClickListener {
    public final /* synthetic */ Context LJLIL;
    public final /* synthetic */ android.net.Uri LJLILLLLZI;
    public final /* synthetic */ int LJLJI;
    public final /* synthetic */ UI8 LJLJJI;

    public DialogInterfaceOnClickListenerC76920UGu(Context context, android.net.Uri uri, int i, UI8 ui8) {
        this.LJLIL = context;
        this.LJLILLLLZI = uri;
        this.LJLJI = i;
        this.LJLJJI = ui8;

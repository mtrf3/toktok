...
public final class C76705U8n extends AbstractC76704U8m {
    ...
    public static String LIZJ(int i) {
        if (MultiGuestUseLinkmicAloggerSetting.INSTANCE.isEnable()) {
            ...
            return C77800Ug8.LIZLLL(U44.LAYOUT, LIZ, "_LiveDataProvider_", LJ, LIZ);
        }
        StringBuilder LIZ2 = X1D.LIZ();
        return C17M.LIZ(U44.LAYOUT, LIZ2, "_LiveDataProvider_", i, LIZ2);
    }

    public final C76711U8t LJI(int i) {
        String str;
        String str2;
        String LIZJ = LIZJ(305);
        StringBuilder LIZ = X1D.LIZ();
        LIZ.append("getMicWindow pos=");
        LIZ.append(i);
        C32014ChO.LJFF(LIZJ, X1D.LIZIZ(LIZ));
        Layout layout = this.LIZLLL;
        C32014ChO.LIZ(LIZJ(308), "LiveDataProvider getMicWindow");
        C76711U8t c76711U8t = null;
        if (layout == null) {
            C32014ChO.LIZJ(LIZJ(310), "live currentLayout is null", null);
    ...
    public C76705U8n(Context context, U92 positionManager, U9E mappingHelper) {

...
@InterfaceC65848Psq(c = "com.ss.android.ugc.aweme.poi.detail.reviews.PoiDetailReviewsViewModel$dislike$1", f = "PoiDetailReviewsViewModel.kt", l = {412}, m = "invokeSuspend")
/* renamed from: X.7rL, reason: invalid class name and case insensitive filesystem */
/* loaded from: classes4.dex */
public final class C198917rL extends AbstractC65782Prm implements InterfaceC88471Ynr<InterfaceC70422pa, InterfaceC67352kd<? super C76800UCe>, Object> {
    public int LJLIL;
    public final /* synthetic */ String LJLILLLLZI;
    public final /* synthetic */ String LJLJI;
    public final /* synthetic */ int LJLJJI;
    public final /* synthetic */ PoiReviewsApi.PoiReviewModel LJLJJL;
    public final /* synthetic */ PoiDetailReviewsViewModel LJLJJLL;
    ...
    public C198917rL(int i, int i2, long j, PoiDetailReviewsViewModel poiDetailReviewsViewModel, PoiReviewsApi.PoiReviewModel poiReviewModel, String str, String str2, InterfaceC67352kd interfaceC67352kd, boolean z, boolean z2, boolean z3) {
        super(2, interfaceC67352kd);
        this.LJLILLLLZI = str;
        this.LJLJI = str2;
        this.LJLJJI = i;
        this.LJLJJL = poiReviewModel;
        this.LJLJJLL = poiDetailReviewsViewModel;
        this.LJLJL = i2;
        this.LJLJLJ = z;
        this.LJLJLLL = z2;
        this.LJLL = j;
    ...
    public final InterfaceC67352kd<C76800UCe> create(Object obj, InterfaceC67352kd<?> interfaceC67352kd) {
        ...
        PoiDetailReviewsViewModel poiDetailReviewsViewModel = this.LJLJJLL;
        return new C198917rL(i, this.LJLJL, this.LJLL, poiDetailReviewsViewModel, poiReviewModel, str, str2, interfaceC67352kd, this.LJLJLJ, this.LJLJLLL, this.LJLLI);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i != 0) {
            ...
            final PoiDetailReviewsViewModel poiDetailReviewsViewModel = this.LJLJJLL;
            ...
            InterfaceC64672gJ<XGX<C199087rc>> interfaceC64672gJ = new InterfaceC64672gJ<XGX<C199087rc>>() { // from class: X.7rP
                ...
                public final Object emit(XGX<C199087rc> xgx, InterfaceC67352kd<? super C76800UCe> interfaceC67352kd) {
                    ...
                    if (xgx2 instanceof XGW) {
                        ...
                        if (baseResponse != null && baseResponse.status_code == 0) {
                            PoiDetailReviewsViewModel poiDetailReviewsViewModel2 = poiDetailReviewsViewModel;
                            int i3 = i2;
                            boolean z4 = z3;
                            if (z4) {
                            ...
                            poiDetailReviewsViewModel2.hv0(i3, LIZ2);
                        }
                        ...
                        PoiDetailReviewsViewModel poiDetailReviewsViewModel3 = poiDetailReviewsViewModel;
                        int i4 = i2;
                        if (poiReviewModel.userStatus != null) {
                        ...
                        poiDetailReviewsViewModel3.hv0(i4, PoiReviewsApi.PoiReviewModel.LIZ(poiReviewModel, poiReviewStatisticsModel, poiReviewUserStatusModel, false, false, null, 3999));
                    }

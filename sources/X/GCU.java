...
public final class GCU extends AbstractC65781Prl implements InterfaceC88472Yns<BaseActivityViewModel, C76800UCe> {
    public static final GCU LJLIL = new GCU();
    ...
    public final C76800UCe invoke(BaseActivityViewModel baseActivityViewModel) {
        ...
        activityConfiguration.config(GCV.LJLIL);

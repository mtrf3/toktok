...
public final class C62729Ojd extends AbstractC62728Ojc {
    public C62729Ojd(View view) {
        super(view);
    }
    ...
    public final void L(InterfaceC62733Ojh interfaceC62733Ojh) {
        ...
        SmartImageView ivVideoCoverLeft = (SmartImageView) this.itemView.findViewById(R.id.fcj);
        ...
        if (LIZLLL2 != null && (str = (String) LIZLLL2.LJLJI) != null) {
            ...
            LJIIIIZZ2.LJJIIJ = ivVideoCoverLeft;
            o.LJIIIIZZ(ivVideoCoverLeft, "ivVideoCoverLeft");
            Context context2 = ivVideoCoverLeft.getContext();
            o.LJIIIIZZ(context2, "ivVideoCoverLeft.context");

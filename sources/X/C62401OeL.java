...
public final class C62401OeL implements InterfaceC62474OfW {
    public final /* synthetic */ Challenge LIZ;

    public C62401OeL(Challenge challenge) {
        this.LIZ = challenge;
    }
    ...
    public static void LJII(String str, boolean z, Challenge challenge) {
        if (!z || challenge == null) {
            return;
        }
        C8BR c8br = new C8BR();

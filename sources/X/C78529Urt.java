...
public final class C78529Urt implements InterfaceC78280Uns {
    ...
    public C78529Urt(JSONObject origin) {
    ...
    public final InterfaceC78505UrV get(String name) {
        o.LJIIJ(name, "name");
        return new C78539Us3(this.LIZ.opt(name));
    }
    ...
    public final InterfaceC78502UrS getArray(String name) {
        ...
        return new C78534Ury(optJSONArray);
    }
    ...
    public final InterfaceC78280Uns getMap(String name) {
        ...
        return new C78529Urt(optJSONObject);
    }

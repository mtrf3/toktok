...
public final class UG3 implements UGI {
    ...
    public UG3(EmoteEditDialogFragment emoteEditDialogFragment, Bitmap bitmap, float f, C56K c56k) {
    ...
    public final void LIZ() {
        ...
        if (c76883UFj == null || (enumC76880UFg = c76883UFj.LIZIZ) == null) {
            ...
            i = C76886UFm.LIZ[enumC76880UFg.ordinal()];
        }
        if (i != 1) {
            if (i == 2) {
                ...
                if (bitmap != null && bitmap.getHeight() < this.LIZIZ.getWidth()) {
                    ...
                    if (emoteEditDialogFragment.LJLZ > 0) {
                        C81091Vs7 c81091Vs7 = (C81091Vs7) emoteEditDialogFragment._$_findCachedViewById(R.id.f12);
                        if (c81091Vs7 != null) {
                        ...
                        if (_$_findCachedViewById != null) {
                            _$_findCachedViewById.postDelayed(new ARunnableS32S0200000_13(this.LIZ, this.LIZLLL, 39), 50L);
                        }
                    }
                }
        ...
        if (_$_findCachedViewById2 != null) {
            _$_findCachedViewById2.postDelayed(new ARunnableS49S0100000_13(this.LIZ, 84), 100L);
        }
    }
}

...
public final class C71595S7z implements Parcelable.Creator<SingleTextTemplateItem> {
    @Override // android.os.Parcelable.Creator
    public final SingleTextTemplateItem createFromParcel(Parcel parcel) {
        boolean z;
        boolean z2;
        ...
        return new SingleTextTemplateItem(readString, readInt, arrayList, readString2, readString3, z, readString4, readString5, z2, arrayList2);
    }

    @Override // android.os.Parcelable.Creator
    public final SingleTextTemplateItem[] newArray(int i) {
        return new SingleTextTemplateItem[i];
    }
}

...
public final class C87854Ydu implements InterfaceC31342CRu {
    public Boolean LIZ;
    ...
    public C87854Ydu(DataChannel dataChannel) {
        o.LJIIIZ(dataChannel, "dataChannel");
        this.LIZIZ = new LinkedList();
        C09800a0 c09800a0 = new C09800a0(dataChannel, new AqS171S0100000_5(this, 661));
        ...
        c09800a0.LIZ(new C87848Ydo());
        c09800a0.LIZ(new C87844Ydk());
        this.LIZJ = c09800a0;
    }

...
public final class FDF implements FDH {
    public static final FDF LIZ = new FDF();
    ...
    public final EcomGeckoFrontUpdateModel[] config() {
        ...
        LJIIIZ.getClass();
        EcomGeckoFrontUpdateModel[] ecomGeckoFrontUpdateModelArr2 = (EcomGeckoFrontUpdateModel[]) FFL.LJIJ(true, "ecom_common_gecko_front_update_ext4", 31744, EcomGeckoFrontUpdateModel[].class, ecomGeckoFrontUpdateModelArr);

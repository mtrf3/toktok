...
public final class C30695C2x {
    ...
    public final ARunnableS41S0100000_5 LJIIIZ;
    public final ARunnableS41S0100000_5 LJIIJ;

    public final LinkedList<Runnable> LIZ() {
        return (LinkedList) this.LJIIIIZZ.getValue();
    }
    ...
    public final void LIZIZ(boolean z) {
        String str;
        C48459J0d<Boolean> c48459J0d = InterfaceC30442Bx8.LLLLLILLIL;
        Boolean LIZJ = c48459J0d.LIZJ();
        o.LJIIIIZZ(LIZJ, "LIVE_GAME_EXTENDED_SCREEN_SHOW_GUIDE.value");
        if (LIZJ.booleanValue()) {
            if (LIZ().size() == 0 || z) {
                ...
                c15540jG.LJFF = false;
                c15540jG.LJI = 3;
                c15540jG.LJ = new C30696C2y(c15540jG2, c15540jG, this, c76732zl);
                ...
                c15540jG2.LJI = 3;
                c15540jG2.LJ = new C30(c15540jG, c15540jG2, this, c76732zl);
                ...
                animatorSet.start();
                this.LIZJ.setClickable(true);
                C16880lQ.LJIILJJIL(this.LIZJ, new ACListenerS31S0300000_5(this, animatorSet, c15540jG, 14));
    ...
    public final void LIZJ(boolean z) {
        ...
        if (LIZJ.booleanValue()) {
            if (LIZ().size() == 0 || z) {
                ...
                animatorSet.start();
                this.LIZJ.setClickable(true);
                C16880lQ.LJIILJJIL(this.LIZJ, new ACListenerS31S0300000_5(this, animatorSet, c15540jG, 15));
            }
            if (!LIZ().contains(this.LJIIJ) && !z) {
                LIZ().add(this.LJIIJ);
            }
        }
    }

    public C30695C2x(View view, Room room) {
        this.LIZ = view;
        this.LIZIZ = room;
        ...
        this.LJIIIIZZ = C78996UzQ.LJJIJIIJI(C33.LJLIL);
        this.LJIIIZ = new ARunnableS41S0100000_5(this, 128);
        this.LJIIJ = new ARunnableS41S0100000_5(this, 129);
    }
}

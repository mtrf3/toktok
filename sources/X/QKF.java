...
public class QKF {
    public final java.util.Set<WeakReference<InterfaceC41790Gag>> LIZ = Q4K.LIZLLL();
    ...
    */
    public final synchronized void LIZ(X.QKH r3) {
        /*
            r2 = this;
            monitor-enter(r2)
            java.util.Set<java.lang.ref.WeakReference<X.Gag>> r0 = r2.LIZ     // Catch: java.lang.Throwable -> L26
        ...
        L19:
            ...
            X.Gag r0 = (X.InterfaceC41790Gag) r0     // Catch: java.lang.Throwable -> L26
            if (r0 != r3) goto L7
            r1.remove()     // Catch: java.lang.Throwable -> L26
        L24:
            monitor-exit(r2)
        ...
        L26:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: X.QKF.LIZ(X.QKH):void");
    }
}

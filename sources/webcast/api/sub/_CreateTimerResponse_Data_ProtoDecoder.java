...
public final class _CreateTimerResponse_Data_ProtoDecoder implements InterfaceC31105CIr<CreateTimerResponse.Data> {
    public static CreateTimerResponse.Data LIZIZ(Q9H q9h) {
        CreateTimerResponse.Data data = new CreateTimerResponse.Data();
        long LIZJ = q9h.LIZJ();
        while (true) {
            int LJI = q9h.LJI();
            if (LJI != -1) {
    ...
    public final CreateTimerResponse.Data LIZ(Q9H q9h) {
        return LIZIZ(q9h);
    }
}

...
public class JSONObject {
    ...
    public static final Object NULL = new Object() { // from class: org.eclipse.mat.json.JSONObject.1
    ...
    public Object get(String str) {
        ...
        throw new JSONException(i0.LJFF("No value for ", str));
    }
    ...
    public JSONObject accumulate(String str, Object obj) {
        Map<String, Object> map = this.nameValuePairs;
        checkName(str);

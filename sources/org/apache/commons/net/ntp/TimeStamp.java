...
public class TimeStamp implements Serializable, Comparable<TimeStamp> {
    ...
    public TimeStamp(Date date) {
        ...
        if (date == null) {
            ...
            ntpTime = toNtpTime(date.getTime());
        }
    ...
    public static long decodeNtpHexString(String str) {
        if (str != null) {
            ...
            if (indexOf == -1) {
                ...
                return CastLongProtector.parseLong(str, 16) << 32;
            }
            return (CastLongProtector.parseLong(str.substring(0, indexOf), 16) << 32) | CastLongProtector.parseLong(str.substring(indexOf + 1), 16);
        }

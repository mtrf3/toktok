...
public class GeneratedTexture {
    ...
    /* renamed from: com.byted.cast.capture.surface.gles.GeneratedTexture$1, reason: invalid class name */
    /* loaded from: classes29.dex */
    public static /* synthetic */ class AnonymousClass1 {
        public static final /* synthetic */ int[] $SwitchMap$com$byted$cast$capture$surface$gles$GeneratedTexture$Image;

        static {
            int[] iArr = new int[Image.values().length];
            $SwitchMap$com$byted$cast$capture$surface$gles$GeneratedTexture$Image = iArr;
            try {
                iArr[Image.COARSE.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                $SwitchMap$com$byted$cast$capture$surface$gles$GeneratedTexture$Image[Image.FINE.ordinal()] = 2;
    ...
    public static int createTestTexture(Image image) {
        ...
        int i = AnonymousClass1.$SwitchMap$com$byted$cast$capture$surface$gles$GeneratedTexture$Image[image.ordinal()];
        if (i != 1) {
            if (i == 2) {

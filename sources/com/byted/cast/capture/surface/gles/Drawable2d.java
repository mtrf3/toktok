...
public class Drawable2d {
    ...
    /* renamed from: com.byted.cast.capture.surface.gles.Drawable2d$1, reason: invalid class name */
    /* loaded from: classes29.dex */
    public static /* synthetic */ class AnonymousClass1 {
        public static final /* synthetic */ int[] $SwitchMap$com$byted$cast$capture$surface$gles$Drawable2d$Prefab;

        static {
            int[] iArr = new int[Prefab.values().length];
            $SwitchMap$com$byted$cast$capture$surface$gles$Drawable2d$Prefab = iArr;
            try {
                iArr[Prefab.TRIANGLE.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                $SwitchMap$com$byted$cast$capture$surface$gles$Drawable2d$Prefab[Prefab.RECTANGLE.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                $SwitchMap$com$byted$cast$capture$surface$gles$Drawable2d$Prefab[Prefab.FULL_RECTANGLE.ordinal()] = 3;
    ...
    public Drawable2d(Prefab prefab) {
        int i = AnonymousClass1.$SwitchMap$com$byted$cast$capture$surface$gles$Drawable2d$Prefab[prefab.ordinal()];
        if (i != 1) {
            if (i != 2) {
                if (i == 3) {

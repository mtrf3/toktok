...
public class golomb {
    ...
    */
    public com.byted.cast.sdk.render.video.SPS ParseH264(byte[] r14) {
        /*
            Method dump skipped, instructions count: 457
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.byted.cast.sdk.render.video.golomb.ParseH264(byte[]):com.byted.cast.sdk.render.video.SPS");
    }
    ...
    */
    ...
    public SPS ParseSequenceParameterSet(byte[] bArr, int i) {
        ...
        if (GetUE > 3) {
            ...
            LIZ.append(GetUE);
            castLogger.e("golomb", X1D.LIZIZ(LIZ));
            return sps;
        }
        if (GetUE2 == 3) {
            nALBitstream.GetWord(1);
        ...
        castLogger2.i("golomb", X1D.LIZIZ(LIZ2));

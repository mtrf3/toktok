...
public class AVMDLHTTPNetwork extends AVMDLNetClient {
    ...
    public static void com_ss_mediakit_net_AVMDLHTTPNetwork_okhttp3_Call_enqueue(InterfaceC48133Iun interfaceC48133Iun, PX8 px8) {
        if (new C03880Dg(2).LIZJ(400103, "okhttp3/Call", "enqueue", interfaceC48133Iun, new Object[]{px8}, "void", new C65300Pk0(false, "(Lokhttp3/Callback;)V", "8904246276395730516")).LIZ) {
            return;
        }
        interfaceC48133Iun.LLIZLLLIL(px8);
    }

    public static C64600PWy com_ss_mediakit_net_AVMDLHTTPNetwork_okhttp3_OkHttpClient$Builder_build(C64601PWz c64601PWz) {
        C39519Ff9 LIZJ = new C03880Dg(2).LIZJ(400100, "okhttp3/OkHttpClient$Builder", "build", c64601PWz, new Object[0], "okhttp3.OkHttpClient", new C65300Pk0(false, "()Lokhttp3/OkHttpClient;", "8904246276395730516"));
    ...
    public void startTask(String str, Map<String, String> map, final AVMDLNetClient.CompletionListener completionListener) {
        synchronized (AVMDLHTTPNetwork.class) {
            if (mClient == null) {
                ...
                mClient = com_ss_mediakit_net_AVMDLHTTPNetwork_okhttp3_OkHttpClient$Builder_build(c64601PWz);
            }
        }
        ...
        this.mCall = LIZJ;
        com_ss_mediakit_net_AVMDLHTTPNetwork_okhttp3_Call_enqueue(LIZJ, new PX8() { // from class: com.ss.mediakit.net.AVMDLHTTPNetwork.1
            @Override // X.PX8
    ...
    public void startTask(String str, Map<String, String> map, JSONObject jSONObject, int i, final AVMDLNetClient.CompletionListener completionListener) {
        ...
        C64587PWl LIZJ = C64587PWl.LIZJ(c64600PWy, LIZIZ, false);
        this.mCall = LIZJ;
        com_ss_mediakit_net_AVMDLHTTPNetwork_okhttp3_Call_enqueue(LIZJ, new PX8() { // from class: com.ss.mediakit.net.AVMDLHTTPNetwork.2
            @Override // X.PX8
            public void onFailure(InterfaceC48133Iun interfaceC48133Iun, IOException iOException) {
                completionListener.onCompletion(null, new Error(0, null, null, iOException.toString()));
            }

...
import X.InterfaceC46305IFh;
import X.InterfaceC82549WaX;
...
public final class AVVideoViewComponentFactoryImplKt {
    public static final InterfaceC82549WaX toIAVMediaError(final IPG ipg) {
        return new InterfaceC82549WaX() { // from class: com.ss.android.ugc.aweme.services.mvtemplate.AVVideoViewComponentFactoryImplKt$toIAVMediaError$1
            @Override // X.InterfaceC82549WaX
            public int getErrorCode() {
                return IPG.this.LJ;
            }

            public int getErrorExtra() {
                return IPG.this.LJFF;
            }
            ...
            public boolean isDash() {
                return IPG.this.LIZLLL;
            }
        };
    }

    public static final InterfaceC46305IFh toIAVPlayerFirstFrameEvent(final IT4 it4) {
        return new InterfaceC46305IFh() { // from class: com.ss.android.ugc.aweme.services.mvtemplate.AVVideoViewComponentFactoryImplKt$toIAVPlayerFirstFrameEvent$1
            public String getId() {
                return IT4.this.getId();
            }
        };
    }

    public static final OnUIPlayListener toOnUIPlayListener(final InterfaceC46304IFg interfaceC46304IFg) {
        return new OnUIPlayListener() { // from class: com.ss.android.ugc.aweme.services.mvtemplate.AVVideoViewComponentFactoryImplKt$toOnUIPlayListener$1
            ...
            @Override // com.ss.android.ugc.aweme.player.sdk.api.OnUIPlayListener
            public void onRetryOnError(IPG ipg) {
            }
            ...
            @Override // com.ss.android.ugc.aweme.player.sdk.api.OnUIPlayListener
            public void onPlayFailed(IPG ipg) {
                InterfaceC82549WaX interfaceC82549WaX;
                InterfaceC46304IFg interfaceC46304IFg2 = InterfaceC46304IFg.this;
                if (ipg != null) {
                    interfaceC82549WaX = AVVideoViewComponentFactoryImplKt.toIAVMediaError(ipg);
                } else {
                    interfaceC82549WaX = null;
                }
                interfaceC46304IFg2.LJJLIIIJJIZ(interfaceC82549WaX);
            }

            @Override // com.ss.android.ugc.aweme.player.sdk.api.OnUIPlayListener
            public void onRenderFirstFrame(IT4 it4) {
                InterfaceC46305IFh interfaceC46305IFh;
                InterfaceC46304IFg interfaceC46304IFg2 = InterfaceC46304IFg.this;
                if (it4 != null) {
                    interfaceC46305IFh = AVVideoViewComponentFactoryImplKt.toIAVPlayerFirstFrameEvent(it4);
                } else {
                    interfaceC46305IFh = null;
                }
                interfaceC46304IFg2.LJJIFFI(interfaceC46305IFh);
            }

            @Override // com.ss.android.ugc.aweme.player.sdk.api.OnUIPlayListener
            public void onResumePlay(String str) {
                InterfaceC46304IFg.this.onResumePlay(str);
            }
        };
    }
}

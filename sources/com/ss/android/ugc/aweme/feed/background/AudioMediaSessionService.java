...
public class AudioMediaSessionService extends MediaBrowserServiceCompat {
    ...
    public final C62822Ol8 LJLJL = C221108m2.LIZIZ(XOT.INSTANCE);
    ...
    public final int onStartCommand(Intent intent, int i, int i2) {
        ...
        if (Build.VERSION.SDK_INT >= 26) {
            ...
            if (YBK.LIZ().tryToFixServiceBug && (activityManager = (ActivityManager) this.LJLJL.getValue()) != null) {
                C39519Ff9 LIZJ = new C03880Dg(2).LIZJ(101302, "android/app/ActivityManager", "getRunningServices", activityManager, new Object[]{Integer.MAX_VALUE}, "java.util.List", new C65300Pk0(false, "(I)Ljava/util/List;", "8458187487693855012"));
                if (LIZJ.LIZ) {
                ...
                if (runningServices != null) {
                    ...
                    while (it.hasNext() && !o.LJ(it.next().service.getClassName(), getClass().getName())) {
                    }
                }
            }
        }

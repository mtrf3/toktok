...
public final class FriendsTabEducateButtonTrigger extends BaseCellTriggerComponent<FriendsTabEducateButtonTrigger> implements PriorityProtocol {
    ...
    public final InterfaceC65350Pko<? extends ReusedUISlotAssem<? extends C3C8>> e4() {
        return C65352Pkq.LIZ(FriendsTabEducateButtonAssem.class);
    }

    @Override // com.ss.android.ugc.feed.platform.container.protocol.priority.PriorityProtocol
    public final String y2() {
        return "bottom_button_friends_tab_educate";
    }

    public FriendsTabEducateButtonTrigger() {
        new LinkedHashMap();
        this.LLF = C221108m2.LIZIZ(new AqS153S0100000_3(this, 334));
    }
    ...
    public final void F0(VideoItemParams item) {
        ...
        if (k4 && (priorityAbility = (PriorityAbility) this.LLF.getValue()) != null) {
            priorityAbility.Es(this, null, C8RS.LJLIL);
        }
    }
    ...
    public final boolean k4(VideoItemParams item) {
        o.LJIIIZ(item, "item");
        return C226068u2.LJ(item.getAweme(), EnumC61832bj.BOTTOM_BUTTON);
    }
}

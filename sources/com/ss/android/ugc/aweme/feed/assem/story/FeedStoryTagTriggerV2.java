...
public final class FeedStoryTagTriggerV2 extends BaseCellTriggerComponent<FeedStoryTagTriggerV2> implements ComponentPriorityProtocol {
    ...
    public final InterfaceC65350Pko<? extends ReusedUISlotAssem<? extends C3C8>> e4() {
        return C65352Pkq.LIZ(FeedStoryTagAssemV2.class);
    }
    ...
    public FeedStoryTagTriggerV2() {
        new LinkedHashMap();
        this.LLF = C221108m2.LIZIZ(new AqS153S0100000_3(this, 376));
    }

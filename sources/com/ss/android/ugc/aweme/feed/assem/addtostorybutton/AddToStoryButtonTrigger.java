...
public final class AddToStoryButtonTrigger extends BaseCellTriggerComponent<AddToStoryButtonTrigger> implements PriorityProtocol {
    ...
    public final InterfaceC65350Pko<? extends ReusedUISlotAssem<? extends C3C8>> e4() {
        return C65352Pkq.LIZ(AddToStoryButtonAssem.class);
    }

    @Override // com.ss.android.ugc.feed.platform.container.protocol.priority.PriorityProtocol
    public final String y2() {
        return "bottom_button_share_to_story";
    }

    public AddToStoryButtonTrigger() {
        new LinkedHashMap();
        this.LLF = C221108m2.LIZIZ(new AqS153S0100000_3(this, 283));
    }
    ...
    public final void F0(VideoItemParams item) {
        ...
        if (k4(item) && (priorityAbility = (PriorityAbility) this.LLF.getValue()) != null) {
            priorityAbility.Es(this, null, new AqS169S0100000_3(this, 182));
        }
    }
    ...
    public final boolean k4(VideoItemParams item) {
        ...
        return C54838Lfe.LJJIJIIJI(item.getAweme(), str);
    }
}

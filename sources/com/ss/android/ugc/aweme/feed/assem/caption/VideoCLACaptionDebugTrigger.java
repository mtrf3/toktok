...
public final class VideoCLACaptionDebugTrigger extends BaseCellTriggerComponent<VideoCLACaptionDebugTrigger> {
    ...
    public final void F0(VideoItemParams item) {
        ...
        if (k4(item) && (interactAreaAttachAbility = (InteractAreaAttachAbility) C55096Ljo.LIZ(C55096Ljo.LJIIZILJ(this), InteractBizTopAreaAttachAbility.class, null)) != null) {
            interactAreaAttachAbility.Sn(this, new AqS153S0100000_3(this, 298));
        }
    ...
    public final boolean k4(VideoItemParams item) {
        o.LJIIIZ(item, "item");
        if ((C53326KwM.LIZ() && !AV1.LJIJ(item.getAweme().getAuthor())) || !C8LG.LIZ() || item.baseFeedPageParams == null) {
            return false;
        }

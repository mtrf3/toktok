...
public final class AntiAddictionToastAssemTrigger extends BaseCellTriggerComponent<AntiAddictionToastAssemTrigger> implements BottomBarPriorityProtocol {
    ...
    public final InterfaceC65350Pko<? extends ReusedUISlotAssem<? extends C3C8>> e4() {
        return C65352Pkq.LIZ(AntiAddictionToastAssem.class);
    }

    @Override // com.ss.android.ugc.feed.platform.container.protocol.priority.PriorityProtocol
    public final String y2() {
        return "bottom_banner_anti_addiction";
    }

    public AntiAddictionToastAssemTrigger() {
        new LinkedHashMap();
        this.LLF = C221108m2.LIZIZ(new AqS153S0100000_3(this, 280));
    }
    ...
    public final void F0(VideoItemParams item) {
        ...
        if (k4(item) && (priorityAbility = (PriorityAbility) this.LLF.getValue()) != null) {
            priorityAbility.Es(this, null, new AqS169S0100000_3(this, 181));
        }
    }
    ...
    public final boolean k4(VideoItemParams item) {
        Boolean LIZ;
        o.LJIIIZ(item, "item");
        C8PD c8pd = VideoAntiAddictionVM.LJLLI;
        VideoItemParams videoItemParams = (VideoItemParams) C51029K0z.LJIILLIIL(this);
        c8pd.getClass();
        if (!C8PD.LIZ(videoItemParams) || (LIZ = a.LIZLLL().LIZ()) == null || !LIZ.booleanValue()) {
            return false;
        }
        return true;
    }

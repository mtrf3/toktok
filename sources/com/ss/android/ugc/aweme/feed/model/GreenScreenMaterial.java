...
public final class GreenScreenMaterial extends F9E implements Parcelable, Serializable {
    ...
    public static final String[] MEDIA_TYPE_STRING = {"all", "photo", "video"};
    ...
    */
    public GreenScreenMaterial() {
        /*
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.ss.android.ugc.aweme.feed.model.GreenScreenMaterial.<init>():void");
    }

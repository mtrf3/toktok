...
public final class SecondLevelMusicFragment extends AmeBaseFragment implements Observer<C207668Da> {
    ...
    public final void wl() {
        ...
        if (c73305Spp != null) {
            ...
            if (c73305Spp2 != null) {
                ...
                C73312Spw.LJIIJJI(c73306Spq, new AqS165S0100000_15(this, 468));
    ...
    */
    public final void onChanged(X.C207668Da r23) {
        /*
    ...
    public final void onViewCreated(View view, Bundle bundle) {
        ...
        if (vw3 != null) {
            ...
            this.LJLJJI = new C84990XXe(childFragmentManager, this.LJLJL, this.LJLLILLLL, this.LJLJLJ);
                ...
                if (c80675VlP2 != null) {
                    ...
                    if (LJJLI != null) {
                        if (LJJLI.isAvailable()) {
                            C84939XVf c84939XVf = this.LJLLI;
                            if (c84939XVf != null) {
                                String str = this.LJLJJL;
                                int i = this.LJLJLLL;
                                ChooseMusicApi.LIZ.secondLevelMusicList(str, 0, 30, i).LJ(new AgS87S0101000_15(i, c84939XVf, 4), C10K.LJIIIIZZ, null);
                                return;
                            }
                            return;
                        }
    ...
    public final View onCreateView(LayoutInflater inflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        View LLLLIILL = C16880lQ.LLLLIILL(inflater, R.layout.bg7, viewGroup, false);
        ...
        C78840Uwu.LJJIZ(c235119Kp, str, new AqS165S0100000_15(this, 469));
        ...
        if (c73305Spp != null) {
            ...
            if (c73305Spp2 != null) {
                ...
                this.LJLLI = new C84939XVf(getContext(), this.LJLL);
                try {

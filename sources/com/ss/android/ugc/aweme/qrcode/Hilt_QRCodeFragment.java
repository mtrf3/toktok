...
public abstract class Hilt_QRCodeFragment extends BaseFragment implements YU5<Object> {
    ...
    public final void onAttach(Activity activity) {
        ...
        if (this.LJLIL == null) {
            ...
            ((InterfaceC87467YUl) generatedComponent()).LJIILL((QRCodeFragment) this);
        }
    }

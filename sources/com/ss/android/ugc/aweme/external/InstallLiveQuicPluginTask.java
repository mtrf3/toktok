...
public final class InstallLiveQuicPluginTask implements EE1 {
    @Override // X.EEY
    ...
    public final void run(Context context) {
        ...
        if (LIZLLL.checkPluginInstalled("com.ss.android.ugc.i18n.quic")) {
            H7B.LIZ("Bytevc1enc8Plugin -> com.ss.android.ugc.i18n.quic installed");
            return;
        }
        H7B.LIZ("Bytevc1enc8Plugin -> start install com.ss.android.ugc.i18n.quic");
        C37132Ehk c37132Ehk = new C37132Ehk();
        c37132Ehk.LIZIZ = true;
        c37132Ehk.LIZ = "com.ss.android.ugc.i18n.quic";
        F5Q f5q = new F5Q();
        f5q.LIZIZ = false;
        f5q.LIZJ = false;
        f5q.LIZLLL = false;
        ...
        c37132Ehk.LIZLLL = new C37252Ejg(LIZLLL);

...
public class JacocoTask implements EE1, InterfaceC36076EDw {
    ...
    public final void run(Context context) {
        if (FCD.LJI(context) && !((LocalTestApi) ServiceManager.get().getService(LocalTestApi.class)).isEnablePreciseTest(context)) {

...
public final class ImageChooseUploadActivity extends ActivityC86117Xqz {
    public static OX9 LJLLLL;
    ...
    public String LJLLI = "";
    public final AqS192S0100000_10 LJLLILLLL = new AqS192S0100000_10(this, 14);
    public final AqS176S0100000_10 LJLLJ = new AqS176S0100000_10(this, 50);

    public static void LLFII(DialogC25756A8y dialogC25756A8y) {
        if (new C03880Dg(2).LIZJ(300000, "com/bytedance/tux/status/loading/TuxLoadingDialogHUD", "show", dialogC25756A8y, new Object[0], "void", new C65300Pk0(false, "()V", "-5584802948945416071")).LIZ) {
            return;
        }
    ...
    public final void onCreate(Bundle bundle) {
        ...
        if (textView != null) {
            C16880lQ.LJIJI(textView, new ACListenerS30S0100000_10(this, 46));
        }
        TextView textView2 = this.LJLJJI;
        if (textView2 != null) {
            C16880lQ.LJIJI(textView2, new ACListenerS30S0100000_10(this, 47));
        }
        ...
        if (getIntent() != null && getIntent().hasExtra("enter_from") && !TextUtils.isEmpty(C16880lQ.LLJJIJIIJIL(getIntent(), "enter_from"))) {
        ...
        if (dialogC25756A8y2 != null) {
            LLFII(dialogC25756A8y2);
        }
        C10K.LIZJ(new ACallableS113S0100000_10(this, 12)).LJ(new AgS127S0100000_10(this, 10), C10K.LJIIIIZZ, null);

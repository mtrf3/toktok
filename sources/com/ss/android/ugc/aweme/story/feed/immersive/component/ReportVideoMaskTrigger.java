...
public final class ReportVideoMaskTrigger extends BaseCellTriggerComponent<ReportVideoMaskTrigger> {
    @Override // com.ss.android.ugc.feed.platform.cell.BaseCellTriggerComponent
    public final InterfaceC65350Pko<? extends ReusedUISlotAssem<? extends C3C8>> e4() {
        return C65352Pkq.LIZ(ReportVideoMaskAssem.class);
    }

    public ReportVideoMaskTrigger() {
        new LinkedHashMap();
    }
    ...
    public final boolean k4(VideoItemParams item) {
        o.LJIIIZ(item, "item");
        return C220858ld.LJIIJJI(item.getAweme());
    }
}

...
public final class StoryCollectionCellConfig extends DefaultCellConfig {
    ...
    public final boolean LJIILL(C8O4 cellCtx) {
        ...
        if (!C59542Vi.LIZ() && o.LJ("cell_story", cellCtx.LIZ())) {
            return true;
        }
        return false;
    }
    ...
    public final void LIZ(BaseCellContentComponent<? extends C3C8> baseCellContentComponent, C8O4 cellCtx) {
        ...
        o.LJIIIZ(cellCtx, "cellCtx");
        C8VV.LIZLLL(baseCellContentComponent, new AqS169S0100000_3((BaseCellContentComponent) baseCellContentComponent, (BaseCellContentComponent<? extends C3C8>) 445));
    }
}

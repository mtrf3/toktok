...
public final class StoryGuideCardPhotoCellConfig implements StoryCellConfigurationProtocol {
    ...
    public final boolean LJIILL(C8O4 cellCtx) {
        ...
        return o.LJ(cellCtx.LIZ(), "cell_story_guide_card_photo");
    }
    ...
    public final void LJJLIIIJ(BaseCellContentComponent<? extends C3C8> component, C8O4 cellCtx) {
        ...
        C8VR.LIZ(component, new AqS169S0100000_3((BaseCellContentComponent) component, (BaseCellContentComponent<? extends C3C8>) 446));
    }
}

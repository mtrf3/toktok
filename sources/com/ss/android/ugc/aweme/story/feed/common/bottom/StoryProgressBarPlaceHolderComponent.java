...
public final class StoryProgressBarPlaceHolderComponent extends BaseCellPlaceHolderComponent implements ComponentPriorityProtocol {
    ...
    public StoryProgressBarPlaceHolderComponent() {
        super("story_progress_bar");
        new LinkedHashMap();
        this.LLD = C221108m2.LIZIZ(new AqS153S0100000_3(this, 870));
    }

...
public abstract class Hilt_ProfileEditFragment extends AbsFragment implements YU5<Object> {
    ...
    public final void onAttach(Activity activity) {
        ...
        if (this.LJLIL == null) {
            ...
            ((InterfaceC87461YUf) generatedComponent()).LJI((ProfileEditFragment) this);
        }
    }

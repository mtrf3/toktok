...
public final class EmoteEditDialogFragment extends LiveDialogFragment implements UGH {
    ...
    public float LJZL;
    public long LL;
    public DialogC31813Ce9 LLD;
    public boolean LLF;
    public TextStickerData LLFF;
    public YKR LLFFF;
    ...
    public final UG7 LLFZ = new UG7(this);
    ...
    public final C28507BGt createParams() {
        C28507BGt c28507BGt = new C28507BGt(R.layout.br_);
    ...
    public final void onDestroy() {
        ...
        int i = C76897UFx.LIZIZ[this.LJLJL.ordinal()];
        if (i != 1) {
            if (i != 2) {
                if (i != 3) {
        ...
        if (this.LJLJL != EnumC76899UFz.DONE && (textStickerData = this.LLFF) != null && (ykr = this.LLFFF) != null) {
            ykr.LJFF(textStickerData);
        }
        BZI LIZ = C28787BRn.LIZ("livesdk_sub_emote_edit_page_leave");
        LIZ.LJIJJ(Long.valueOf(SystemClock.elapsedRealtime() - this.LL), "duration");
    ...
    public final void Gl(Bitmap bitmap) {
        ...
        if (ugw != null) {
            ugw.setIntercepter(new UG6(this));
        }
        ...
        if (relativeLayout != null) {
            C16880lQ.LJIJ(relativeLayout, new ACListenerS2S0200001_13(this, f, c56k, 0));
        }
        ...
        if (c81091Vs7 != null) {
            c81091Vs7.setFirstReadyListener(new UG3(this, bitmap, f, c56k));
        }
    }

    public final void Hl(YKR ykr) {
        int i;
    ...
    public final void keyBoardHide(int i) {
        ...
        if (V1M.LJJIJIIJI(textWrapList)) {
            ...
            if (safeHandler != null) {
                vl(new YKR(mo49getActivity, safeHandler, textStickerData, z2, new UGF(this)));
                return;
            } else {
                o.LJIJI("safeHandler");
                throw null;
    ...
    public final void vl(YKR ykr) {
        ...
        if (editTextStickerViewModel != null) {
            ...
            this.LJLLILLLL = ykr;
            ykr.setOnEditClickListener(new UGB(this));
            ykr.setMotionInterceptor(new UGC(this, ykr));
            ykr.LJIILIIL(0, 0);
            ykr.setInitOffsetY(-this.LJZL);
            EditTextStickerViewModel editTextStickerViewModel2 = this.LJLLJ;
            if (editTextStickerViewModel2 != null) {
                ...
                if (_$_findCachedViewById != null) {
                    _$_findCachedViewById.post(new ARunnableS32S0200000_13(this, ykr, 36));
                    return;
                }
                return;
            }
    ...
    public final void onViewCreated(View view, Bundle bundle) {
        ...
        if (mo49getActivity != null) {
            JediViewModel LIZ3 = C165616ej.LIZIZ(this).LIZ(EditTextStickerViewModel.class);
            o.LJIIIIZZ(LIZ3, "JediViewModelProviders.o…kerViewModel::class.java]");
            this.LJLLJ = (EditTextStickerViewModel) LIZ3;
        ...
        if (getContext() != null) {
            ...
            int LIZLLL = C81184Vtc.LIZLLL(getContext());
            this.LJZI = LIZLLL;
            this.LJZL = (LIZLLL / 2.0f) - ((this.LJLZ / 2.0f) + this.LJLLLLLL);
            ...
            C76883UFj c76883UFj2 = this.LJLIL;
            if (c76883UFj2 != null && c76883UFj2.LIZLLL == 2) {
            ...
            ugs.LJLJJL = 0;
            ugs.LJLJJLL = 1.0f;
            ugs.LJLLL = this.LJLLLLLL;
            ugs.LJLJJI = this.LJLLLL;
            ugs.LJLLJ = B9K.LIZ(ugs.getContext(), 8.0f);
            ugs.postDelayed(new ARunnableS49S0100000_13(this, 13), 5000L);
            ugs.addOnLayoutChangeListener(new IDCListenerS259S0100000_13(this, 0));
            ((C81091Vs7) _$_findCachedViewById(R.id.f12)).setEnableDoubleTap(false);
            C16880lQ.LJJII((LiveIconView) _$_findCachedViewById(R.id.auv), new ACListenerS33S0100000_13(this, 7));
            C16880lQ.LJJIII((C2A7) _$_findCachedViewById(R.id.avw), new ACListenerS33S0100000_13(this, 8));
            C76883UFj c76883UFj3 = this.LJLIL;
            if (c76883UFj3 != null && c76883UFj3.LJI) {
                z = true;
            } else {
                z = false;
            }
            ...
            C16880lQ.LJJII((LiveIconView) _$_findCachedViewById(R.id.avs), new ACListenerS33S0100000_13(this, 9));
            ((C6IQ) _$_findCachedViewById(R.id.l5b)).setTextStickerUpdateListener(new UG1(this));
            C16880lQ.LJIJ((RelativeLayout) _$_findCachedViewById(R.id.j5y), new ACListenerS33S0100000_13(this, 11));
        ...
        C76883UFj c76883UFj4 = this.LJLIL;
        if (c76883UFj4 != null && (ug0 = c76883UFj4.LIZJ) != null) {
            int i = C76897UFx.LIZ[ug0.ordinal()];
            if (i != 1) {
                if (i != 2) {
                    if (i != 3) {
                        if (i == 4) {
                            C76883UFj c76883UFj5 = this.LJLIL;
                            if (c76883UFj5 == null || (c76881UFh = c76883UFj5.LJIIJ) == null) {
                                return;
                            }
                            Gl(c76881UFh.LIZJ);
                            ...
                            YKR ykr = (YKR) obj;
                            this.LLFFF = ykr;
                            this.LLFF = ykr.LIZIZ().m138clone();
                            vl(ykr);
                            return;
                        }
                    } else {
                        C76883UFj c76883UFj6 = this.LJLIL;
                        if (c76883UFj6 == null || (str = c76883UFj6.LJIIIZ) == null) {
                            return;
                        }
                        W5F LJIIIIZZ = W5U.LJIIIIZZ(str);
                        LJIIIIZZ.getClass();
                        LJIIIIZZ.LIZJ = mo49getActivity();
                        LJIIIIZZ.LJIIIZ(new IDdS504S0100000_13(this, 1));
                        return;
                    }
                } else {
                    C76883UFj c76883UFj7 = this.LJLIL;
                    if (c76883UFj7 == null || (uri = c76883UFj7.LJIIIIZZ) == null) {
                        return;
                    }
                    W5F LJFF = W5U.LJFF(uri);
                    LJFF.LIZJ = mo49getActivity();
                    LJFF.LJIIIZ(new IDdS504S0100000_13(this, 0));
                    return;
                }
            } else {
        ...
        C76883UFj c76883UFj9 = this.LJLIL;
        if (c76883UFj9 != null) {
            bitmap = c76883UFj9.LJII;
        }
        Gl(bitmap);
    }

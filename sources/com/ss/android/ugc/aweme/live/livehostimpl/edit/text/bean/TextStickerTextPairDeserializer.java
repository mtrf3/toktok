        ...
        try {
            ...
            if (LJJIJ == null && (LJJIJ = LJIIZILJ.LJJIJ("first")) == null) {
                ...
                if (LJJIJ2 == null && (LJJIJ2 = LJIIZILJ.LJJIJ("second")) == null) {
                    ...
                    Object LJII = C09650Zl.LIZIZ.LJII(jVar2, new C79477VHd().getType());
                    o.LJIIIIZZ(LJII, "get().fromJson<List<Inte…                        )");
                    ...
                    Object LJII2 = C09650Zl.LIZIZ.LJII(jVar3, new C79478VHe().getType());
                    o.LJIIIIZZ(LJII2, "get().fromJson<List<Inte…                        )");

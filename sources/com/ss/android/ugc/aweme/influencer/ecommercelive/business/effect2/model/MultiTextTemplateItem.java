...
public final class MultiTextTemplateItem implements TemplateItem, Parcelable {
    ...
    public static final C71577S7h Companion = new C71577S7h();
    public static final Parcelable.Creator<MultiTextTemplateItem> CREATOR = new C71593S7x();
    ...
    public final boolean equals(Object obj) {
        ...
        if (this.type == multiTextTemplateItem.type && o.LJ(this.templateId, multiTextTemplateItem.templateId) && o.LJ(this.bgImgUrl, multiTextTemplateItem.bgImgUrl) && o.LJ(this.templateImgUrl, multiTextTemplateItem.templateImgUrl) && o.LJ(this.keyMessage, multiTextTemplateItem.keyMessage) && o.LJ(this.introduction, multiTextTemplateItem.introduction) && o.LJ(this.fieldList, multiTextTemplateItem.fieldList) && this.isUsing == multiTextTemplateItem.isUsing && this.isChanged == multiTextTemplateItem.isChanged && o.LJ(this.templateDecorationList, multiTextTemplateItem.templateDecorationList)) {
            return true;
        }
        return false;
    }
    ...
    public static MultiTextTemplateItem LIZ(MultiTextTemplateItem multiTextTemplateItem, List list, boolean z, int i) {
        int i2;
        String templateId;
        String bgImgUrl;
        ...
        List fieldList = list;
        if ((i & 1) != 0) {
            i2 = multiTextTemplateItem.type;
        } else {
            i2 = 0;
        }
        List<TemplateDecoration> list2 = null;
        if ((i & 2) != 0) {
            templateId = multiTextTemplateItem.templateId;
        } else {
            templateId = null;
        }
        if ((i & 4) != 0) {
            bgImgUrl = multiTextTemplateItem.bgImgUrl;
        } else {
            bgImgUrl = null;
        }
        if ((i & 8) != 0) {
            templateImgUrl = multiTextTemplateItem.templateImgUrl;
        } else {
            templateImgUrl = null;
        }
        if ((i & 16) != 0) {
            keyMessage = multiTextTemplateItem.keyMessage;
        } else {
            keyMessage = null;
        }
        if ((i & 32) != 0) {
            introduction = multiTextTemplateItem.introduction;
        } else {
            introduction = null;
        }
        if ((i & 64) != 0) {
            fieldList = multiTextTemplateItem.fieldList;
        }
        if ((i & 128) != 0) {
            z3 = multiTextTemplateItem.isUsing;
        }
        if ((i & 256) != 0) {
        ...
        if ((i & 512) != 0) {
            list2 = multiTextTemplateItem.templateDecorationList;
        }
        multiTextTemplateItem.getClass();
        ...
        return new MultiTextTemplateItem(templateId, i2, fieldList, bgImgUrl, templateImgUrl, z3, keyMessage, introduction, z2, list2);
    }
    ...
    */
    public MultiTextTemplateItem(java.lang.String r13, java.lang.String r14, java.lang.String r15, java.lang.String r16, java.lang.String r17, java.util.List r18, boolean r19, boolean r20, java.util.List r21, int r22) {
        /*
            r12 = this;
            r1 = r22
            r11 = r21
    ...
    public MultiTextTemplateItem(String templateId, int i, List fieldList, String bgImgUrl, String templateImgUrl, boolean z, String keyMessage, String introduction, boolean z2, List list) {
        o.LJIIIZ(templateId, "templateId");
        o.LJIIIZ(bgImgUrl, "bgImgUrl");
        o.LJIIIZ(templateImgUrl, "templateImgUrl");
        o.LJIIIZ(keyMessage, "keyMessage");

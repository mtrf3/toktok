...
public final class ProductTemplateItem implements TemplateItem, Parcelable {
    ...
    public static final C71578S7i Companion = new C71578S7i();
    public static final Parcelable.Creator<ProductTemplateItem> CREATOR = new C71594S7y();
    ...
    public final boolean equals(Object obj) {
        ...
        if (this.type == productTemplateItem.type && o.LJ(this.templateId, productTemplateItem.templateId) && o.LJ(this.bgImgUrl, productTemplateItem.bgImgUrl) && o.LJ(this.templateImgUrl, productTemplateItem.templateImgUrl) && o.LJ(this.keyMessage, productTemplateItem.keyMessage) && o.LJ(this.introduction, productTemplateItem.introduction) && o.LJ(this.fieldList, productTemplateItem.fieldList) && this.isUsing == productTemplateItem.isUsing && this.isChanged == productTemplateItem.isChanged && o.LJ(this.templateDecorationList, productTemplateItem.templateDecorationList)) {
            return true;
        }
        return false;
    }
    ...
    public static ProductTemplateItem LIZ(ProductTemplateItem productTemplateItem, List list, boolean z, int i) {
        ...
        List fieldList = list;
        if ((i & 1) != 0) {
            i2 = productTemplateItem.type;
        } else {
            i2 = 0;
        }
        List<TemplateDecoration> list2 = null;
        if ((i & 2) != 0) {
            templateId = productTemplateItem.templateId;
        } else {
            templateId = null;
        }
        if ((i & 4) != 0) {
            bgImgUrl = productTemplateItem.bgImgUrl;
        } else {
            bgImgUrl = null;
        }
        if ((i & 8) != 0) {
            templateImgUrl = productTemplateItem.templateImgUrl;
        } else {
            templateImgUrl = null;
        }
        if ((i & 16) != 0) {
            keyMessage = productTemplateItem.keyMessage;
        } else {
            keyMessage = null;
        }
        if ((i & 32) != 0) {
            introduction = productTemplateItem.introduction;
        } else {
            introduction = null;
        }
        if ((i & 64) != 0) {
        ...
        if ((i & 128) != 0) {
            z3 = productTemplateItem.isUsing;
        }
        if ((i & 256) != 0) {
            z2 = productTemplateItem.isChanged;
        } else {
            z2 = false;
        }
        if ((i & 512) != 0) {
            list2 = productTemplateItem.templateDecorationList;
        }
        ...
        return new ProductTemplateItem(templateId, i2, fieldList, bgImgUrl, templateImgUrl, z3, keyMessage, introduction, z2, list2);
    }

...
public final class DiscountTemplateItem implements TemplateItem, Parcelable {
    ...
    public static final C71576S7g Companion = new C71576S7g();
    public static final Parcelable.Creator<DiscountTemplateItem> CREATOR = new C71592S7w();

    public DiscountTemplateItem() {
    ...
    public final String toString() {
        ...
        LIZ.append("DiscountTemplateItem(type=");
    ...
    public final boolean equals(Object obj) {
        ...
        if (!(obj instanceof DiscountTemplateItem)) {
            return false;
        }
        DiscountTemplateItem discountTemplateItem = (DiscountTemplateItem) obj;
        if (this.type == discountTemplateItem.type && o.LJ(this.templateId, discountTemplateItem.templateId) && o.LJ(this.bgImgUrl, discountTemplateItem.bgImgUrl) && o.LJ(this.templateImgUrl, discountTemplateItem.templateImgUrl) && o.LJ(this.keyMessage, discountTemplateItem.keyMessage) && o.LJ(this.introduction, discountTemplateItem.introduction) && o.LJ(this.fieldList, discountTemplateItem.fieldList) && this.isUsing == discountTemplateItem.isUsing && this.isChanged == discountTemplateItem.isChanged && o.LJ(this.templateDecorationList, discountTemplateItem.templateDecorationList)) {
            return true;
        }
        return false;
    }
    ...
    public static DiscountTemplateItem LIZ(DiscountTemplateItem discountTemplateItem, List list, boolean z, int i) {
        int i2;
        String templateId;
        String bgImgUrl;
        ...
        List fieldList = list;
        if ((i & 1) != 0) {
            i2 = discountTemplateItem.type;
        } else {
            i2 = 0;
        }
        List<TemplateDecoration> list2 = null;
        if ((i & 2) != 0) {
            templateId = discountTemplateItem.templateId;
        } else {
            templateId = null;
        }
        if ((i & 4) != 0) {
            bgImgUrl = discountTemplateItem.bgImgUrl;
        } else {
            bgImgUrl = null;
        }
        if ((i & 8) != 0) {
            templateImgUrl = discountTemplateItem.templateImgUrl;
        } else {
            templateImgUrl = null;
        }
        if ((i & 16) != 0) {
            keyMessage = discountTemplateItem.keyMessage;
        } else {
            keyMessage = null;
        }
        if ((i & 32) != 0) {
            introduction = discountTemplateItem.introduction;
        } else {
            introduction = null;
        }
        if ((i & 64) != 0) {
            fieldList = discountTemplateItem.fieldList;
        }
        if ((i & 128) != 0) {
            z3 = discountTemplateItem.isUsing;
        }
        if ((i & 256) != 0) {
            z2 = discountTemplateItem.isChanged;
        } else {
            z2 = false;
        }
        if ((i & 512) != 0) {
            list2 = discountTemplateItem.templateDecorationList;
        }
        discountTemplateItem.getClass();
        ...
        return new DiscountTemplateItem(templateId, i2, fieldList, bgImgUrl, templateImgUrl, z3, keyMessage, introduction, z2, list2);
    }
    ...
    */
    public DiscountTemplateItem(java.lang.String r13, java.lang.String r14, java.lang.String r15, java.lang.String r16, java.lang.String r17, java.util.List r18, boolean r19, boolean r20, java.util.List r21, int r22) {
        /*
            r12 = this;
            r1 = r22
            r11 = r21
        ...
        L4b:
            ...
            goto L14
        */
        throw new UnsupportedOperationException("Method not decompiled: com.ss.android.ugc.aweme.influencer.ecommercelive.business.effect2.model.DiscountTemplateItem.<init>(java.lang.String, java.lang.String, java.lang.String, java.lang.String, java.lang.String, java.util.List, boolean, boolean, java.util.List, int):void");
    }

    public DiscountTemplateItem(String templateId, int i, List fieldList, String bgImgUrl, String templateImgUrl, boolean z, String keyMessage, String introduction, boolean z2, List list) {
        o.LJIIIZ(templateId, "templateId");
        o.LJIIIZ(bgImgUrl, "bgImgUrl");
        o.LJIIIZ(templateImgUrl, "templateImgUrl");
        o.LJIIIZ(keyMessage, "keyMessage");

...
public final class SizeChartTemplateItem implements TemplateItem, Parcelable {
    ...
    public static final C71580S7k Companion = new C71580S7k();
    public static final Parcelable.Creator<SizeChartTemplateItem> CREATOR = new S80();

    public SizeChartTemplateItem() {
    ...
    public final String toString() {
        ...
        LIZ.append("SizeChartTemplateItem(type=");
    ...
    public final boolean equals(Object obj) {
        ...
        if (!(obj instanceof SizeChartTemplateItem)) {
            return false;
        }
        SizeChartTemplateItem sizeChartTemplateItem = (SizeChartTemplateItem) obj;
        if (this.type == sizeChartTemplateItem.type && o.LJ(this.templateId, sizeChartTemplateItem.templateId) && o.LJ(this.bgImgUrl, sizeChartTemplateItem.bgImgUrl) && o.LJ(this.templateImgUrl, sizeChartTemplateItem.templateImgUrl) && o.LJ(this.keyMessage, sizeChartTemplateItem.keyMessage) && o.LJ(this.introduction, sizeChartTemplateItem.introduction) && o.LJ(this.fieldList, sizeChartTemplateItem.fieldList) && this.isUsing == sizeChartTemplateItem.isUsing && this.isChanged == sizeChartTemplateItem.isChanged && o.LJ(this.templateDecorationList, sizeChartTemplateItem.templateDecorationList)) {
            return true;
        }
        return false;
    }
    ...
    public static SizeChartTemplateItem LIZ(SizeChartTemplateItem sizeChartTemplateItem, List list, boolean z, int i) {
        int i2;
        String templateId;
        String bgImgUrl;
        ...
        List fieldList = list;
        if ((i & 1) != 0) {
            i2 = sizeChartTemplateItem.type;
        } else {
            i2 = 0;
        }
        List<TemplateDecoration> list2 = null;
        if ((i & 2) != 0) {
            templateId = sizeChartTemplateItem.templateId;
        } else {
            templateId = null;
        }
        if ((i & 4) != 0) {
            bgImgUrl = sizeChartTemplateItem.bgImgUrl;
        } else {
            bgImgUrl = null;
        }
        if ((i & 8) != 0) {
            templateImgUrl = sizeChartTemplateItem.templateImgUrl;
        } else {
            templateImgUrl = null;
        }
        if ((i & 16) != 0) {
            keyMessage = sizeChartTemplateItem.keyMessage;
        } else {
            keyMessage = null;
        }
        if ((i & 32) != 0) {
            introduction = sizeChartTemplateItem.introduction;
        } else {
            introduction = null;
        }
        if ((i & 64) != 0) {
            fieldList = sizeChartTemplateItem.fieldList;
        }
        if ((i & 128) != 0) {
            z3 = sizeChartTemplateItem.isUsing;
        }
        if ((i & 256) != 0) {
            z2 = sizeChartTemplateItem.isChanged;
        } else {
            z2 = false;
        }
        if ((i & 512) != 0) {
            list2 = sizeChartTemplateItem.templateDecorationList;
        }
        ...
        return new SizeChartTemplateItem(templateId, i2, fieldList, bgImgUrl, templateImgUrl, z3, keyMessage, introduction, z2, list2);
    }
    ...
    */
    public SizeChartTemplateItem(java.lang.String r13, java.lang.String r14, java.lang.String r15, java.lang.String r16, java.lang.String r17, java.util.List r18, boolean r19, boolean r20, java.util.List r21, int r22) {
        /*
            r12 = this;
            r1 = r22
            r11 = r21
        ...
        L4b:
            ...
            goto L14
        */
        throw new UnsupportedOperationException("Method not decompiled: com.ss.android.ugc.aweme.influencer.ecommercelive.business.effect2.model.SizeChartTemplateItem.<init>(java.lang.String, java.lang.String, java.lang.String, java.lang.String, java.lang.String, java.util.List, boolean, boolean, java.util.List, int):void");
    }

    public SizeChartTemplateItem(String templateId, int i, List fieldList, String bgImgUrl, String templateImgUrl, boolean z, String keyMessage, String introduction, boolean z2, List list) {
        o.LJIIIZ(templateId, "templateId");
        o.LJIIIZ(bgImgUrl, "bgImgUrl");
        o.LJIIIZ(templateImgUrl, "templateImgUrl");
        o.LJIIIZ(keyMessage, "keyMessage");

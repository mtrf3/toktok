...
public final class PolicyNotice implements Serializable {
    ...
    public boolean equals(Object obj) {
        ...
        return o.LJ(this.business, policyNotice.business) && o.LJ(this.policyVersion, policyNotice.policyVersion) && o.LJ(this.style, policyNotice.style) && o.LJ(this.title, policyNotice.title) && o.LJ(this.body, policyNotice.body) && o.LJ(this.actions, policyNotice.actions) && o.LJ(this.icon_url, policyNotice.icon_url) && o.LJ(this.policyLinkList, policyNotice.policyLinkList) && o.LJ(this.isSubPopUp, policyNotice.isSubPopUp) && o.LJ(this.firstButtonHighlight, policyNotice.firstButtonHighlight) && this.upperRightClose == policyNotice.upperRightClose;
    }

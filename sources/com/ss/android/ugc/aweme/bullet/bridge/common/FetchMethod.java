...
public final class FetchMethod extends BaseBridgeMethod {
    ...
    public FetchMethod(F3T contextProviderFactory) {
        super(contextProviderFactory);
        o.LJIIIZ(contextProviderFactory, "contextProviderFactory");
        this.LJLIL = "fetch";
        this.LJLILLLLZI = EnumC38014Evy.PROTECT;
        this.LJLJI = new F1C(this);
    }
    ...
    public final void handle(JSONObject params, InterfaceC37146Ehy iReturn) {
        ...
        try {
            C38294F1e.LIZ(getWebJsMsg(params), params.optJSONObject("res"), getJsBridge(), new F1I(iReturn), this.LJLJI).execute();

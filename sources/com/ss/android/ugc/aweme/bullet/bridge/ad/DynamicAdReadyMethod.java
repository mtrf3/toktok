...
public final class DynamicAdReadyMethod extends BaseBridgeMethod {
    ...
    public DynamicAdReadyMethod(F3T contextProviderFactory) {
        super(contextProviderFactory);
        o.LJIIIZ(contextProviderFactory, "contextProviderFactory");
        this.LJLIL = "onDCReady";
    }
    ...
    public final void handle(JSONObject params, InterfaceC37146Ehy iReturn) {
        ...
        long optLong = params.optLong("duration");
        ...
        C2U8.LIZ(new C40494Fus(hashCode, optLong));

...
public final class RequestMethod extends BaseBridgeMethod {
    ...
    public RequestMethod(F3T contextProviderFactory) {
        super(contextProviderFactory);
        o.LJIIIZ(contextProviderFactory, "contextProviderFactory");
        this.LJLIL = "request";
        this.LJLILLLLZI = EnumC38014Evy.PROTECT;
        this.LJLJI = new F1D(this);
    }
    ...
    public final void handle(JSONObject params, InterfaceC37146Ehy iReturn) {
        ...
        try {
            C38294F1e.LIZ(getWebJsMsg(params), params.optJSONObject("res"), null, new F1H(iReturn), this.LJLJI).execute();

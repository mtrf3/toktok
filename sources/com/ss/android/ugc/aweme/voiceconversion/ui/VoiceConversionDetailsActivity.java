...
public final class VoiceConversionDetailsActivity extends ActivityC86117Xqz implements C34X, InterfaceC27853AwT {
    public long LJLIL;
    ...
    public final void onDestroy() {
        ...
        c188727au.LJI("anchor_id", C16880lQ.LLJJIJIIJIL(getIntent(), "anchor_id"));
        ...
        c188727au.LJI("enter_from", C16880lQ.LLJJIJIIJIL(getIntent(), "enter_from"));
        c188727au.LJI("author_id", C16880lQ.LLJJIJIIJIL(getIntent(), "author_id"));
        c188727au.LJI("group_id", C16880lQ.LLJJIJIIJIL(getIntent(), "group_id"));
    ...
    public final void onCreate(Bundle bundle) {
        ...
        c1b3.LJIIJ(voiceConversionDetailsFragment, "voice_conversion_detail_fragment_tag", R.id.bs8);
        c1b3.LJIILJJIL();

...
public final class InboxChangeTabInterceptor implements ChangeTabProtocol {
    public final void LIZ(ActivityC45651qj activityC45651qj, Intent intent) {
        Bundle bundle;
        C54072LKa.LIZLLL = true;
        C221018lt.LJFF("InboxChangeTabInterceptor", "onChangeTab perform intercept");
        ...
        Hox.LJLLI.LIZ(activityC45651qj).Cv0(bundle, "NOTIFICATION");
    }
    ...
    public final boolean m0(ActivityC45651qj activityC45651qj, Intent intent, String str, EnumC54052LJg scene) {
        ...
        if (!o.LJ(str, "NOTIFICATION") || C53765L8f.LJIIL("NOTIFICATION")) {
            return false;
        }
        ...
        LIZ.append(' ');
        C221018lt.LJFF("InboxChangeTabInterceptor", X1D.LIZIZ(LIZ));
        if (C16880lQ.LLJJIJIL(activityC45651qj.getLifecycle().getCurrentState(), Lifecycle.State.CREATED) <= 0) {
            C221018lt.LJFF("InboxChangeTabInterceptor", "onChangeTab perform intercept delay when resumed");
            Hox.LJLLI.LIZ(activityC45651qj).Cv0(new Bundle(), "HOME");
            ScrollSwitchStateManager LIZ2 = C84193Sd.LIZ(activityC45651qj);
            if (!LIZ2.pv0()) {
                LIZ2.LJLLLL.observe(activityC45651qj, new AObserverS38S0400000_9(this, activityC45651qj, intent, LIZ2, 0));
                return true;
            }

...
public class FastImport4kHighRes60FpsInBenchmarkStrategy$$Imp implements FastImport4kHighRes60FpsInBenchmarkStrategy {
        ...
        try {
            synchronized (this) {
                if (this.mStickyStrategy.contains("high_res_high50_60_benchmark_enable")) {
                    ...
                    LIZ = C05090Hx.LIZJ.LIZ(this.mRepoName, "high_res_high50_60_benchmark_enable", false);
    ...
    @Override // com.ss.android.ugc.aweme.property.FastImport4kHighRes60FpsInBenchmarkStrategy, X.InterfaceC09230Xv

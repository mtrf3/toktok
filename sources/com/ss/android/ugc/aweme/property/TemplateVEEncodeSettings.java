...
public final class TemplateVEEncodeSettings extends F9E {
    ...
    public TemplateVEEncodeSettings() {
    ...
    public TemplateVEEncodeSettings(String veSynthesisSettings, String highQualityVeSynthesisSettings) {
    ...
    public /* synthetic */ TemplateVEEncodeSettings(String str, String str2, int i, DefaultConstructorMarker defaultConstructorMarker) {

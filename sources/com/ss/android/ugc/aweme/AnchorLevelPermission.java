...
public class AnchorLevelPermission {
    ...
    @InterfaceC65349Pkn("gift_setting")
    public int giftSetting;

    @InterfaceC65349Pkn("live_center")
    public int liveCenter;

    @InterfaceC65349Pkn("live_goal")
    public int liveGoal;

    @InterfaceC65349Pkn("live_intro")
    public int liveIntro;

    @InterfaceC65349Pkn("moderator_setting")
    ...
    @InterfaceC65349Pkn("sub_setting")
    public int subSetting;

    @InterfaceC65349Pkn("subscription")
    public int subscription;

    @InterfaceC65349Pkn("topic")
    public int topic;

    @InterfaceC65349Pkn("voice_effect")

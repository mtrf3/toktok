...
public final class CWebViewInterceptor {
    ...
    public static final C62822Ol8 LIZJ = C221108m2.LIZIZ(C40707FyJ.LJLIL);
    ...
    public static String LIZ(CookieManager cookieManager, String str) {
        C39519Ff9 LIZJ2 = new C03880Dg(2).LIZJ(103100, "android/webkit/CookieManager", "getCookie", cookieManager, new Object[]{str}, "java.lang.String", new C65300Pk0(false, "(Ljava/lang/String;)Ljava/lang/String;", "-3895814813115658676"));
    ...
    public static final void LIZLLL(C59222NMc c59222NMc) {
        String str;
        String str2;
        LIZIZ = LIZ;
        ...
        C58655N0h LJ = C58704N2e.LJ("landing_ad", "adx_ad_load_success", str, str2, null);
        LJ.LIZIZ(LIZ, "web_url");
        LJ.LJI();
    }

    public static WebResourceResponse LIZJ(WebResourceRequest request, C59222NMc c59222NMc) {
        C76800UCe c76800UCe;
        ...
        try {
            ...
            if (LIZ2 != null && C78685UuP.LJJJZ(LIZ2)) {

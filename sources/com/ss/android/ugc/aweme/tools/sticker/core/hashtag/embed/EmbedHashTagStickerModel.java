...
public final class EmbedHashTagStickerModel extends F9E implements StickerModel, Parcelable, Serializable {
    public static final Parcelable.Creator<EmbedHashTagStickerModel> CREATOR = new Parcelable.Creator<EmbedHashTagStickerModel>() { // from class: X.6TW
        @Override // android.os.Parcelable.Creator
        public final EmbedHashTagStickerModel createFromParcel(Parcel parcel) {
            boolean z;
            boolean z2;
            boolean z3;
            ...
            return new EmbedHashTagStickerModel(createFromParcel, readLong, readString, z, z2, z3);
        }

        @Override // android.os.Parcelable.Creator
        public final EmbedHashTagStickerModel[] newArray(int i) {
            return new EmbedHashTagStickerModel[i];
        }
    };

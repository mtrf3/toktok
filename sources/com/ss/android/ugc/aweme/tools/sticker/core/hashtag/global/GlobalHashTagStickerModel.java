package com.ss.android.ugc.aweme.tools.sticker.core.hashtag.global;
...
public final class GlobalHashTagStickerModel extends F9E implements StickerModel, Parcelable, Serializable {
    public static final Parcelable.Creator<GlobalHashTagStickerModel> CREATOR = new Parcelable.Creator<GlobalHashTagStickerModel>() { // from class: X.6TX
        @Override // android.os.Parcelable.Creator
        public final GlobalHashTagStickerModel createFromParcel(Parcel parcel) {
            boolean z;
            boolean z2;
            boolean z3;
            ...
            return new GlobalHashTagStickerModel(createFromParcel, readLong, readString, z, z2, z3);
        }

        @Override // android.os.Parcelable.Creator
        public final GlobalHashTagStickerModel[] newArray(int i) {
            return new GlobalHashTagStickerModel[i];
        }
    };
    ...
    public GlobalHashTagStickerModel() {
        this(null, 0L, null, false, false, false, 63, null);
    }

    public static /* synthetic */ GlobalHashTagStickerModel copy$default(GlobalHashTagStickerModel globalHashTagStickerModel, BaseStickerModel baseStickerModel, long j, String str, boolean z, boolean z2, boolean z3, int i, Object obj) {
        if ((i & 1) != 0) {
            baseStickerModel = globalHashTagStickerModel.baseStickerModel;
        }
        if ((i & 2) != 0) {
            j = globalHashTagStickerModel.hashtagId;
        }
        if ((i & 4) != 0) {
            str = globalHashTagStickerModel.contentText;
        }
        if ((i & 8) != 0) {
            z = globalHashTagStickerModel.editable;
        }
        if ((i & 16) != 0) {
            z2 = globalHashTagStickerModel.clickable;
        }
        if ((i & 32) != 0) {
            z3 = globalHashTagStickerModel.visible;
        }
        return globalHashTagStickerModel.copy(baseStickerModel, j, str, z, z2, z3);
    }

    public final GlobalHashTagStickerModel copy(BaseStickerModel baseStickerModel, long j, String contentText, boolean z, boolean z2, boolean z3) {
        o.LJIIIZ(baseStickerModel, "baseStickerModel");
        o.LJIIIZ(contentText, "contentText");
        return new GlobalHashTagStickerModel(baseStickerModel, j, contentText, z, z2, z3);
    }
    ...
    public GlobalHashTagStickerModel(BaseStickerModel baseStickerModel, long j, String contentText, boolean z, boolean z2, boolean z3) {
        o.LJIIIZ(baseStickerModel, "baseStickerModel");
        o.LJIIIZ(contentText, "contentText");
    ...
    public /* synthetic */ GlobalHashTagStickerModel(BaseStickerModel baseStickerModel, long j, String str, boolean z, boolean z2, boolean z3, int i, DefaultConstructorMarker defaultConstructorMarker) {

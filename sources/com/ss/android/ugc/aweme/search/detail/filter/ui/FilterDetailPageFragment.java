...
public final class FilterDetailPageFragment extends DetailPageFragment implements KPL {
    public final Map<Integer, View> LJLL = new LinkedHashMap();
    public final C62822Ol8 LJLJLLL = C221108m2.LIZIZ(new AqS158S0100000_8(this, 151));
    ...
    public final DetailPageComponent Gl() {
        return new FilterDetailComponent();
    }

    @Override // com.ss.android.ugc.aweme.detail.ui.DetailPageFragment
    public final DetailFragmentPanel Hl() {
        return new FilterDetailFragmentPanel(this.LJLJJI);
    }

    public final InterfaceC51657KPd Sl() {
        return (InterfaceC51657KPd) this.LJLJLLL.getValue();
    }

    @Override // com.ss.android.ugc.aweme.detail.ui.DetailPageFragment, com.ss.android.ugc.aweme.base.ui.CommonPageFragment
    public final boolean vl() {
        InterfaceC51657KPd Sl = Sl();
    ...
    public final void onViewCreated(View view, Bundle bundle) {
        ...
        InterfaceC51657KPd Sl2 = Sl();
        if (Sl2 != null) {
            Sl2.LIZJ(Ol().getOperator());
        }
    }
    ...
    public final View onCreateView(LayoutInflater inflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        InterfaceC51657KPd Sl = Sl();
        if (Sl != null && (LJFF = Sl.LJFF(inflater, onCreateView)) != null) {
            onCreateView = LJFF;
        }
        C29S c29s = null;

...
public abstract class Hilt_WishListFragment extends AmeBaseFragment implements YU5<Object> {
    ...
    public final void onAttach(Activity activity) {
        ...
        if (this.LJLIL == null) {
            ...
            ((InterfaceC87460YUe) generatedComponent()).LJIIIZ((WishListFragment) this);
        }
    }

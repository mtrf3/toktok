...
public abstract class Hilt_AdsPreviewFragment extends Fragment implements YU5<Object> {
    ...
    public final void onAttach(Activity activity) {
        ...
        if (this.LJLIL == null) {
            ...
            ((InterfaceC87459YUd) generatedComponent()).LJIIJ((AdsPreviewFragment) this);
        }
    }

...
public final class FeedTextModeVideoTagTrigger extends BaseCellTriggerComponent<FeedTextModeVideoTagTrigger> implements VideoTagCategoryProtocol {
    ...
    public final InterfaceC65350Pko<? extends ReusedUISlotAssem<? extends C3C8>> e4() {
        return C65352Pkq.LIZ(FeedTextModeVideoTagAssem.class);
    }
    ...
    public FeedTextModeVideoTagTrigger() {
        new LinkedHashMap();
        this.LLF = C221108m2.LIZIZ(new AqS153S0100000_3(this, 1032));
    }
    ...
    public final void F0(VideoItemParams item) {
        ...
        if (k4(item) && (priorityAbility = (PriorityAbility) this.LLF.getValue()) != null) {
            priorityAbility.Es(this, null, new AqS169S0100000_3(this, 474));
        }
    }
    ...
    public final boolean k4(VideoItemParams item) {
        o.LJIIIZ(item, "item");
        return C211128Qi.LIZIZ.LIZJ(item.getAweme());
    }
}

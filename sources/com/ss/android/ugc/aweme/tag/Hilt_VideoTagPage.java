...
public abstract class Hilt_VideoTagPage extends BaseFragment implements YU5<Object> {
    ...
    public final void onAttach(Activity activity) {
        ...
        if (this.LJLIL == null) {
            ...
            ((InterfaceC87473YUr) generatedComponent()).LIZIZ();
        }
    }

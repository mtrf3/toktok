...
public abstract class Hilt_GifChoosePanelBottomSheet extends BaseFragment implements YU5<Object> {
    ...
    public final void onAttach(Activity activity) {
        ...
        if (this.LJLIL == null) {
            ...
            ((InterfaceC87470YUo) generatedComponent()).LJIILJJIL();
        }
    }

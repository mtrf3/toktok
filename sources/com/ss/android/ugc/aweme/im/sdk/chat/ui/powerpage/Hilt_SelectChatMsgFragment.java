...
public abstract class Hilt_SelectChatMsgFragment extends BaseChatRoomFragment implements YU5<Object> {
    ...
    public final void onAttach(Activity activity) {
        ...
        if (this.LJLIL == null) {
            ...
            ((InterfaceC87469YUn) generatedComponent()).LIZ();
        }
    }

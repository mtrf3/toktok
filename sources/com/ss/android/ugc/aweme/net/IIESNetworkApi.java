...
public interface IIESNetworkApi {
    @InterfaceC36317ENd
    InterfaceC37276Ek4<String> doDetete(@ENW int i, @InterfaceC195747mE String str, @InterfaceC36228EJs Map<String, String> map, @InterfaceC195767mG List<EJ6> list, @InterfaceC195737mD Object obj);
    ...
    @InterfaceC36318ENe
    @InterfaceC195757mF
    InterfaceC37276Ek4<String> doPut(@ENW int i, @InterfaceC195747mE String str, @InterfaceC36228EJs Map<String, String> map, @InterfaceC36229EJt(encode = true) Map<String, String> map2, @InterfaceC195767mG List<EJ6> list, @InterfaceC195737mD Object obj);
    ...
    @ENX
    @E8L
    InterfaceC37276Ek4<TypedInput> downloadFile(@InterfaceC30951CCt boolean z, @ENW int i, @InterfaceC195747mE String str, @InterfaceC36228EJs(encode = true) Map<String, String> map, @InterfaceC195767mG List<EJ6> list);
    ...
    @ENY
    @E8M
    InterfaceC37276Ek4<String> postMultiPart(@ENW int i, @InterfaceC195747mE String str, @InterfaceC36228EJs(encode = true) Map<String, String> map, @InterfaceC64982Pes Map<String, TypedOutput> map2, @InterfaceC195767mG List<EJ6> list, @InterfaceC195737mD Object obj);

    @InterfaceC36318ENe
    InterfaceC37276Ek4<String> putBody(@ENW int i, @InterfaceC195747mE String str, @InterfaceC36228EJs(encode = true) Map<String, String> map, @InterfaceC195727mC TypedOutput typedOutput, @InterfaceC195767mG List<EJ6> list, @InterfaceC195737mD Object obj);
}

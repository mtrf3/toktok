...
public class MusicTypeAdapterFactory implements u {
    @Override // com.google.gson.u
    public final <T> TypeAdapter<T> create(Gson gson, TypeToken<T> typeToken) {
        if (!Music.class.isAssignableFrom(typeToken.getRawType())) {
            return null;
        }
        final TypeAdapter<T> LJIIJJI = gson.LJIIJJI(this, typeToken);
        return new TypeAdapter<T>() { // from class: com.ss.android.ugc.aweme.net.MusicTypeAdapterFactory.1
            ...
            public final T read(C65385PlN c65385PlN) {
                ...
                ?? r3 = (T) ((Music) TypeAdapter.this.read(c65385PlN));
                C40515FvD.LIZJ().LJIIIIZZ(r3.getOwnerId(), r3.getSecUid());
                return r3;
            }

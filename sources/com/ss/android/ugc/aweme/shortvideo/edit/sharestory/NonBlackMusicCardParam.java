...
public final class NonBlackMusicCardParam implements Serializable, Parcelable {
    public static final Parcelable.Creator<NonBlackMusicCardParam> CREATOR = new C82797WeX();
    ...
    @InterfaceC65349Pkn("card_bottom_lightness")
    public final float cardL;
    ...
    */
    public NonBlackMusicCardParam() {
        /*
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.ss.android.ugc.aweme.shortvideo.edit.sharestory.NonBlackMusicCardParam.<init>():void");
    }
    ...
    public final float getCardL() {
        return this.cardL;
    }

    public NonBlackMusicCardParam(float f, float f2, float f3, float f4, float f5, float f6, float f7, float f8, float f9, float f10, float f11, float f12) {
        this.bgTolerance = f;
        this.bgChromaMin = f2;
        this.bgChromaMax = f3;
        this.bgLMin = f4;
    ...
    public /* synthetic */ NonBlackMusicCardParam(float f, float f2, float f3, float f4, float f5, float f6, float f7, float f8, float f9, float f10, float f11, float f12, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this((i & 1) != 0 ? 8.0f : f, (i & 2) != 0 ? 0.0f : f2, (i & 4) != 0 ? 0.12f : f3, (i & 8) != 0 ? 0.3f : f4, (i & 16) != 0 ? 0.6f : f5, (i & 32) == 0 ? f6 : 8.0f, (i & 64) == 0 ? f7 : 0.3f, (i & 128) != 0 ? 50.0f : f8, (i & 256) == 0 ? f9 : 0.0f, (i & 512) != 0 ? 0.1f : f10, (i & 1024) != 0 ? 0.8f : f11, (i & 2048) != 0 ? 1.0f : f12);
    }
}

...
public final class ClickSeeOriginalInBioEvent extends AbstractC63695OzD {
    public final Map<String, C214578bV> LJII;

    public ClickSeeOriginalInBioEvent() {
        super("click_see_original_in_bio");
        C65352Pkq.LIZ(String.class);
        C65352Pkq.LIZ(String.class);
        this.LJII = C113554cx.LJJL(new OSZ("bio_card_lang", new C214578bV(false, null, null, false)), new OSZ("target_lang", new C214578bV(false, null, null, false)));
    }

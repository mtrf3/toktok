...
public final class SeeTranslationShowInBioEvent extends AbstractC63695OzD {
    public final Map<String, C214578bV> LJII;

    public SeeTranslationShowInBioEvent() {
        super("see_translation_show_in_bio");
        C65352Pkq.LIZ(String.class);
        C65352Pkq.LIZ(String.class);
        this.LJII = C113554cx.LJJL(new OSZ("enter_method", new C214578bV(true, null, null, false)), new OSZ("target_lang", new C214578bV(false, null, null, false)));
    }

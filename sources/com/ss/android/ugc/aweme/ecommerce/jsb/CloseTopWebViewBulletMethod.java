...
public final class CloseTopWebViewBulletMethod extends BaseBridgeMethod {
    ...
    public CloseTopWebViewBulletMethod(F3T contextProviderFactory) {
        super(contextProviderFactory);
        o.LJIIIZ(contextProviderFactory, "contextProviderFactory");
        this.LJLIL = "closeTopWebView";
    ...
    public final void handle(JSONObject params, InterfaceC37146Ehy iReturn) {
        ...
        C60008Ngq.LIZ(null, iReturn);
        iReturn.onSuccess(C76800UCe.LIZ);
    }
}

...
public final class USLogisticSelectModuleTitleVH extends ECJediViewHolder {
    ...
    public USLogisticSelectModuleTitleVH(ViewGroup viewGroup) {
    ...
    public final void onBind(Object item) {
        ...
        TextView textView = (TextView) _$_findCachedViewById(R.id.glp);
        if (textView == null) {
            return;
        }
        textView.setText(this.itemView.getContext().getText(R.string.faf));
    }
}

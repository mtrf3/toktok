package com.ss.android.ugc.aweme.ecommerce.us.osp.subpage;
...
public final class USMessageEditPanelFragment extends CommerceBottomSheetDialogFragment implements InterfaceC151715xP {
    public static final /* synthetic */ int LJLJJL = 0;
    public final C62822Ol8 LJLIL;
    public final long LJLILLLLZI;
    public C26018AJa LJLJI;
    ...
    public USMessageEditPanelFragment() {
        super(false, 1, null);
        C65776Prg LIZ = C65352Pkq.LIZ(OrderSubmitViewModel.class);
        this.LJLIL = C221108m2.LIZIZ(new AqS93S0300000_4(this, LIZ, LIZ, 139));
    ...
    public final void onViewCreated(View view, Bundle bundle) {
        ...
        if (arguments2 != null) {
            str = arguments2.getString("hint");
        } else {
            str = null;
        }
        Bundle arguments3 = getArguments();
        if (arguments3 != null) {
            str2 = arguments3.getString("seller_id");
        } else {
            str2 = null;
        }
        setKeyboardUtilListener(new AqS170S0100000_4(this, 372));
        C252709vu c252709vu = (C252709vu) _$_findCachedViewById(R.id.mvj);
        ...
        LIZJ.LIZLLL = true;
        LIZJ.LIZIZ(new AqS154S0100000_4(this, 328));
        c235119Kp.LIZIZ(LIZJ);
        c252709vu.setNavActions(c235119Kp);
        ((C252709vu) _$_findCachedViewById(R.id.mvj)).LJIILJJIL(true);
        C27949Ay1.LJIJI("save", "confirm", getViewModel().fw0(false), "message", null, null, null, 4080);
        if (str2 == null || (str3 = getViewModel().LLIIIILZ.get(str2)) == null) {
            str3 = "";
        }
        Context context = getContext();
        if (context != null) {
            C26018AJa c26018AJa = new C26018AJa(context, null, 6);
            c26018AJa.getEditText().setMinHeight(O6R.LJJIIZ(C32151Nz.LJIIZILJ(112)));
            c26018AJa.getEditText().setMaxHeight(O6R.LJJIIZ(C32151Nz.LJIIZILJ(142)));
            c26018AJa.LJII(str);
            c26018AJa.LJIIIZ(str3);
            c26018AJa.LJLJI = 200;
            c26018AJa.LJI(200);
            c26018AJa.LJ(false);
            this.LJLJI = c26018AJa;
        }
        C26021AJd c26021AJd = (C26021AJd) _$_findCachedViewById(R.id.mvf);
        c26021AJd.LJIIIIZZ(getString(R.string.f8y));
        c26021AJd.LJII();
        c26021AJd.setFormField(this.LJLJI);
        c26021AJd.LIZJ(EnumC26023AJf.HEADER);
        _$_findCachedViewById(R.id.mvh).getClass();
        View us_message_panel_save_button = _$_findCachedViewById(R.id.mvh);
        o.LJIIIIZZ(us_message_panel_save_button, "us_message_panel_save_button");
        C16880lQ.LJIIJ(new Au2S0S1100000_4(this, str2, 5), us_message_panel_save_button);
    }
    ...
    public final View onCreateView(LayoutInflater inflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        getViewModel().xw0();
        View LLLLIILL = C16880lQ.LLLLIILL(inflater, R.layout.a99, viewGroup, false);
        C29S c29s = null;

...
public final class USUnreachableSku extends ECJediViewHolder implements c {
    ...
    public USUnreachableSku(View view) {
        super(view);
        o.LJIIIZ(view, "view");
        this._$_findViewCache = new LinkedHashMap();
        C65776Prg LIZ = C65352Pkq.LIZ(OrderSubmitViewModel.class);
        this.vm$delegate = C221108m2.LIZIZ(new AqS93S0300000_4(this, LIZ, LIZ, 135));
    }
    ...
    public void onBind(PackedSku item) {
        ...
        TextView textView2 = (TextView) this.itemView.findViewById(R.id.euj);

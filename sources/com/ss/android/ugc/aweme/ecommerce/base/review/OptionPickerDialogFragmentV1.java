...
public final class OptionPickerDialogFragmentV1 extends ECBaseFragment implements InterfaceC219588ja, DialogInterface.OnDismissListener {
    public static final /* synthetic */ int LJLLILLLL = 0;
    public String LJLIL;
    public String LJLILLLLZI;
    public String LJLJI;
    public ArrayList<OptionV1> LJLJJI;
    ...
    public final C235119Kp createNavActions() {
        ...
        c234529Ii.LIZIZ(new AqS162S0100000_12(this, 404));
    ...
    public final void onStop() {
        ?? r3;
        super.onStop();
        if (!this.LJLJJLL && (r3 = this.LJLL) != 0) {
    ...
    public final void onCreate(Bundle bundle) {
        ...
        if (arguments3 != null) {
            str3 = arguments3.getString("selected_option_key");
        }
        this.LJLJI = str3;
        Bundle arguments4 = getArguments();
        if (arguments4 == null || (arrayList = arguments4.getParcelableArrayList("option_list")) == null) {
    ...
    public final void onViewCreated(View view, Bundle bundle) {
        ...
        ArrayList<OptionV1> arrayList = this.LJLJJI;
        if (arrayList != null) {
            RecyclerView recyclerView2 = (RecyclerView) _$_findCachedViewById(R.id.isn);
            C70834Rr4 c70834Rr4 = new C70834Rr4(arrayList);
            c70834Rr4.LJLILLLLZI = this.LJLJI;
            c70834Rr4.LJLJI = this.LJLILLLLZI;
            c70834Rr4.LJLJJI = new IDqS436S0100000_12(this, 32);
            c70834Rr4.LJLJJL = this.LJLJLJ;
            recyclerView2.setAdapter(c70834Rr4);
        }
        ?? r0 = this.LJLJLLL;
        if (r0 != 0) {
            r0.invoke(view);

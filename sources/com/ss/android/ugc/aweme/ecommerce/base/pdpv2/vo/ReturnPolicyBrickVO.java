...
public final class ReturnPolicyBrickVO extends AbstractC27664AtQ<ReturnPolicyBizData, ReturnPolicyBizExtra> implements Parcelable {
    public static final Parcelable.Creator<ReturnPolicyBrickVO> CREATOR = new C27654AtG();
    ...
    public final Object LJIIJ(String str) {
        try {
            Object fromJson = GsonProtectorUtils.fromJson(C27739Aud.LJFF(), str, C65330PkU.LIZJ(C65352Pkq.LJI(ReturnPolicyBizData.class)));
            if (!(fromJson instanceof ReturnPolicyBizData)) {
                fromJson = null;
            }
            return fromJson;
        } catch (s unused) {

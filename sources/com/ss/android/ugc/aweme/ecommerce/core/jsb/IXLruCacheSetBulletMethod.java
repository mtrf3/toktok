...
public final class IXLruCacheSetBulletMethod extends BaseBridgeMethod {
    ...
    public IXLruCacheSetBulletMethod(F3T contextProviderFactory) {
        super(contextProviderFactory);
        o.LJIIIZ(contextProviderFactory, "contextProviderFactory");
        this.LJLIL = "webcast_i18n.lruCacheSet";
    ...
    public final void handle(JSONObject params, InterfaceC37146Ehy iReturn) {
        ...
        getContext();
        iReturn.onSuccess(C64732gP.LIZ(params));
    }
}

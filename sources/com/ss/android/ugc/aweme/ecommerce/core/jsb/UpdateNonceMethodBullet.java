...
public final class UpdateNonceMethodBullet extends BaseBridgeMethod {
    ...
    public UpdateNonceMethodBullet(F3T contextProviderFactory) {
        super(contextProviderFactory);
        o.LJIIIZ(contextProviderFactory, "contextProviderFactory");
        this.LJLIL = "pipo.updateNonce";
    ...
    public final void handle(JSONObject params, InterfaceC37146Ehy iReturn) {
        ...
        C36487ETr.LIZ(iReturn, null, params);
    }
}

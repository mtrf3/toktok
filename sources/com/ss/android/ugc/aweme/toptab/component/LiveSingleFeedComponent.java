package com.ss.android.ugc.aweme.toptab.component;
...
public final class LiveSingleFeedComponent extends HomeFeedComponent {
    ...
    public LiveSingleFeedComponent() {
        new LinkedHashMap();
        this.LJLLI = C221108m2.LIZIZ(new AqS159S0100000_9(this, 658));
        this.LJLLILLLL = C221108m2.LIZIZ(new AqS159S0100000_9(this, 657));
        C9BE c9be = C9BE.LIZ;
        C65776Prg LIZ = C65352Pkq.LIZ(LiveSingleFeedListViewModel.class);
        this.LJLLJ = C78926UyI.LJ(this, LIZ, c9be, new AqS159S0100000_9(LIZ, 659), LXR.INSTANCE, null);
    }

    @Override // X.InterfaceC55112Lk4
    public final void LJJIJIL() {
        withState(this.LJLLJ.getValue(), new AqS175S0100000_9(this, 306));
        if (C1DH.LJIL()) {
            C77439UaJ.LIZIZ();
        }
    }
    ...
    public final boolean LJIILJJIL() {
        ILiveSingleFeedContentAssemAbility iLiveSingleFeedContentAssemAbility = (ILiveSingleFeedContentAssemAbility) C55096Ljo.LIZ(C55096Ljo.LJIIZILJ(this), ILiveSingleFeedContentAssemAbility.class, null);
        if (iLiveSingleFeedContentAssemAbility != null) {
            return iLiveSingleFeedContentAssemAbility.LJIILJJIL();
        }
        return false;
    }
    ...
    public final boolean LJJIJIIJI() {
        ILiveSingleFeedContentAssemAbility iLiveSingleFeedContentAssemAbility = (ILiveSingleFeedContentAssemAbility) C55096Ljo.LIZ(C55096Ljo.LJIIZILJ(this), ILiveSingleFeedContentAssemAbility.class, null);
        if (iLiveSingleFeedContentAssemAbility != null) {
            return iLiveSingleFeedContentAssemAbility.LJJIJIIJI();
        }
        return false;
    }
    ...
    public final boolean LJJIJLIJ(Aweme aweme) {
        ...
        ILiveSingleFeedContentAssemAbility iLiveSingleFeedContentAssemAbility = (ILiveSingleFeedContentAssemAbility) C55096Ljo.LIZ(C55096Ljo.LJIIZILJ(this), ILiveSingleFeedContentAssemAbility.class, null);
        if (iLiveSingleFeedContentAssemAbility != null) {
            return iLiveSingleFeedContentAssemAbility.LJJIJLIJ(aweme);
        }
        return false;
    }

...
public abstract class Hilt_SearchMusicListAssem<VM extends AssemListViewModel<?, ?, ?>> extends UIListContentAssem<VM> implements YU5<Object> {
    ...
    public void inject() {
        ((InterfaceC87446YTq) generatedComponent()).LJIIL();
    }

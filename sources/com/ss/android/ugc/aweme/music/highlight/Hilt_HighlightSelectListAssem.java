...
public abstract class Hilt_HighlightSelectListAssem<VM extends AssemListViewModel<?, ?, ?>> extends UIListContentAssem<VM> implements YU5<Object> {
    ...
    public final void onCreate() {
        super.onCreate();
        ((InterfaceC87451YTv) generatedComponent()).LJIIIIZZ();
    }
}

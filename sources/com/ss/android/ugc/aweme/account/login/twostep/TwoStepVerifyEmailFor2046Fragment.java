...
public final class TwoStepVerifyEmailFor2046Fragment extends InputCodeFragmentV2 {
    ...
    public final C62822Ol8 LLIIIZ = C221108m2.LIZIZ(new AqS165S0100000_15(this, 161));
    public final C62822Ol8 LLIIJI = C221108m2.LIZIZ(new AqS165S0100000_15(this, 163));
    public final C62822Ol8 LLIIJLIL = C221108m2.LIZIZ(new AqS165S0100000_15(this, 162));
    public final C62822Ol8 LLIIL = C221108m2.LIZIZ(new AqS165S0100000_15(this, 160));
    public final C62822Ol8 LLIILII = C221108m2.LIZIZ(new AqS161S0100000_11(this, 15));
    ...
    public final C85712XkS Jl() {
        ...
        LIZ.append('\n');
        LIZ.append(getString(R.string.hx0));
        c85712XkS.LJIIIIZZ = X1D.LIZIZ(LIZ);
        c85712XkS.LJIIIZ = getString(R.string.hx1, getEmail());
        c85712XkS.LIZ = " ";
        c85712XkS.LJIILIIL = false;
        if (C52927Kpv.LIZ()) {
            c85712XkS.LIZ = getString(R.string.t7o);
            c85712XkS.LJIIIIZZ = getString(R.string.t7n);
            c85712XkS.LJIIIZ = getString(R.string.t7m, getEmail());
    ...
    public final List<TwoStepVerifyWays> lm() {
        return (List) this.LLIIJLIL.getValue();
    }
    ...
    public final void LLFZ() {
        ...
        C85144XbI.LJJIJIIJIL(enterFrom, enterMethod, platForm, "email");
        super.LLFZ();
    }
    ...
    public final C73525StN nm(String str) {
        return C69093R9t.LJIJI(this, this, getEmail(), 6, str, (Map) this.LLIILII.getValue(), null, 192).LJFF(new IDaS224S0100000_15(this, 11));
    }
    ...
    public final void onCreate(Bundle bundle) {
        ...
        C69135RBj LIZ = C69134RBi.LIZ(mo49getActivity(), getEmail(), xl());
    ...
    public final void onViewCreated(final View view, Bundle bundle) {
        ...
        String platForm = mm();
        o.LJIIIIZZ(platForm, "platForm");
        C85144XbI.LJJIZ(enterFrom, enterMethod, platForm, "email");
        ...
        ((CompoundButton) _$_findCachedViewById(R.id.b_d)).setOnCheckedChangeListener(C85616Xiu.LJLIL);
        if (!lm().isEmpty()) {
            _$_findCachedViewById(R.id.b9_).setVisibility(0);
            C16880lQ.LJJJJI((TuxTextView) _$_findCachedViewById(R.id.b9_), new ACListenerS35S0100000_15(this, 41));
        } else {
            _$_findCachedViewById(R.id.b9_).setVisibility(8);
        }
        C16880lQ.LJJIZ((SY4) _$_findCachedViewById(R.id.h0u), new ACListenerS35S0100000_15(this, 42));
        C16880lQ.LJIIJ(new ACListenerS35S0100000_15(view, 43), view);
        ((C80498ViY) _$_findCachedViewById(R.id.enw)).setInputLength(6);
        ((TextView) _$_findCachedViewById(R.id.enw)).addTextChangedListener(new C85617Xiv(this));
        ...
        if (C52927Kpv.LIZ()) {
            ...
            C16880lQ.LJIL((ConstraintLayout) _$_findCachedViewById(R.id.b_9), new ACListenerS35S0100000_15(this, 44));
            if (Build.VERSION.SDK_INT < 30) {
                getLifecycle().addObserver(new LifecycleEventObserver() { // from class: com.ss.android.ugc.aweme.account.login.twostep.TwoStepVerifyEmailFor2046Fragment$onViewCreated$7
                    @Override // androidx.lifecycle.LifecycleEventObserver
                    public final void onStateChanged(LifecycleOwner source, Lifecycle.Event event) {
                        o.LJIIIZ(source, "source");
                        o.LJIIIZ(event, "event");
                        if (event == Lifecycle.Event.ON_RESUME) {
                            KeyboardUtils.LIZ(TwoStepVerifyEmailFor2046Fragment.this.getViewLifecycleOwner(), view, new C85619Xix(TwoStepVerifyEmailFor2046Fragment.this));
                        }
                    }
                });
            } else {
                C16360ka.LJIJJ(view, new C85614Xis(this));
            }
        }
    }
}

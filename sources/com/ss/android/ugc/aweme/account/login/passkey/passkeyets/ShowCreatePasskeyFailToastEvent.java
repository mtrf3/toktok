...
public final class ShowCreatePasskeyFailToastEvent extends AbstractC63695OzD {
    public final Map<String, C214578bV> LJII;

    public ShowCreatePasskeyFailToastEvent() {
        super("show_create_passkey_fail_toast");
        ...
        C65352Pkq.LIZ(cls);
        C65352Pkq.LIZ(cls);
        this.LJII = C113554cx.LJJL(new OSZ("enter_from", new C214578bV(false, null, null, false)), new OSZ("enter_method", new C214578bV(false, null, null, false)), new OSZ("error_code", new C214578bV(false, null, null, false)), new OSZ("has_google_account", new C214578bV(false, null, null, false)), new OSZ("has_screen_lock", new C214578bV(false, null, null, false)));
    }

...
public final class PoiCollectListFragment extends BasePage implements KPL, C8Z9, C8ZK {
    ...
    public final void LJJIJL() {
        if (this.LJLILLLLZI) {
            ((C7DQ) C8VC.LIZLLL(this, C65352Pkq.LIZ(C7DQ.class))).nh();
        }
    }
    ...
    public final void onCreate(Bundle bundle) {
        ...
        fragmentConfiguration(GG0.LJLIL);
    }
    ...
    public final void onViewCreated(View view, Bundle bundle) {
        ...
        C8VV.LIZ(this, false, new AqS169S0100000_3(this, 368));
    }

    @Override // androidx.fragment.app.Fragment
    public final View onCreateView(LayoutInflater inflater, ViewGroup viewGroup, Bundle bundle) {
        o.LJIIIZ(inflater, "inflater");
        View LLLLIILL = C16880lQ.LLLLIILL(inflater, R.layout.c0c, viewGroup, false);
        C29S c29s = null;

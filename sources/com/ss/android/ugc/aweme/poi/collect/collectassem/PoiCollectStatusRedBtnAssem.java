...
public class PoiCollectStatusRedBtnAssem extends PoiCollectStatusBaseAssem {
    ...
    public PoiCollectStatusRedBtnAssem() {
        new LinkedHashMap();
        C9BE c9be = C9BE.LIZ;
        C65776Prg LIZ = C65352Pkq.LIZ(PoiDetailInfoViewModel.class);
        C78926UyI.LJ(this, LIZ, c9be, new AqS153S0100000_3(LIZ, 689), C189147ba.INSTANCE, null);
        this.LJLLLL = C221108m2.LIZIZ(new AqS153S0100000_3(this, 686));
        this.LJLLLLLL = C221108m2.LIZIZ(new AqS153S0100000_3(this, 687));
        this.LJLZ = C221108m2.LIZIZ(new AqS153S0100000_3(this, 688));
    }
    ...
    public void X3() {
        C189127bY.LIZJ((InterfaceC189137bZ) C8VC.LIZIZ(this, C65352Pkq.LIZ(InterfaceC189137bZ.class), null), null, "click_button", null, 13);
    }
    ...
    public final void onViewCreated(View view) {
        ...
        if (LIZLLL != null) {
            ...
            PoiDetailInfoRefreshAbility poiDetailInfoRefreshAbility = new PoiDetailInfoRefreshAbility() { // from class: com.ss.android.ugc.aweme.poi.collect.collectassem.PoiCollectStatusRedBtnAssem$onViewCreated$1
                ...
                public final void RD(PoiListApi.PoiDetailResponse poiDetailResponse, boolean z) {
                    PoiCollectStatusRedBtnAssem.this.X3();
                }

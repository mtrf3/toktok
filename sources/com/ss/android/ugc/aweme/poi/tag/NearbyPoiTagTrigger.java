...
public final class NearbyPoiTagTrigger extends BaseCellTriggerComponent<NearbyPoiTagTrigger> implements VideoTagCategoryProtocol {
    ...
    public final InterfaceC65350Pko<? extends ReusedUISlotAssem<? extends C3C8>> e4() {
        return C65352Pkq.LIZ(NearbyPoiTagAssem.class);
    }
    ...
    public NearbyPoiTagTrigger() {
        new LinkedHashMap();
        this.LLF = C221108m2.LIZIZ(new AqS153S0100000_3(this, 791));
    }
    ...
    public final void F0(VideoItemParams item) {
        ...
        if (C51556KLg.LIZ().isPoiTagShow(str, aweme) && (priorityAbility = (PriorityAbility) this.LLF.getValue()) != null) {
            priorityAbility.Es(this, null, new AqS169S0100000_3(this, 1013));
        }
    }
    ...
    public final boolean k4(VideoItemParams item) {
        ...
        o.LJIIIIZZ(aweme, "item.aweme");
        C51556KLg.LIZ.getClass();
        return C51556KLg.LIZ().isPoiTagShow(str, aweme);
    }
}

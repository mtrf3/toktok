...
public final class ClickReportDanmakuEvent extends AbstractC63695OzD {
    public final Map<String, C214578bV> LJII;

    public ClickReportDanmakuEvent() {
        super("click_report_danmaku");
        ...
        C65352Pkq.LIZ(String.class);
        C65352Pkq.LIZ(String.class);
        this.LJII = C113554cx.LJJL(new OSZ("is_author", new C214578bV(false, null, null, false)), new OSZ("author_id", new C214578bV(false, null, null, false)), new OSZ("danmaku_id", new C214578bV(false, null, null, false)), new OSZ("enter_from", new C214578bV(false, null, null, false)), new OSZ("group_id", new C214578bV(false, null, null, false)), new OSZ("user_id", new C214578bV(false, null, null, false)));
    }

...
public final class ClickAddDanmakuEvent extends AbstractC63695OzD {
    public final Map<String, C214578bV> LJII;

    public ClickAddDanmakuEvent() {
        super("click_add_danmaku");
        C65352Pkq.LIZ(Integer.TYPE);
        C65352Pkq.LIZ(String.class);
        C65352Pkq.LIZ(String.class);
        C65352Pkq.LIZ(EnumC122764ro.class);
        C65352Pkq.LIZ(String.class);
        C65352Pkq.LIZ(String.class);

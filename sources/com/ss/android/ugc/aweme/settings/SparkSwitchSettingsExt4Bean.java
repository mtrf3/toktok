...
public final class SparkSwitchSettingsExt4Bean extends F9E {
    ...
    public SparkSwitchSettingsExt4Bean() {
    ...
    public SparkSwitchSettingsExt4Bean(List<String> allowList, List<String> denyList) {
    ...
    public SparkSwitchSettingsExt4Bean(List list, List list2, int i, DefaultConstructorMarker defaultConstructorMarker) {

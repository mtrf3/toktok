...
public final class SparkSwitchSettingsExt3Bean extends F9E {
    ...
    public SparkSwitchSettingsExt3Bean() {
    ...
    public SparkSwitchSettingsExt3Bean(List<String> allowList, List<String> denyList) {
    ...
    public SparkSwitchSettingsExt3Bean(List list, List list2, int i, DefaultConstructorMarker defaultConstructorMarker) {

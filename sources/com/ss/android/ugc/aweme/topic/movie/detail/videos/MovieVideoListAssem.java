...
public final class MovieVideoListAssem extends DetailListAssem implements InnerFlowAbility<C185907Ri> {
    ...
    public MovieVideoListAssem() {
        ...
        new LinkedHashMap();
        this.LJLLLL = new C55749LuL(C47704Ins.LIZJ(this, C7RE.class, null), checkSupervisorPrepared());
        AqS153S0100000_3 aqS153S0100000_3 = new AqS153S0100000_3(this, 1077);
        C65776Prg LIZ = C65352Pkq.LIZ(MovieVideoListVM.class);
        C185847Rc c185847Rc = C185847Rc.INSTANCE;
        if (C214368bA.LJIIIIZZ) {
            LJIILJJIL = new AqS153S0100000_3((C8W0) this, 1076);
        } else {
            LJIILJJIL = C78926UyI.LJIILJJIL(this, true);
        }
        this.LJLLLLLL = new C214378bB(LIZ, aqS153S0100000_3, C214528bQ.LJLIL, C78926UyI.LJJII(this, false), C184077Kh.LJLIL, c185847Rc, LJIILJJIL, C78926UyI.LJIIZILJ(this, true));
    }
    ...
    public final C7RE W3() {
        return (C7RE) this.LJLLLL.getValue();
    }
    ...
    public final void onViewCreated(View view) {
        ...
        MovieVideoListVM movieVideoListVM = (MovieVideoListVM) this.LJLLLLLL.getValue();
        C7RE W3 = W3();
        String str3 = "";
        if (W3 == null || (str = W3.LJLIL) == null) {
            str = "";
        }
        movieVideoListVM.LJLIL = str;
        MovieVideoListVM movieVideoListVM2 = (MovieVideoListVM) this.LJLLLLLL.getValue();
        C7RE W32 = W3();
        ...
        wrapGridLayoutManager.LLIILII = new IDcS7S0200000_3(this, wrapGridLayoutManager, 4);
        M3.setLayoutManager(wrapGridLayoutManager);
        U3();
        C8YN.LJII(this, (AssemViewModel) this.LJLLLLLL.getValue(), new TBT() { // from class: X.7Re
            @Override // X.TBT, X.TBZ, X.TBW
            public final Object get(Object obj) {
                return ((C185937Rl) obj).LJLIL;
            }
        }, null, new AqS185S0100000_3(this, 91), 6);

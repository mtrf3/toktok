...
public final class MovieVideosResp extends BaseResponse {
    ...
    public final boolean equals(Object obj) {
        ...
        if (!(obj instanceof MovieVideosResp)) {
            return false;
        }
        MovieVideosResp movieVideosResp = (MovieVideosResp) obj;
        return o.LJ(this.awemeList, movieVideosResp.awemeList) && this.hasMore == movieVideosResp.hasMore && o.LJ(this.pageExtra, movieVideosResp.pageExtra);
    }
    ...
    public final String toString() {
        ...
        LIZ.append("MovieVideosResp(awemeList=");
    ...
    /* JADX WARN: Multi-variable type inference failed */
    public MovieVideosResp(List<? extends Aweme> list, boolean z, String pageExtra) {

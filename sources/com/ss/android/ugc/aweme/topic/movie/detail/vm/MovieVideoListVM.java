...
public final class MovieVideoListVM extends BaseDetailShareVM<C185937Rl, C185907Ri, C185957Rn> {
    public String LJLIL;
    public String LJLILLLLZI;
    public C185957Rn LJLJI = new C185957Rn(null);
    ...
    public final void newState(C8HZ<C185907Ri> newListState) {
        ...
        setState(new AqS169S0100000_3(newListState, (C8HZ<C2050482y>) 493));
    }
    ...
    public final void onReceiveVideoEvent(C50420Jqa event) {
        ...
        if (bundle2 == null || (LLJJIII = C16880lQ.LLJJIII(bundle2, "page_id")) == null || (bundle = event.LJLJI) == null || (LLJJIII2 = C16880lQ.LLJJIII(bundle, "movie_id")) == null || (str = this.LJLIL) == null || this.LJLILLLLZI == null || event.LJLIL != 21 || !o.LJ(str, LLJJIII2) || !o.LJ(LLJJIII, LLJJIII)) {
            return;
        }
        ...
        while (it.hasNext()) {
            if (o.LJ(it.next().getAid(), ((Aweme) obj).getAid())) {
                ...
                setState(new AqS28S0001000_3(i, 10));
                return;
            }
            i++;
        }
    ...
    public final Object onRefresh(InterfaceC67352kd<? super A2G<C185957Rn>> interfaceC67352kd) {
        return onLoadMore(new C185957Rn(null), interfaceC67352kd);
    }
    ...
    */
    public final java.lang.Object onLoadMore(X.C185957Rn r9, X.InterfaceC67352kd<? super X.A2G<X.C185957Rn>> r10) {
        /*
            r8 = this;
            boolean r0 = r10 instanceof X.C185947Rm
            if (r0 == 0) goto L54
            r6 = r10
            X.7Rm r6 = (X.C185947Rm) r6
            int r2 = r6.LJLJJI
        ...
        L12:
            ...
            if (r0 == 0) goto L3d
            if (r0 != r4) goto Ld5
            com.ss.android.ugc.aweme.topic.movie.detail.vm.MovieVideoListVM r6 = r6.LJLIL
            X.C141335gf.LIZJ(r3)
        L23:
            X.XGX r3 = (X.XGX) r3
            ...
            X.7T1 r0 = (X.C7T1) r0
            com.ss.android.ugc.aweme.topic.movie.detail.api.MovieVideosResp r7 = r0.LIZ
            if (r7 != 0) goto L5a
            X.A2F r0 = X.A2G.LIZ
        ...
        Ld5:
            ...
            throw r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.ss.android.ugc.aweme.topic.movie.detail.vm.MovieVideoListVM.onLoadMore(X.7Rn, X.2kd):java.lang.Object");
    }

    @Override // com.ss.android.ugc.aweme.detail.vm.BaseDetailShareVM
    public final C185957Rn getCursorByFeedParam(int i, M89 feedParam, int i2, boolean z) {

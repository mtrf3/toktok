...
public final class MovieSearchPage__BindExtra {
    public MovieSearchPage__BindExtra(MovieSearchPage fragment, Intent intent) {
        o.LJIIIZ(fragment, "fragment");
        o.LJIIIZ(intent, "intent");
        Bundle LLJJIJI = C16880lQ.LLJJIJI(intent);
        if (LLJJIJI != null) {
            Object LLJJIII = C16880lQ.LLJJIII(LLJJIJI, "selected_movie_ids");
            if (LLJJIII != null) {
            ...
            Object LLJJIII2 = C16880lQ.LLJJIII(LLJJIJI, "selected_movie_max_count");
            if (LLJJIII2 != null) {

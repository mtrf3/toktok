...
public final class BookInfoPage extends DetailBaseFragment {
    ...
    public final C5H3 LJLILLLLZI = RouteArgExtension.INSTANCE.requiredArg(this, GK7.LJLIL, "book_id", String.class);
    ...
    public final void onViewCreated(View view, Bundle bundle) {
        ...
        fragmentConfiguration(C41243GGp.LJLIL);
        ...
        LIZJ.LIZLLL = true;
        LIZJ.LIZIZ(new AqS157S0100000_7(this, 329));
        C9KF LIZLLL = t1.LIZLLL(c235119Kp, new AbstractC234519Ih[]{LIZJ});
        String string = getString(R.string.cci);
        o.LJIIIIZZ(string, "getString(R.string.book_details_caret_details)");
        LIZLLL.LIZJ = string;
        ...
        String str = discoveryTopicCdnSettingModel.bookCdnUrl;
        if (str == null) {
            str = "aweme://lynxview/?hide_nav_bar=1&channel=discovery_topic_book_info&bundle=pages%2Fbook_info%2Ftemplate.js&dynamic=1&group=discovery_topic_book_info";
        }
        sparkContext.LJJIJLIJ(str);
        sparkContext.LJJIIZ(this.LJLILLLLZI.getValue(), "bookId");
        sparkContext.LJJI(new IDbS497S0100000_7(this, 0));

...
public final class BookSearchPage extends DetailBaseFragment implements SubmitAbility, TopicSearchListAssem.TopicSelectedAbility {
    ...
    public int LJLJI = 5;
    public final C62822Ol8 LJLJJI = C221108m2.LIZIZ(new AqS151S0100000_1(this, 722));
    public final Map<String, BookDetail> LJLJJL = new LinkedHashMap();
    ...
    public final void q0() {
        String str;
        List<String> urlList;
        Collection<BookDetail> values = ((LinkedHashMap) this.LJLJJL).values();
        C188727au LIZ = CK3.LIZ("anchor_type", "book");
        ArrayList arrayList = new ArrayList(C32I.LJJL(values, 10));
        Iterator it = values.iterator();
        while (it.hasNext()) {
            arrayList.add(((BookDetail) it.next()).id);
        }
        LIZ.LJI("book_id", ORZ.LLD(arrayList, null, null, null, null, 63));
        ArrayList arrayList2 = new ArrayList(C32I.LJJL(values, 10));
        Iterator it2 = values.iterator();
        while (it2.hasNext()) {
            arrayList2.add(((BookDetail) it2.next()).title);
        }
        LIZ.LJI("book_title", ORZ.LLD(arrayList2, null, null, null, null, 63));
        LIZ.LIZLLL(values.size(), "book_num");
        FMX.LJIIL("choose_anchor", LIZ.LIZ);
        ArrayList arrayList3 = new ArrayList(C32I.LJJL(values, 10));
        for (BookDetail bookDetail : values) {
            String str2 = bookDetail.id;
            String str3 = bookDetail.title;
            UrlModel urlModel = bookDetail.cover;
            if (urlModel != null && (urlList = urlModel.getUrlList()) != null) {
                str = (String) ORZ.LJLLLL(urlList);
            } else {
                str = null;
            }
            arrayList3.add(new BookAnchorContent(str2, str3, str, bookDetail.author, null, bookDetail.topicRating, 16, null));
        }
        Iterator it3 = arrayList3.iterator();
        while (it3.hasNext()) {
            BookAnchorContent bookAnchorContent = (BookAnchorContent) it3.next();
            String str4 = bookAnchorContent.bookId;
            int type = EnumC42934Gt8.ANCHOR_BOOKTOK.getTYPE();
            String str5 = bookAnchorContent.bookName;
            String LIZJ = C75792yF.LIZJ(bookAnchorContent);
    ...
    public final boolean Uk(TopicRawInfo topicInfo, boolean z) {
        ...
        if (z) {
            this.LJLJJL.put(String.valueOf(topicInfo.id), new BookDetail(topicInfo.id, topicInfo.title, topicInfo.authorName, null, topicInfo.cover, topicInfo.topicRating, null, null, null, topicInfo.isCollected, 456, null));
            Map<String, BookDetail> map = this.LJLJJL;
            ...
            if (((List) this.LJLJJI.getValue()).size() + linkedHashMap.size() > this.LJLJI) {
                ...
                if (context != null && (resources = context.getResources()) != null) {
                    int i = this.LJLJI;
                    str = resources.getQuantityString(R.plurals.bm, i, Integer.valueOf(i));
                } else {
                    str = null;
                }
    ...
    public final void onViewCreated(View view, Bundle bundle) {
        ...
        C8VV.LIZ(this, false, new AqS169S0100000_3(this, 648));
    }

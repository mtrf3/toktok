...
public final class PinChangeConsultResult {
    ...
    public final boolean equals(Object obj) {
        ...
        if (!(obj instanceof PinChangeConsultResult)) {
            return false;
        }
        PinChangeConsultResult pinChangeConsultResult = (PinChangeConsultResult) obj;
        return o.LJ(this.verifyInfo, pinChangeConsultResult.verifyInfo) && o.LJ(this.pinRuleList, pinChangeConsultResult.pinRuleList) && o.LJ(this.pinStatusDetail, pinChangeConsultResult.pinStatusDetail);
    }
    ...
    public final String toString() {
        ...
        LIZ.append("PinChangeConsultResult(verifyInfo=");
    ...
    public PinChangeConsultResult(String verifyInfo, List<PinRule> pinRuleList, PinStatusDetail pinStatusDetail) {

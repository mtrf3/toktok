...
public abstract class Hilt_PostModeDetailPageFragment extends BaseFragment implements YU5<Object> {
    ...
    public final void onAttach(Activity activity) {
        ...
        if (this.LJLIL == null) {
            ...
            ((InterfaceC87474YUs) generatedComponent()).LJFF();
        }
    }

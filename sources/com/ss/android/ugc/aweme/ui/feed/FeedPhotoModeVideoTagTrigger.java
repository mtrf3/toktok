...
public final class FeedPhotoModeVideoTagTrigger extends BaseCellTriggerComponent<FeedPhotoModeVideoTagTrigger> implements VideoTagCategoryProtocol {
    ...
    public final InterfaceC65350Pko<? extends ReusedUISlotAssem<? extends C3C8>> e4() {
        return C65352Pkq.LIZ(FeedPhotoModeVideoTagAssem.class);
    }

    @Override // com.ss.android.ugc.feed.platform.container.protocol.priority.PriorityProtocol
    public final String y2() {
        return "low_tag_photo";
    }

    public FeedPhotoModeVideoTagTrigger() {
        new LinkedHashMap();
        this.LLF = C221108m2.LIZIZ(new AqS153S0100000_3(this, 1137));
    }
    ...
    public final void F0(VideoItemParams item) {
        ...
        if (k4(item) && (priorityAbility = (PriorityAbility) this.LLF.getValue()) != null) {
            priorityAbility.Es(this, null, new AqS169S0100000_3(this, 512));
        }
    }
    ...
    public final boolean k4(VideoItemParams item) {
        o.LJIIIZ(item, "item");
        return C8SG.LIZIZ.LJIL(item.getAweme());
    }
}

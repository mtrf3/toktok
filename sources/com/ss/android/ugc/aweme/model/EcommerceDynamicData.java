...
public final class EcommerceDynamicData extends F9E {
    ...
    public EcommerceDynamicData(int i, DynamicPatch dynamicPatch) {
        o.LJIIIZ(dynamicPatch, "dynamicPatch");
        this.cardType = i;
        this.dynamicPatch = dynamicPatch;
    }

    public /* synthetic */ EcommerceDynamicData(int i, DynamicPatch dynamicPatch, int i2, DefaultConstructorMarker defaultConstructorMarker) {

...
public class SingleWebChromeClient extends C35701Dzl {
    ...
    public final void onPermissionRequest(PermissionRequest permissionRequest) {
        if (new C03880Dg(2).LIZJ(102604, "com/ss/android/ugc/aweme/crossplatform/platform/webview/SingleWebChromeClient", "onPermissionRequest", this, new Object[]{permissionRequest}, "void", new C65300Pk0(false, "(Landroid/webkit/PermissionRequest;)V", "6685650330628497826")).LIZ) {
            return;
        }
    ...
    public final void onGeolocationPermissionsShowPrompt(String origin, GeolocationPermissions.Callback callback) {
        if (new C03880Dg(2).LIZJ(100003, "com/ss/android/ugc/aweme/crossplatform/platform/webview/SingleWebChromeClient", "onGeolocationPermissionsShowPrompt", this, new Object[]{origin, callback}, "void", new C65300Pk0(false, "(Ljava/lang/String;Landroid/webkit/GeolocationPermissions$Callback;)V", "6685650330628497826")).LIZ) {
            return;
        }

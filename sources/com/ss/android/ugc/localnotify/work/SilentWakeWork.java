...
public final class SilentWakeWork extends Worker {
    ...
    public final C0CS LJII() {
        ...
        C68467Qtz.LIZ(0, currentTimeMillis, LIZIZ, LIZJ, false);
        StringBuilder LIZLLL = C06540Nm.LIZLLL("SilentWakeWork.doWork(", LIZJ, ": ", str, " - offset: ");
        LIZLLL.append(LIZIZ);
        LIZLLL.append(") START, ");
        LIZLLL.append(C16880lQ.LLLLIIIILLL());
        LIZLLL.append(" is main? ");
        LIZLLL.append(o.LJ(C16880lQ.LLJJJJ().getThread(), C16880lQ.LLLLIIIILLL()));
        C47629Imf.LIZ("SilentWakeWork", X1D.LIZIZ(LIZLLL));
        return new C29261Cw();
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public SilentWakeWork(Context context, WorkerParameters params) {

...
public class ListenerManger {
    ...
    public Map<String, XDR> mKNEffectPlatformListenerMap = new ConcurrentHashMap();
    ...
    public <T> XDR<T> getKNPlatformListener(String str) {
        Map<String, XDR> map = this.mKNEffectPlatformListenerMap;
        if (map == null) {
            return null;
        }
        return map.get(str);
    ...
    public void addNewKNPlatformListener(String str, XDR xdr) {
        if (xdr != null) {
            if (this.mKNEffectPlatformListenerMap == null) {
                this.mKNEffectPlatformListenerMap = new ConcurrentHashMap();
            }
            this.mKNEffectPlatformListenerMap.put(str, xdr);
        }
    }

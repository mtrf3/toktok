...
public final class FriendsPageStateImp extends PageStateCommonComponent {
    ...
    public final void NV() {
        if (!FriendsTabPerfOptPhase2.LIZ().respToFirstFrameOpt) {
            super.NV();
        }
    }

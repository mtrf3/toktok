...
public final class VideoTagContainer$highTagComponentProtocol$2$1 implements ComponentPriorityProtocol {
    ...
    public final String o0() {
        ...
        Map<String, PriorityProtocol> map = this.LJLIL.C4().LIZ(EnumC210828Pe.VIDEO_TAG).get("high_tag");
        if (map == null) {
    ...
    public final View l0() {
        return ((C8PV) C113554cx.LJJJLL("high_tag", this.LJLIL.C4().LIZJ)).LJ();
    }
    ...
    public final C8T7 e2() {
        ...
        String o0 = o0();
        if (o0 == null || o0.length() == 0 || (map = this.LJLIL.C4().LIZ(EnumC210828Pe.VIDEO_TAG).get("high_tag")) == null || (priorityProtocol = map.get(o0())) == null) {
            return null;
        }

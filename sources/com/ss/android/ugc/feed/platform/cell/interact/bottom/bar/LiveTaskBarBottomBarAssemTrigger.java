...
public final class LiveTaskBarBottomBarAssemTrigger extends BaseCellTriggerComponent<LiveTaskBarBottomBarAssemTrigger> implements BottomBarPriorityProtocol {
    ...
    public final InterfaceC65350Pko<? extends ReusedUISlotAssem<? extends C3C8>> e4() {
        return C65352Pkq.LIZ(LiveTaskBarBottomBarAssem.class);
    }

    @Override // com.ss.android.ugc.feed.platform.container.protocol.priority.PriorityProtocol
    public final String y2() {
        return "bottom_banner_live_task";
    }

    public LiveTaskBarBottomBarAssemTrigger() {
        new LinkedHashMap();
        this.LLF = C221108m2.LIZIZ(new AqS153S0100000_3(this, 1265));
    }
    ...
    public final void F0(VideoItemParams item) {
        ...
        if (k4(item) && (priorityAbility = (PriorityAbility) this.LLF.getValue()) != null) {
            priorityAbility.Es(this, null, new AqS169S0100000_3(this, 572));
        }
    }
    ...
    public final boolean k4(VideoItemParams item) {
        ...
        return C78596Usy.LJJJJIZL(aweme, str);
    }
}

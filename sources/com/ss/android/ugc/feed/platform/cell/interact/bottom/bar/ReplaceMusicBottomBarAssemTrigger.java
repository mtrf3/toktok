...
public final class ReplaceMusicBottomBarAssemTrigger extends BaseCellTriggerComponent<ReplaceMusicBottomBarAssemTrigger> implements BottomBarPriorityProtocol {
    ...
    public final InterfaceC65350Pko<? extends ReusedUISlotAssem<? extends C3C8>> e4() {
        return C65352Pkq.LIZ(ReplaceMusicBottomBarAssem.class);
    }

    @Override // com.ss.android.ugc.feed.platform.container.protocol.priority.PriorityProtocol
    public final String y2() {
        return "bottom_banner_replace_music";
    }

    public ReplaceMusicBottomBarAssemTrigger() {
        new LinkedHashMap();
        this.LLF = C221108m2.LIZIZ(new AqS153S0100000_3(this, 1280));
    }
    ...
    public final void F0(VideoItemParams item) {
        ...
        if (k4(item)) {
            ...
            if (priorityAbility != null) {
                priorityAbility.Es(this, null, new AqS169S0100000_3(this, 578));
                return;
            }
            return;
        }

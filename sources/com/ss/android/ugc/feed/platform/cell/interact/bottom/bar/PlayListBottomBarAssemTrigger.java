...
public final class PlayListBottomBarAssemTrigger extends BaseCellTriggerComponent<PlayListBottomBarAssemTrigger> implements BottomBarPriorityProtocol {
    ...
    public final InterfaceC65350Pko<? extends ReusedUISlotAssem<? extends C3C8>> e4() {
        return C65352Pkq.LIZ(InteractPlayListBottomBarAssem.class);
    }

    @Override // com.ss.android.ugc.feed.platform.container.protocol.priority.PriorityProtocol
    public final String y2() {
        return "bottom_banner_playlist";
    }

    public PlayListBottomBarAssemTrigger() {
        new LinkedHashMap();
        this.LLF = C221108m2.LIZIZ(new AqS153S0100000_3(this, 1267));
    }
    ...
    public final void F0(VideoItemParams item) {
        ...
        if (C8P5.LIZ(item)) {
            ...
            if (priorityAbility != null) {
                priorityAbility.Es(this, null, new AqS169S0100000_3(this, 573));
                return;
            }
            return;
        }

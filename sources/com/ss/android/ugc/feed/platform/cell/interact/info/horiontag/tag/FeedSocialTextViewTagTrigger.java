...
public final class FeedSocialTextViewTagTrigger extends BaseCellTriggerComponent<FeedSocialTextViewTagTrigger> implements VideoSocialTagCategoryProtocol {
    ...
    public final InterfaceC65350Pko<? extends ReusedUISlotAssem<? extends C3C8>> e4() {
        return C65352Pkq.LIZ(FeedSocialTextViewTagAssem.class);
    }
    ...
    public FeedSocialTextViewTagTrigger() {
        new LinkedHashMap();
        this.LLF = C221108m2.LIZIZ(new AqS153S0100000_3(this, 1306));
    }
    ...
    public final boolean l4(Aweme aweme) {
        ...
        if (aweme == null || C8QV.LIZIZ(aweme) || (list = aweme.textVideoLabels) == null || !(!list.isEmpty())) {
            return false;
        }
        return true;
    }
    ...
    public final void m4(Aweme aweme) {
        ...
        if (l4(aweme) && (priorityAbility = (PriorityAbility) this.LLF.getValue()) != null) {
            priorityAbility.Es(this, null, new AqS169S0100000_3(this, 587));
        }
    }
}

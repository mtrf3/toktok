...
public final class EditCaptionBottomBarAssemTrigger extends BaseCellTriggerComponent<EditCaptionBottomBarAssemTrigger> implements BottomBarPriorityProtocol {
    ...
    public final InterfaceC65350Pko<? extends ReusedUISlotAssem<? extends C3C8>> e4() {
        return C65352Pkq.LIZ(EditCaptionBottomBarAssem.class);
    }

    @Override // com.ss.android.ugc.feed.platform.container.protocol.priority.PriorityProtocol
    public final String y2() {
        return "bottom_banner_edit_caption";
    }

    public EditCaptionBottomBarAssemTrigger() {
        new LinkedHashMap();
        this.LLF = C221108m2.LIZIZ(new AqS153S0100000_3(this, 1258));
    }
    ...
    public final void F0(VideoItemParams item) {
        ...
        if (k4(item) && (priorityAbility = (PriorityAbility) this.LLF.getValue()) != null) {
            priorityAbility.Es(this, null, new AqS169S0100000_3(this, 567));
        }
    }
    ...
    public final boolean k4(VideoItemParams item) {
        ...
        return C78866UxK.LJJLIIIJL(aweme);
    }
}

...
public final class AdFeeDeductionBottomBarAssemTrigger extends BaseCellTriggerComponent<AdFeeDeductionBottomBarAssemTrigger> implements BottomBarPriorityProtocol {
    ...
    public final InterfaceC65350Pko<? extends ReusedUISlotAssem<? extends C3C8>> e4() {
        return C65352Pkq.LIZ(AdFeeDeductionBottomBarAssem.class);
    }

    @Override // com.ss.android.ugc.feed.platform.container.protocol.priority.PriorityProtocol
    public final String y2() {
        return "bottom_banner_ad_deduction";
    }

    public AdFeeDeductionBottomBarAssemTrigger() {
        new LinkedHashMap();
        this.LLF = C221108m2.LIZIZ(new AqS153S0100000_3(this, 1253));
    }
    ...
    public final void F0(VideoItemParams item) {
        ...
        if (k4(item)) {
            ...
            if (priorityAbility != null) {
                priorityAbility.Es(this, null, new AqS169S0100000_3(this, 566));
                return;
            }
            return;
        }
    ...
    public final boolean k4(VideoItemParams item) {
        ...
        if (aweme.isAd() && (awemeRawAd = aweme.getAwemeRawAd()) != null && (disclaimer = awemeRawAd.getDisclaimer()) != null && disclaimer.getType() != 0) {
            return true;
        }
        return false;
    }

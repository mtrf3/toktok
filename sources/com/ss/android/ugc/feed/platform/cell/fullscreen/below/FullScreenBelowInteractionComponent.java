package com.ss.android.ugc.feed.platform.cell.fullscreen.below;
...
public final class FullScreenBelowInteractionComponent extends BaseContainer<VContainerProtocol, FullScreenBelowInteractionComponent> {
    ...
    public FullScreenBelowInteractionComponent() {
        new LinkedHashMap();
        this.LLFFF = EnumC210578Of.CELL_FULL_SCREEN_COMPONENT;
    }

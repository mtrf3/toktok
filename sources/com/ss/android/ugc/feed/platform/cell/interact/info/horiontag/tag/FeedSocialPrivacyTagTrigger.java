...
public final class FeedSocialPrivacyTagTrigger extends BaseCellTriggerComponent<FeedSocialPrivacyTagTrigger> implements VideoSocialTagCategoryProtocol {
    ...
    public final InterfaceC65350Pko<? extends ReusedUISlotAssem<? extends C3C8>> e4() {
        return C65352Pkq.LIZ(FeedSocialPrivacyTagAssem.class);
    }

    @Override // com.ss.android.ugc.feed.platform.container.protocol.priority.PriorityProtocol
    public final String y2() {
        return "high_tag_privacy";
    }

    public FeedSocialPrivacyTagTrigger() {
        new LinkedHashMap();
        this.LLF = C221108m2.LIZIZ(new AqS153S0100000_3(this, 1302));
    }
    ...
    public final boolean l4(Aweme aweme) {
        ...
        if (((AwemeHybridLabelModel) ListProtector.get(aweme.getHybridLabels(), 0)).getLabelType() != HybridLabelTagType.PRIVACY.getValue() && (((AwemeHybridLabelModel) ListProtector.get(aweme.getHybridLabels(), 0)).getLabelType() != HybridLabelTagType.UNKNOWN.getValue() || ((AwemeHybridLabelModel) ListProtector.get(aweme.getHybridLabels(), 0)).getImageUrl() == null)) {
            return false;
        }
        return true;
    }
    ...
    public final void m4(Aweme aweme) {
        ...
        if (l4(aweme) && (priorityAbility = (PriorityAbility) this.LLF.getValue()) != null) {
            priorityAbility.Es(this, null, new AqS169S0100000_3(this, 585));
        }
    }
}

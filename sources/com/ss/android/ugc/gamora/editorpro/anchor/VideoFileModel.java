...
public final class VideoFileModel {
        ...
        */
        public Item() {
            /*
                ...
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.ss.android.ugc.gamora.editorpro.anchor.VideoFileModel.Item.<init>():void");
        }
    ...
    public final boolean equals(Object obj) {
        ...
        return o.LJ(this.portrait, videoFileModel.portrait) && o.LJ(this.landscape, videoFileModel.landscape);
    }
    ...
    public final String toString() {
        ...
        LIZ.append("VideoFileModel(portrait=");
    ...
    public VideoFileModel(Item item, Item item2) {
        this.portrait = item;
        this.landscape = item2;
    }

    public /* synthetic */ VideoFileModel(Item item, Item item2, int i, DefaultConstructorMarker defaultConstructorMarker) {

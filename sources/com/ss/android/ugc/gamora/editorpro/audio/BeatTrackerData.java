...
public final class BeatTrackerData extends F9E {
    ...
    public BeatTrackerData(List<Integer> time, List<Integer> value) {
        o.LJIIIZ(time, "time");
    ...
    public BeatTrackerData(List list, List list2, int i, DefaultConstructorMarker defaultConstructorMarker) {

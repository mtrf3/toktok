package com.ss.android.ugc.tiktok.tpsc.settings.account.adapters.profileviews;
...
public final class ProfileViewHistorySettingViewModel extends BasePrivacyUserSettingViewModelV3 {
    public ProfileViewHistorySettingViewModel() {
        super("profile_view_history");
    }
    ...
    public final void iv0(int i, BaseResponse response) {
        ...
        C07250Qf.LIZLLL(map, "newBuilder()\n           …               .builder()", LIZ, "change_profile_visitor_status", map);
    }
}

...
public class X509Util {
    ...
    public static final class TrustStorageListener extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            com_ss_videoarch_live_ttquic_X509Util$TrustStorageListener_com_ss_android_ugc_aweme_feed_lancet_JatoBoostLancet_onBroadcastReceiverReceive(this, context, intent);
        }

        public TrustStorageListener() {
        }

        public void com_ss_videoarch_live_ttquic_X509Util$TrustStorageListener__onReceive$___twin___(Context context, Intent intent) {
            if (Build.VERSION.SDK_INT >= 26) {
        ...
        public static void com_ss_videoarch_live_ttquic_X509Util$TrustStorageListener_com_bytedance_otis_optimise_lancet_NetworkInfoManager_onReceive(TrustStorageListener trustStorageListener, Context context, Intent intent) {
            if (!"android.net.conn.CONNECTIVITY_CHANGE".equals(intent.getAction())) {
                trustStorageListener.com_ss_videoarch_live_ttquic_X509Util$TrustStorageListener__onReceive$___twin___(context, intent);
            } else {
                C38523F9z.LIZ();
                trustStorageListener.com_ss_videoarch_live_ttquic_X509Util$TrustStorageListener__onReceive$___twin___(context, intent);
            }
        ...
        public static void com_ss_videoarch_live_ttquic_X509Util$TrustStorageListener_com_ss_android_ugc_aweme_feed_lancet_JatoBoostLancet_onBroadcastReceiverReceive(TrustStorageListener trustStorageListener, Context context, Intent intent) {
            if (!C84763XOl.LJIIJJI && intent != null) {
                if (!((ArrayList) C38413F5t.LIZ).contains(intent.getAction()) && C38413F5t.LIZ("onBroadcastReceiverReceive")) {
                    C35532Dx2.LIZIZ();
                }
            }
            com_ss_videoarch_live_ttquic_X509Util$TrustStorageListener_com_bytedance_otis_optimise_lancet_NetworkInfoManager_onReceive(trustStorageListener, context, intent);
        }
    }

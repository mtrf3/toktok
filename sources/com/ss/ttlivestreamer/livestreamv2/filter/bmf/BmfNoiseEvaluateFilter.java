...
public abstract class BmfNoiseEvaluateFilter {
    public static final String TAG = C16880lQ.LJLLJ(BmfNoiseEvaluateFilter.class);
    public volatile int mCostMsAccum;
    public volatile int mCostMsCount;
    public volatile int mLastCode;
    public volatile float mNoiseValueAccum;
    public StringBuilder sb;
    public boolean mEnable = true;
    public volatile float mNoiseValueAvg = -1.0f;
    ...
    public static BmfNoiseEvaluateFilter Create(Context context, JSONObject jSONObject, Handler handler, Handler handler2) {
        if (context != null && jSONObject != null) {
            try {
                ...
                LIZ.append(BmfNoiseEvaluateFilter.class.getPackage().getName());
                LIZ.append(".BmfNoiseEvaluateFilterImpl");
                return (BmfNoiseEvaluateFilter) Class.forName(X1D.LIZIZ(LIZ)).getDeclaredConstructor(Context.class, JSONObject.class, Handler.class, Handler.class).newInstance(context, jSONObject, handler, handler2);
            } catch (InvocationTargetException e) {
                printErrorLog(TAG, "create BmfNoiseLiveFilter failed. ", e.getTargetException());
                return null;
            } catch (Throwable th) {

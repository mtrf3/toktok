...
public class X509Util {
    ...
    public static void ensureInitializedLocked() {
        ...
        if (sTrustStorageListener == null) {
            ...
            C16880lQ.LJJLIIIJILLIZJL(sTrustStorageListener, ContextUtils.getApplicationContext(), intentFilter);
        }
    }
    ...
    public static final class TrustStorageListener extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            com_ss_bytertc_base_utils_X509Util$TrustStorageListener_com_ss_android_ugc_aweme_feed_lancet_JatoBoostLancet_onBroadcastReceiverReceive(this, context, intent);
        }

        public TrustStorageListener() {
        }

        public void com_ss_bytertc_base_utils_X509Util$TrustStorageListener__onReceive$___twin___(Context context, Intent intent) {
            if (Build.VERSION.SDK_INT >= 26) {
            ...
            try {
                ...
                LogUtil.e("X509Util", "Unable to reload the default TrustManager", e);
            } catch (NoSuchAlgorithmException e2) {
                LogUtil.e("X509Util", "Unable to reload the default TrustManager", e2);
            } catch (CertificateException e3) {
                LogUtil.e("X509Util", "Unable to reload the default TrustManager", e3);
            }
        }

        public static void com_ss_bytertc_base_utils_X509Util$TrustStorageListener_com_bytedance_otis_optimise_lancet_NetworkInfoManager_onReceive(TrustStorageListener trustStorageListener, Context context, Intent intent) {
            if (!"android.net.conn.CONNECTIVITY_CHANGE".equals(intent.getAction())) {
                trustStorageListener.com_ss_bytertc_base_utils_X509Util$TrustStorageListener__onReceive$___twin___(context, intent);
            } else {
                C38523F9z.LIZ();
                trustStorageListener.com_ss_bytertc_base_utils_X509Util$TrustStorageListener__onReceive$___twin___(context, intent);
            }
        ...
        public static void com_ss_bytertc_base_utils_X509Util$TrustStorageListener_com_ss_android_ugc_aweme_feed_lancet_JatoBoostLancet_onBroadcastReceiverReceive(TrustStorageListener trustStorageListener, Context context, Intent intent) {
            if (!C84763XOl.LJIIJJI && intent != null) {
                if (!((ArrayList) C38413F5t.LIZ).contains(intent.getAction()) && C38413F5t.LIZ("onBroadcastReceiverReceive")) {
                    C35532Dx2.LIZIZ();
                }
            }
            com_ss_bytertc_base_utils_X509Util$TrustStorageListener_com_bytedance_otis_optimise_lancet_NetworkInfoManager_onReceive(trustStorageListener, context, intent);
        }
    }
    ...
    public static final class X509TrustManagerIceCreamSandwich implements X509TrustManagerImplementation {
        ...
        @Override // com.ss.bytertc.base.utils.X509Util.X509TrustManagerImplementation
        public List<X509Certificate> checkServerTrusted(X509Certificate[] x509CertificateArr, String str, String str2) {
            try {
                ...
                LogUtil.e("X509Util", "X509TrustManager unexpectedly threw: %s", e);
    ...
    public static final class X509TrustManagerJellyBean implements X509TrustManagerImplementation {
        ...
        public List<X509Certificate> checkServerTrusted(X509Certificate[] x509CertificateArr, String str, String str2) {
            try {
                ...
                LogUtil.e("X509Util", "checkServerTrusted() unexpectedly threw: %s", e);
                throw new CertificateException(e);
            }
        }
    }
            ...
            for (TrustManager trustManager : trustManagerFactory.getTrustManagers()) {
                if (trustManager instanceof X509TrustManager) {
                    try {
                        ...
                        StringBuilder LIZ = X1D.LIZ();
                        LIZ.append("Error creating trust manager (");
                        LIZ.append(name);
                        LIZ.append("): ");
                        LIZ.append(e);
                        LogUtil.e("X509Util", X1D.LIZIZ(LIZ));
                    }
                }
            }
            LogUtil.e("X509Util", "Could not find suitable trust manager");
            return null;
        } catch (RuntimeException e2) {
            LogUtil.e("X509Util", "TrustManagerFactory.getTrustManagers() unexpectedly threw: %s", e2);
        ...
        while (true) {
            ...
            if (certificate != null) {
                if (!(certificate instanceof X509Certificate)) {
                    ...
                    LIZ3.append("Anchor ");
                    LIZ3.append(LIZIZ);
                    LIZ3.append(" not an X509Certificate: ");
                    LIZ3.append(name);
                    LogUtil.e("X509Util", X1D.LIZIZ(LIZ3));
                } else {
                ...
                try {
                    ...
                    for (int i = 1; i < bArr.length; i++) {
                        try {
                            ...
                            StringBuilder LIZ = X1D.LIZ();
                            LIZ.append("intermediate ");
                            LIZ.append(i);
                            LIZ.append(" failed parsing");
                            LogUtil.w("X509Util", X1D.LIZIZ(LIZ));
                        }
                    }
                        ...
                        synchronized (sLock) {
                            ...
                            try {
                                ...
                                try {
                                    ...
                                    LogUtil.i("X509Util", X1D.LIZIZ(LIZ2));

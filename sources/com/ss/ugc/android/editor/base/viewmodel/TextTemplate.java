...
public final class TextTemplate extends F9E {
    ...
    */
    public TextTemplate() {
        /*
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.ss.ugc.android.editor.base.viewmodel.TextTemplate.<init>():void");
    }
    ...
    public final TextTemplate copy(List<Float> position, double d, List<Double> scale, int i, float f, double d2, List<Double> bounding_box, List<TextContent> text_list) {
        o.LJIIJ(position, "position");
        o.LJIIJ(scale, "scale");
        o.LJIIJ(bounding_box, "bounding_box");
        o.LJIIJ(text_list, "text_list");
        return new TextTemplate(position, d, scale, i, f, d2, bounding_box, text_list);
    }
    ...
    public final SizeF boundingBox() {
        ...
        return new SizeF(((((float) ((Number) ListProtector.get(this.bounding_box, 2)).doubleValue()) / 2.0f) + 0.5f) - ((((float) ((Number) ListProtector.get(this.bounding_box, 0)).doubleValue()) / 2.0f) + 0.5f), (0.5f - (((float) ((Number) ListProtector.get(this.bounding_box, 1)).doubleValue()) / 2.0f)) - (0.5f - (((float) ((Number) ListProtector.get(this.bounding_box, 3)).doubleValue()) / 2.0f)));
    }
    ...
    public TextTemplate(List<Float> position, double d, List<Double> scale, int i, float f, double d2, List<Double> bounding_box, List<TextContent> text_list) {
        o.LJIIJ(position, "position");
        o.LJIIJ(scale, "scale");
        o.LJIIJ(bounding_box, "bounding_box");
        o.LJIIJ(text_list, "text_list");
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public /* synthetic */ TextTemplate(java.util.List r35, double r36, java.util.List r38, int r39, float r40, double r41, java.util.List r43, java.util.List r44, int r45, kotlin.jvm.internal.DefaultConstructorMarker r46) {
        /*
            r34 = this;
            r3 = r45
            r17 = r44
        ...
        L78:
            ...
            if (r0 == 0) goto Laa
            com.ss.ugc.android.editor.base.viewmodel.TextContent[] r0 = new com.ss.ugc.android.editor.base.viewmodel.TextContent[r2]
            com.ss.ugc.android.editor.base.viewmodel.TextContent r17 = new com.ss.ugc.android.editor.base.viewmodel.TextContent
            r19 = 0
            r27 = 0
            r26 = 0
            r20 = 0
            ...
            r0[r18] = r17
            com.ss.ugc.android.editor.base.viewmodel.TextContent r25 = new com.ss.ugc.android.editor.base.viewmodel.TextContent
            r28 = r20
            r29 = r21
            r31 = r27
            r32 = r24
        ...
        Lb0:
            ...
            goto L4e
        */
        throw new UnsupportedOperationException("Method not decompiled: com.ss.ugc.android.editor.base.viewmodel.TextTemplate.<init>(java.util.List, double, java.util.List, int, float, double, java.util.List, java.util.List, int, kotlin.jvm.internal.DefaultConstructorMarker):void");
    }
}

...
public interface IDavResourceNetworkApi {
    @ENX
    @E8L
    InterfaceC37276Ek4<TypedInput> davResourceGet(@InterfaceC30951CCt Boolean bool, @ENW int i, @InterfaceC195747mE String str, @InterfaceC36228EJs(encode = true) Map<String, String> map, @InterfaceC195767mG List<EJ6> list);

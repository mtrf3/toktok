...
public final class ByteAudioNativeFunctions {
    public static native int nativeAddEnableAudioRouteReference(long j);
    ...
    public static native int nativePushExternalReferenceBuffer(long j, int i, ByteAudioStreamBuffer byteAudioStreamBuffer, int i2);

    public static native void nativeReleaseAuxStreamSink(long j);

    public static native void nativeReleaseInputStreamSink(long j);

    public static native int nativeReleaseInstance();

    public static native void nativeReleaseOutputStreamSink(long j);

    public static native int nativeRemoveEnableAudioRouteReference(long j);

    public static native void nativeRemoveEventHandler(long j, long j2);

    public static native int nativeSetAudioModeStrategy(long j, int i);

    public static native int nativeSetDefaultAudioRoute(long j, int i);

    public static native long nativeSetEarMonitorFilter(long j, ByteAudioFilterProxy byteAudioFilterProxy, int i, int i2);

    public static native void nativeSetExternalAudioDevice(long j, int i, boolean z);
    ...
    public static native int nativeStopPushExternalReferenceBuffer(long j, int i);
}

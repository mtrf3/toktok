...
public class AndroidExcludeRefs {
    public static void buildSystemExcludeRefs(ExcludedRefs.Builder builder) {
        ...
        if ("samsung".equals(AndroidOS.MANUFACTURER) && (i3 = AndroidOS.SDK_INT) >= 19 && i3 <= 21) {
            builder.staticField("android.sec.clipboard.ClipboardUIManager", "sInstance");
        }
        if ("LGE".equals(AndroidOS.MANUFACTURER) && (i2 = AndroidOS.SDK_INT) >= 19 && i2 <= 21) {
        ...
        if (AndroidOS.MANUFACTURER.equalsIgnoreCase("HUAWEI") && (i = AndroidOS.SDK_INT) >= 24 && i <= 25) {
    ...
    public static void excludeInvalidReference(ExcludedRefs.Builder builder) {

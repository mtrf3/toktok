...
public class MemoryConfig {
    ...
    public final int dumpHprofWaitTime;
    public final boolean dumpSelf;
    public final boolean enableMonkey;
    ...
    public final int pullHprofWaitTime;
    ...
    public static JSONObject sJsonConfig = new JSONObject();
    public static MemoryConfig sConfig = null;
    ...
    public MemoryConfig(JSONObject jSONObject) {
        ...
        if (this.oversea) {
            ...
            LIZ.append(this.SERVERURL_SUFFIX);
            this.SERVERURL = X1D.LIZIZ(LIZ);
        } else {
            StringBuilder LIZ2 = X1D.LIZ();
            LIZ2.append(optString);
            LIZ2.append(this.SERVERURL_SUFFIX);
            this.SERVERURL = X1D.LIZIZ(LIZ2);
        }
        ...
        this.bitmapLatitude = jSONObject.optLong("bitmapLatitude", 204800L);
        ...
        this.bitmapMinSize = jSONObject.optInt("bitmapMinSize", LiveMaxRetainAlogMessageSizeSetting.DEFAULT);
    ...
    public static MemoryConfig changeMemoryConfig(JSONObject jSONObject) {
        if (jSONObject != null) {
            ...
            sConfig = new MemoryConfig(jSONObject);
        }
        return sConfig;
    }
    ...
    public static void parseExcludeRef(ExcludedRefs.Builder builder, JSONObject jSONObject) {
        if (jSONObject == null) {
            return;
        }

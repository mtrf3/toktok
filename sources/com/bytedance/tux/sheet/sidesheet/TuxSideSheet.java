...
public final class TuxSideSheet extends AppCompatDialogFragment {
    ...
    public final Dialog onCreateDialog(Bundle bundle) {
        ...
        return new DialogC80741VmT(requireContext, this.LJLIL, this.LJLILLLLZI, this.LJLJI, this.LJLJJI);
    }
    ...
    public final View onCreateView(LayoutInflater inflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        C29S c29s = null;
        if (dialog != null) {
            c226588us = (C226588us) dialog.findViewById(R.id.jvx);
        } else {
            c226588us = null;
        }
        if (c226588us != null) {

...
public class LikeUserInfoAnimWidget extends LiveRecyclableWidget implements InterfaceC29986Bpm {
    ...
    public C30012BqC LJZ;

    @Override // X.InterfaceC29986Bpm
    public final String A4() {
        return "LikeUserInfoAnimWidget";
    }
    ...
    public final void onInit(Object[] objArr) {
        ...
        C29701Eo c29701Eo = (C29701Eo) findViewById(R.id.b0s);
        this.LJLLJ = c29701Eo;
        c29701Eo.addAnimatorListener(new ALAdapterS4S0100000_5(this, 31));
        ValueAnimator ofInt = ValueAnimator.ofInt(0, LinkMicRtcMixBitrateSetting.DEFAULT);
        this.LJLJI = ofInt;
        ofInt.addUpdateListener(new AUListenerS94S0100000_5(this, 17));
        this.LJLJI.setDuration(1200L);
        ObjectAnimator ofFloat = ObjectAnimator.ofFloat(this.LJLIL, (Property<View, Float>) View.ROTATION, 0.0f, LJZI, 0.0f);
        this.LJLJJI = ofFloat;
        ...
        this.LJZ = new C30012BqC(Integer.class);
    }
    ...
    public final void onLoad(Object[] objArr) {
        ...
        if (room != null && room.getOwner() != null) {
            ...
            C16880lQ.LJIILLIIL(this.LJLLLL, new IDCListenerS10S0101000(1, room, 7));
        }
    ...
    public final void t3(LikeHelper likeHelper, int i) {
        ...
        if (i >= likeHelper.LJZI) {
            ...
            this.LJLZ.addListener(new ALAdapterS4S0100000_5(this, 72));
            this.LJLZ.start();
            return;
        }
        if (i < likeHelper.LJZ) {
    ...
    public final void g4(LikeHelper likeHelper, int i, int i2, float f, float f2, float f3, float f4) {
        ...
        if (i2 >= likeHelper.LJZI) {
            ...
            this.LJLJJI.start();
            if (!this.LJLLJ.isAnimating()) {
                this.LJLLJ.setVisibility(0);
                if (i2 == likeHelper.LJZI) {
                    C15490jB.LJIIJ(this.LJLLJ, CFX.LIZ("tiktok_live_lottie_resource", "tiktok_live_watch_resource_normal_1"), "full_progress_bubbles_lottie.zip", true);
                } else {
                    C15490jB.LJIIJ(this.LJLLJ, CFX.LIZ("tiktok_live_lottie_resource", "tiktok_live_watch_resource_normal_1"), "like_after_full_progress_bubbles_lottie.zip", true);
                }
                this.LJLLJ.playAnimation();
            }
            C29982Bpi.LJFF++;
            return;
        }

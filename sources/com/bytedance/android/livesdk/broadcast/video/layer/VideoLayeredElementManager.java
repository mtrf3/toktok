...
public final class VideoLayeredElementManager extends BroadcastLayeredElementManager {
    ...
    public VideoLayeredElementManager(Context context, Fragment fragment, LayeredConstraintLayout layeredConstraintLayout, DataChannel dataChannel) {
        ...
        registerGroups(new UNA((C1O4) layeredElementContext));
        ...
        registerLayer(new ULS((C1O4) layeredElementContext3));
        ...
        registerLayer(new C77062UMg(layeredElementContext4));
        ...
        registerLayer(new C77059UMd((C1O4) layeredElementContext5));
        ...
        registerLayer(new C77057UMb((C1O4) layeredElementContext6));
        ...
        registerLayer(new C77058UMc(layeredElementContext7));
        ...
        C74295TDv.fixReferencedIds(layeredConstraintLayout, R.id.k51, R.id.bjy, R.id.e0e);
        finishRegistration();
    }
}

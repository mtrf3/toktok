...
public final class ApplyContent extends F9E {
    ...
    public ApplyContent(Player player, String str) {
        this.applicant = player;
        this.applicantLinkMicId = str;
    }

    public /* synthetic */ ApplyContent(Player player, String str, int i, DefaultConstructorMarker defaultConstructorMarker) {

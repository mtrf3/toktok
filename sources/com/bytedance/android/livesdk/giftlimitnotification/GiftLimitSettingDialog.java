...
public final class GiftLimitSettingDialog extends LiveDialogFragment {
    ...
    */
    public final X.C28507BGt createParams() {
        ...
        L21:
            X.BGt r1 = new X.BGt
            r0 = 2131563625(0x7f0d1469, float:1.8752712E38)
            r1.<init>(r0)
            r1.LIZJ = r5
            r0 = 48
            r1.LJIILIIL = r0
        ...
        L4a:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.bytedance.android.livesdk.giftlimitnotification.GiftLimitSettingDialog.createParams():X.BGt");
    }
    ...
    public final void onViewCreated(View view, Bundle bundle) {
        ...
        C16880lQ.LJIIJ(new ACListenerS25S0100000_5(this, 160), _$_findCachedViewById(R.id.jr6));
        LiveGiftReminderFragment Kx = ((IGiftReminderService) CN1.LIZ(IGiftReminderService.class)).Kx(0);
        this.LJLIL = Kx;
        if (Kx != null) {
            FragmentManager childFragmentManager = getChildFragmentManager();
            C1B3 LIZ = C1B6.LIZ(childFragmentManager, childFragmentManager);
            LIZ.LJIIIIZZ(R.id.dtj, 1, Kx, null);
            LIZ.LJIILJJIL();
        }
        DataChannel dataChannel = this.dataChannel;
        if (dataChannel != null) {
            dataChannel.lv0(this, BroadcastDialogPageChannel.class, new BB7(this));
        }

...
public final class MultiGuestFollowAndApplyDialog extends LiveDialogFragment {
    ...
    public final C28507BGt createParams() {
        C28507BGt c28507BGt = new C28507BGt(R.layout.cz_);
    ...
    public final void onViewCreated(View view, Bundle bundle) {
        ...
        if (c2a7 != null) {
            this.LJLIL = c2a7;
            C16880lQ.LJJIII(c2a7, new ACListenerS33S0100000_13(this, 33));
        }
        C16880lQ.LJIIJ(new ACListenerS33S0100000_13(this, 34), view);
        DataChannel dataChannel = this.dataChannel;
        if (dataChannel != null) {
            dataChannel.lv0(this, CheckPermissionSucc.class, new AqS179S0100000_13(this, 135));
            dataChannel.lv0(this, LiveEndEvent.class, new AqS179S0100000_13(this, 136));
        }
    }
}

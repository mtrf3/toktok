...
public final class SessionAbility implements ISessionAbility, U62 {
    public InterfaceC74626TQo LJLIL = null;
    public final C62822Ol8 LJLILLLLZI = C221108m2.LIZIZ(TQO.LJLIL);
    ...
    public final String LLLLLLIL() {
        return C78886Uxe.LJJJLL(C8E.LJ());
    }
    ...
    public final void Ui(LinkLayerRTCMessage rtcMessage) {
        ...
        if (R6 != null && (LLIIJLIL = R6.LLIIJLIL()) != null) {
            String json = GsonProtectorUtils.toJson(C09650Zl.LIZIZ, rtcMessage);
            o.LJIIIIZZ(json, "get().toJson(rtcMessage)");
    ...
    public final void LJLLI(InterfaceC75441TjB session, String linkMicId, String messageContent) {
        InterfaceC74626TQo interfaceC74626TQo;
        o.LJIIIZ(session, "session");
        o.LJIIIZ(linkMicId, "linkMicId");
        o.LJIIIZ(messageContent, "messageContent");
        StringBuilder LIZ = X1D.LIZ();
        LIZ.append("onReceived RTC room message [");
        LIZ.append(linkMicId);
        LIZ.append("]: \t ");
        LIZ.append(messageContent);
        UC0.LJJIZ(X1D.LIZIZ(LIZ), "SAbility");
        this.LJLILLLLZI.getValue().getClass();
        LinkLayerRTCMessage LIZIZ = TQ0.LIZIZ(messageContent);
        if (LIZIZ != null && (interfaceC74626TQo = this.LJLIL) != null) {
            interfaceC74626TQo.LIZ(LIZIZ);
        }
    }

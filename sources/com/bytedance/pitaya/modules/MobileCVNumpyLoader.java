...
public final class MobileCVNumpyLoader extends SubModule {
    ...
    public boolean load(Context context, PTYSoLoader soLoader, InterfaceC93304aOi errorReporter) {
        ...
        try {
            soLoader.loadSo("py-cv-numpycv");
            return true;
        } catch (UnsatisfiedLinkError e) {
            errorReporter.onError(":projects:Pitaya_Android:mobilecvbinder_numpy", e);
            return false;
        }
    }
}

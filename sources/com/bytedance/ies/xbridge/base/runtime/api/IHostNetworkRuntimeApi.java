...
public interface IHostNetworkRuntimeApi {
    @InterfaceC36317ENd
    InterfaceC37276Ek4<String> doDeleteForString(@InterfaceC30951CCt boolean z, @ENW int i, @InterfaceC195747mE String str, @InterfaceC195767mG List<EJ6> list, @InterfaceC195737mD Object obj);

    @ENX
    @E8L
    InterfaceC37276Ek4<TypedInput> doGetForStream(@InterfaceC30951CCt boolean z, @ENW int i, @InterfaceC195747mE String str, @InterfaceC36228EJs Map<String, String> map, @InterfaceC195767mG List<EJ6> list, @InterfaceC195737mD Object obj);
    ...
    @InterfaceC36318ENe
    InterfaceC37276Ek4<String> doPutForString(@InterfaceC30951CCt boolean z, @ENW int i, @InterfaceC195747mE String str, @InterfaceC195767mG List<EJ6> list, @InterfaceC195727mC TypedOutput typedOutput, @InterfaceC195737mD Object obj);

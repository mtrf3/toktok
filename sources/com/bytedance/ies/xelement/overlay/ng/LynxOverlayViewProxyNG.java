...
public final class LynxOverlayViewProxyNG extends UIGroup<VRK> implements VOI {
    public static final VRH Companion = new VRH();
    ...
    public boolean isViewVisible() {
        return this.mOverlayView.LJLILLLLZI;
    }
    ...
    public VRK createView(Context context) {
        o.LJIIJ(context, "context");
        VRF vrf = new VRF(this, context);
        vrf.getViewTreeObserver().addOnGlobalLayoutListener(new IDLListenerS64S0200000_14(vrf, this, 0));
        return vrf;
    }

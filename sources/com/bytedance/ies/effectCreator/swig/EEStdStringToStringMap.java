...
public class EEStdStringToStringMap extends AbstractMap<String, String> {
    ...
    public static class Iterator {
        ...
        public String getKey() {
            return EffectCreatorJniJNI.EEStdStringToStringMap_Iterator_getKey(this.swigCPtr, this);
        }

        public Iterator getNextUnchecked() {
            return new Iterator(EffectCreatorJniJNI.EEStdStringToStringMap_Iterator_getNextUnchecked(this.swigCPtr, this), true);
        }

        public String getValue() {
            return EffectCreatorJniJNI.EEStdStringToStringMap_Iterator_getValue(this.swigCPtr, this);
        }
        ...
        public boolean isNot(Iterator iterator) {
            return EffectCreatorJniJNI.EEStdStringToStringMap_Iterator_isNot(this.swigCPtr, this, getCPtr(iterator), iterator);
        }
    ...
    private Iterator begin() {
        return new Iterator(EffectCreatorJniJNI.EEStdStringToStringMap_begin(this.swigCPtr, this), true);
    }

    private Iterator end() {
        return new Iterator(EffectCreatorJniJNI.EEStdStringToStringMap_end(this.swigCPtr, this), true);
    }

    private int sizeImpl() {
        return EffectCreatorJniJNI.EEStdStringToStringMap_sizeImpl(this.swigCPtr, this);
    }
    ...
    public boolean isEmpty() {
        return EffectCreatorJniJNI.EEStdStringToStringMap_isEmpty(this.swigCPtr, this);
    }
    ...
    private boolean containsImpl(String str) {
        return EffectCreatorJniJNI.EEStdStringToStringMap_containsImpl(this.swigCPtr, this, str);
    }

    private Iterator find(String str) {
        return new Iterator(EffectCreatorJniJNI.EEStdStringToStringMap_find(this.swigCPtr, this, str), true);
    }

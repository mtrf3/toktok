...
public class SpeedPredictorRecordItem {
    public long mBytes;
    public long mLastDataRecv;
    public long mMDLBufferCurrentSize;
    public long mMDLBufferMaxSize;
    public long mMDLRangeEndOffset;
    public long mMDLRangeStartOffset;
    ...
    public void setMDLBufferCurrentSize(long j) {
        this.mMDLBufferCurrentSize = j;
    }

    public void setMDLBufferMaxSize(long j) {
        this.mMDLBufferMaxSize = j;
    }

    public void setMDLRangeEndOffset(long j) {
        this.mMDLRangeEndOffset = j;
    }

    public void setMDLRangeStartOffset(long j) {
        this.mMDLRangeStartOffset = j;
    }

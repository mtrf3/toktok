...
public enum Transport implements ReflectedParcelable {
    ...
    public static final Parcelable.Creator<Transport> CREATOR = new Parcelable.Creator() { // from class: X.PN3
    ...
    public static Transport fromString(String str) {
        ...
        throw new PN4(C16880lQ.LLLZ("Transport %s not supported", new Object[]{str}));
    }
    ...
    public static Transport valueOf(String str) {
        return (Transport) V0N.LJJJ(Transport.class, str);
    }

...
public abstract class AppsFlyerLib {
    ...
    public abstract void autoLogSubscriptionsRevenue(Function<List<Purchase>, Map<String, String>> function, Consumer<String> consumer, Consumer<String> consumer2, Boolean bool);

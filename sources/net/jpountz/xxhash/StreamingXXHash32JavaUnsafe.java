...
public final class StreamingXXHash32JavaUnsafe extends AbstractStreamingXXHash32Java {
    ...
    public int getValue() {
        ...
        while (i3 <= this.memSize - 4) {
            i2 = Integer.rotateLeft((UnsafeUtils.readIntLE(this.memory, i3) * (-1028477379)) + i2, 17) * 668265263;
            i3 += 4;
        }
        while (i3 < this.memSize) {
            i2 = Integer.rotateLeft(((UnsafeUtils.readByte(this.memory, i3) & 255) * 374761393) + i2, 11) * (-1640531535);
            i3++;
        }
    ...
    public StreamingXXHash32JavaUnsafe(int i) {
        super(i);
    }
    ...
    public void update(byte[] bArr, int i, int i2) {
        ...
        if (i3 > 0) {
            ...
            int readIntLE = (UnsafeUtils.readIntLE(this.memory, 0) * (-2048144777)) + this.v1;
            this.v1 = readIntLE;
            this.v1 = Integer.rotateLeft(readIntLE, 13) * (-1640531535);
            int readIntLE2 = (UnsafeUtils.readIntLE(this.memory, 4) * (-2048144777)) + this.v2;
            this.v2 = readIntLE2;
            this.v2 = Integer.rotateLeft(readIntLE2, 13) * (-1640531535);
            int readIntLE3 = (UnsafeUtils.readIntLE(this.memory, 8) * (-2048144777)) + this.v3;
            this.v3 = readIntLE3;
            this.v3 = Integer.rotateLeft(readIntLE3, 13) * (-1640531535);
            int readIntLE4 = (UnsafeUtils.readIntLE(this.memory, 12) * (-2048144777)) + this.v4;
            this.v4 = readIntLE4;
        ...
        int i9 = this.v4;
        while (i <= i5) {
            i6 = Integer.rotateLeft((UnsafeUtils.readIntLE(bArr, i) * (-2048144777)) + i6, 13) * (-1640531535);
            int i10 = i + 4;
            i7 = Integer.rotateLeft((UnsafeUtils.readIntLE(bArr, i10) * (-2048144777)) + i7, 13) * (-1640531535);
            int i11 = i10 + 4;
            i8 = Integer.rotateLeft((UnsafeUtils.readIntLE(bArr, i11) * (-2048144777)) + i8, 13) * (-1640531535);
            int i12 = i11 + 4;

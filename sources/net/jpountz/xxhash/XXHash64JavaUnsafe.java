...
public final class XXHash64JavaUnsafe extends XXHash64 {
    ...
    public long hash(byte[] bArr, int i, int i2, long j) {
        ...
        if (i2 >= 32) {
            ...
            long j6 = j - (-7046029288634856825L);
            do {
                j3 = Long.rotateLeft((UnsafeUtils.readLongLE(bArr, i3) * (-4417276706812531889L)) + j3, 31) * (-7046029288634856825L);
                int i6 = i3 + 8;
                j4 = Long.rotateLeft((UnsafeUtils.readLongLE(bArr, i6) * (-4417276706812531889L)) + j4, 31) * (-7046029288634856825L);
                int i7 = i6 + 8;
                j5 = Long.rotateLeft((UnsafeUtils.readLongLE(bArr, i7) * (-4417276706812531889L)) + j5, 31) * (-7046029288634856825L);
                int i8 = i7 + 8;
                j6 = Long.rotateLeft((UnsafeUtils.readLongLE(bArr, i8) * (-4417276706812531889L)) + j6, 31) * (-7046029288634856825L);
                i3 = i8 + 8;
            } while (i3 <= i5);
        ...
        long j7 = j2 + i2;
        while (i3 <= i4 - 8) {
            j7 = (Long.rotateLeft(j7 ^ (Long.rotateLeft(UnsafeUtils.readLongLE(bArr, i3) * (-4417276706812531889L), 31) * (-7046029288634856825L)), 27) * (-7046029288634856825L)) - 8796714831421723037L;
            i3 += 8;
        }
        if (i3 <= i4 - 4) {
            j7 = (Long.rotateLeft(j7 ^ ((UnsafeUtils.readIntLE(bArr, i3) & 4294967295L) * (-7046029288634856825L)), 23) * (-4417276706812531889L)) + 1609587929392839161L;
            i3 += 4;
        }
        while (i3 < i4) {
            j7 = Long.rotateLeft(j7 ^ ((UnsafeUtils.readByte(bArr, i3) & 255) * 2870177450012600261L), 11) * (-7046029288634856825L);
            i3++;
        }
        long j8 = ((j7 >>> 33) ^ j7) * (-4417276706812531889L);
        long j9 = (j8 ^ (j8 >>> 29)) * 1609587929392839161L;

...
public final class StreamingXXHash64JavaUnsafe extends AbstractStreamingXXHash64Java {
    ...
    public long getValue() {
        ...
        while (true) {
            ...
            j5 = (Long.rotateLeft(j5 ^ (Long.rotateLeft(UnsafeUtils.readLongLE(this.memory, i2) * (-4417276706812531889L), 31) * (-7046029288634856825L)), 27) * (-7046029288634856825L)) - 8796714831421723037L;
            i2 += 8;
        }
        if (i2 <= i - 4) {
            j5 = (Long.rotateLeft(j5 ^ ((UnsafeUtils.readIntLE(this.memory, i2) & 4294967295L) * (-7046029288634856825L)), 23) * (-4417276706812531889L)) + 1609587929392839161L;
            i2 += 4;
        }
    ...
    public StreamingXXHash64JavaUnsafe(long j) {
        super(j);
    }
    ...
    public void update(byte[] bArr, int i, int i2) {
        ...
        if (i4 > 0) {
            ...
            long readLongLE = this.v1 + (UnsafeUtils.readLongLE(this.memory, 0) * (-4417276706812531889L));
            this.v1 = readLongLE;
            this.v1 = Long.rotateLeft(readLongLE, 31) * (-7046029288634856825L);
            long readLongLE2 = this.v2 + (UnsafeUtils.readLongLE(this.memory, 8) * (-4417276706812531889L));
            this.v2 = readLongLE2;
            this.v2 = Long.rotateLeft(readLongLE2, 31) * (-7046029288634856825L);
            long readLongLE3 = this.v3 + (UnsafeUtils.readLongLE(this.memory, 16) * (-4417276706812531889L));
            this.v3 = readLongLE3;
            this.v3 = Long.rotateLeft(readLongLE3, 31) * (-7046029288634856825L);
            long readLongLE4 = this.v4 + (UnsafeUtils.readLongLE(this.memory, 24) * (-4417276706812531889L));
            this.v4 = readLongLE4;
        ...
        long j4 = this.v4;
        while (i3 <= i6) {
            j = Long.rotateLeft((UnsafeUtils.readLongLE(bArr, i3) * (-4417276706812531889L)) + j, 31) * (-7046029288634856825L);
            int i7 = i3 + 8;
            j2 = Long.rotateLeft((UnsafeUtils.readLongLE(bArr, i7) * (-4417276706812531889L)) + j2, 31) * (-7046029288634856825L);
            int i8 = i7 + 8;
            j3 = Long.rotateLeft((UnsafeUtils.readLongLE(bArr, i8) * (-4417276706812531889L)) + j3, 31) * (-7046029288634856825L);
            int i9 = i8 + 8;
            j4 = Long.rotateLeft((UnsafeUtils.readLongLE(bArr, i9) * (-4417276706812531889L)) + j4, 31) * (-7046029288634856825L);
            i3 = i9 + 8;
        }
        this.v1 = j;
        this.v2 = j2;

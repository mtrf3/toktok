...
public final class XXHash32JavaSafe extends XXHash32 {
    ...
    public int hash(byte[] bArr, int i, int i2, int i3) {
        ...
        if (i2 >= 16) {
            ...
            do {
                i7 = Integer.rotateLeft((SafeUtils.readIntLE(bArr, i) * (-2048144777)) + i7, 13) * (-1640531535);
                int i10 = i + 4;
                i8 = Integer.rotateLeft((SafeUtils.readIntLE(bArr, i10) * (-2048144777)) + i8, 13) * (-1640531535);
                int i11 = i10 + 4;
                i3 = Integer.rotateLeft((SafeUtils.readIntLE(bArr, i11) * (-2048144777)) + i3, 13) * (-1640531535);
                int i12 = i11 + 4;
        ...
        int i13 = i4 + i2;
        while (i <= i5 - 4) {
            i13 = 668265263 * Integer.rotateLeft((SafeUtils.readIntLE(bArr, i) * (-1028477379)) + i13, 17);
            i += 4;
        }
        while (i < i5) {
            i13 = Integer.rotateLeft(((SafeUtils.readByte(bArr, i) & 255) * 374761393) + i13, 11) * (-1640531535);
            i++;
        }

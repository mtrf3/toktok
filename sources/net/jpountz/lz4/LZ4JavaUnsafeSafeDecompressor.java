...
public final class LZ4JavaUnsafeSafeDecompressor extends LZ4SafeDecompressor {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:59:0x0063, code lost:
        ...
        net.jpountz.lz4.LZ4UnsafeUtils.safeArraycopy(r17, r3, r20, r2, r10);
     */
    ...
    */
    public int decompress(byte[] r17, int r18, int r19, byte[] r20, int r21, int r22) {
        /*
            ...
            r2 = r19
            r11 = r17
            net.jpountz.util.UnsafeUtils.checkRange(r11, r10, r2)
            r9 = r20
            r1 = r22
            r8 = r21
            net.jpountz.util.UnsafeUtils.checkRange(r9, r8, r1)
            r0 = 1
            if (r1 != 0) goto L27
            if (r2 != r0) goto L1f
            byte r0 = net.jpountz.util.UnsafeUtils.readByte(r11, r10)
            if (r0 != 0) goto L1f
            r0 = 0
            return r0
        L1f:
        ...
        L3c:
            if (r3 >= r7) goto L4c
            int r1 = r3 + 1
            byte r0 = net.jpountz.util.UnsafeUtils.readByte(r11, r3)
            if (r0 != r13) goto L4b
            int r10 = r10 + 255
            r0 = -1
            r3 = r1
        ...
        L5d:
            ...
            int r0 = r3 + r10
            if (r0 != r7) goto L9d
            net.jpountz.lz4.LZ4UnsafeUtils.safeArraycopy(r11, r3, r9, r2, r10)
            int r6 = r6 - r8
            return r6
        L68:
            net.jpountz.lz4.LZ4UnsafeUtils.wildArraycopy(r11, r3, r9, r2, r10)
            int r0 = net.jpountz.util.UnsafeUtils.readShortLE(r11, r1)
            int r10 = r1 + 2
            int r3 = r6 - r0
            if (r3 < r8) goto Lb7
            r2 = r15 & 15
        ...
        L8d:
            ...
            if (r2 <= r5) goto L99
            if (r2 > r12) goto Lad
            net.jpountz.lz4.LZ4UnsafeUtils.safeIncrementalCopy(r9, r3, r6, r0)
            goto L2c
        L99:
            net.jpountz.lz4.LZ4UnsafeUtils.wildIncrementalCopy(r9, r3, r6, r2)
            goto L2c
        L9d:
            net.jpountz.lz4.LZ4Exception r1 = new net.jpountz.lz4.LZ4Exception

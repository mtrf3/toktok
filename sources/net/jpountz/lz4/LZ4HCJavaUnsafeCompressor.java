    ...
    public class HashTable {
        ...
        */
        ...
        /* JADX WARN: Code restructure failed: missing block: B:32:0x0081, code lost:
            ...
            r7.chainTable[r9 & 65535] = (short) r4;
            r7.hashTable[net.jpountz.lz4.LZ4Utils.hashHC(net.jpountz.util.UnsafeUtils.readInt(r8, r9))] = r9;
            r9 = r9 + 1;
         */
        /* JADX WARN: Code restructure failed: missing block: B:33:0x0096, code lost:
        ...
        */
        public boolean insertAndFindBestMatch(byte[] r8, int r9, int r10, net.jpountz.lz4.LZ4Utils.Match r11) {
            /*
                ...
                int r0 = r7.base
                if (r6 < r0) goto L7e
                boolean r0 = net.jpountz.lz4.LZ4UnsafeUtils.readIntEquals(r8, r6, r9)
                if (r0 == 0) goto L7b
                int r4 = r9 - r6
                int r1 = r6 + 4
                int r0 = r9 + 4
                int r0 = net.jpountz.lz4.LZ4UnsafeUtils.commonBytes(r8, r1, r0, r10)
                int r5 = r0 + 4
                r11.len = r5
                r11.ref = r6
            L2c:
            ...
            L81:
                ...
                r2[r1] = r0
                int[] r1 = r7.hashTable
                int r0 = net.jpountz.util.UnsafeUtils.readInt(r8, r9)
                int r0 = net.jpountz.lz4.LZ4Utils.hashHC(r0)
                r1[r0] = r9
                int r9 = r9 + 1
                if (r9 < r6) goto L81
